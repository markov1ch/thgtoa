...
There are many advanced techniques that can be used by skilled adversaries[^249] to bypass your security measures provided they already know where your devices are. Many of those techniques are detailed here <https://cyber.bgu.ac.il/advanced-cyber/airgap> <sup>[[Archive.org]][168]</sup> (Air-Gap Research Page, Cyber-Security Research Center, Ben-Gurion University of the Negev, Israel) and include:
...
-   **Attacks that require no malware:**
    ...
    -   Observing a light bulb from a distance to listen to the sound in the room[^250] **without any malware**: Demonstration: <https://www.youtube.com/watch?v=t32QvpfOHqw> <sup>[[Invidious]][185]</sup>
...
-   Check some data yourself here on the Tor Project OONI[^253] (Open Observatory of Network Interference) website: <https://explorer.ooni.org/> <sup>[[Archive.org]][217]</sup>
...
**You might also consider some memory tricks to build your password as explained on this blog post from Bruce Schneier: <https://www.schneier.com/blog/archives/2014/03/choosing_secure_1.html>** <sup>[[Archive.org]][219]</sup>
...
-   **Recommended**: Do not require any identification (even e-mail):
    ...
    -   (UK based) <https://dtmf.io/> <sup>[[Archive.org]][222]</sup> **preferred** because they even provide an onion hidden service address for direct access through the Tor Network at <http://dtmfiovjh42uviqez6qn75igbagtiyo724hy3rdxm77dy2m5tt7lbaqd.onion/>
...
You should also read Tails Documentation, Warnings, and limitations, before going further <https://tails.boum.org/doc/about/warning/index.en.html> <sup>[[Archive.org]][229]</sup>
...
If you can afford it, you might consider getting a Purism Librem laptop (<https://puri.sm> <sup>[[Archive.org]][241]</sup>) or System76 laptops (<https://system76.com/> <sup>[[Archive.org]][242]</sup>) while using Coreboot[^260] (where Intel IME is disabled from factory).
...
Here is a good cheap method to make your laptop tamper proof using Nail Polish (with glitter) <https://mullvad.net/en/help/how-tamper-protect-laptop/> <sup>[[Archive.org]][251]</sup> [^267] (with pictures).
...
Follow this tutorial to enable Hibernate: <https://help.ubuntu.com/16.04/ubuntu-help/power-hibernate.html> <sup>[[Archive.org]][270]</sup>

After Hibernate is enabled, change the behavior so that your laptop will hibernate when you close the lid by following this tutorial for Ubuntu 20.04 <http://ubuntuhandbook.org/index.php/2020/05/lid-close-behavior-ubuntu-20-04/> <sup>[[Archive.org]][271]</sup> and this tutorial for Ubuntu 18.04 <https://tipsonubuntu.com/2018/04/28/change-lid-close-action-ubuntu-18-04-lts/> <sup>[[Archive.org]][272]</sup>

Unfortunately, this will not clean the key from memory directly from memory when hibernating. To avoid this at the cost of some performance, you might consider encrypting the swap file by following this tutorial: <https://help.ubuntu.com/community/EnableHibernateWithEncryptedSwap> <sup>[[Archive.org]][273]</sup>

These settings should mitigate cold boot attacks if you can hibernate fast enough.

#### Enable MAC address randomization:

-   Ubuntu, follow these steps <https://help.ubuntu.com/community/AnonymizingNetworkMACAddresses> <sup>[[Archive.org]][274]</sup>.

-   Any other distro: you will have to find the documentation yourself but it should be quite similar to the Ubuntu tutorial.

-   Consider this tutorial which should still work: <https://josh.works/shell-script-basics-change-mac-address> <sup>[[Archive.org]][275]</sup>

#### Hardening Linux:

As a light introduction for new Linux users, consider <https://www.youtube.com/watch?v=Sa0KqbpLye4> <sup>[[Invidious]][276]</sup>

For more in-depth and advanced options, refer to:

-   This excellent guide: <https://madaidans-insecurities.github.io/guides/linux-hardening.html> <sup>[[Archive.org]][277]</sup>

-   This excellent wiki resource: <https://wiki.archlinux.org/title/Security> <sup>[[Archive.org]][278]</sup>

-   These excellent scripts based on the guide and wiki above: <https://codeberg.org/SalamanderSecurity/PARSEC> <sup>[[Archive.org]][279]</sup>
...
As a light introduction for new MacOS users, consider <https://www.youtube.com/watch?v=lFx5icuE6Io> <sup>[[Invidious]][280]</sup>

Now to go more in-depth in securing and hardening your MacOS, I recommend reading this GitHub guide which should cover many of the issues: <https://github.com/drduh/macOS-Security-and-Privacy-Guide> <sup>[[Archive.org]][281]</sup>
...
First you should set-up a firmware password following this guide from Apple: <https://support.apple.com/en-us/HT204455> <sup>[[Archive.org]][282]</sup>
...
These are the infamous "unblockable telemetry" calls from MacOS Big Sur disclosed here: <https://sneak.berlin/20201112/your-computer-isnt-yours/> <sup>[[Archive.org]][283]</sup>
...
But you should probably document yourself on the actual issue before acting. This page is a good place to start: <https://blog.jacopo.io/en/post/apple-ocsp/> <sup>[[Archive.org]][284]</sup>
...
You should enable full disk encryption on your Mac using Filevault according to this part of the guide: <https://github.com/drduh/macOS-Security-and-Privacy-Guide#full-disk-encryption> <sup>[[Archive.org]][281]</sup>
...
As a light introduction, consider watching <https://www.youtube.com/watch?v=vNRics7tlqw> <sup>[[Invidious]][285]</sup>
...
Alternatively, you could use this free piece of software: <https://technitium.com/tmac/> <sup>[[Archive.org]][286]</sup>
...
Go ahead and download and install Veracrypt from: <https://www.veracrypt.fr/en/Downloads.html> <sup>[[Archive.org]][287]</sup>
...
Basically you can follow the instructions here: <https://support.microsoft.com/en-us/windows/turn-on-device-encryption-0c453637-bc88-5f74-5105-741561aae838> <sup>[[Archive.org]][288]</sup>
...
By default, Windows 10 might not offer you this possibility so you should enable it by following this Microsoft tutorial: <https://docs.microsoft.com/en-us/troubleshoot/windows-client/deployment/disable-and-re-enable-hibernation> <sup>[[Archive.org]][289]</sup>
...
Read the Veracrypt Documentation <https://www.veracrypt.fr/en/VeraCrypt%20Hidden%20Operating%20System.html> <sup>[[Archive.org]][290]</sup> (Process of Creation of Hidden Operating System part) and <https://www.veracrypt.fr/en/Security%20Requirements%20for%20Hidden%20Volumes.html> <sup>[[Archive.org]][291]</sup> (Security Requirements and Precautions Pertaining to Hidden Volumes).

This is how your system will look after this process is done:

![][292]

(Illustration from Veracrypt Documentation, <https://veracrypt.fr/en/VeraCrypt%20Hidden%20Operating%20System.html> <sup>[[Archive.org]][290]</sup>)
...
Remember to read <https://www.veracrypt.fr/en/VeraCrypt%20Hidden%20Operating%20System.html> <sup>[[Archive.org]][290]</sup>
...
Before going to next step, you should learn the way to mount your Outer Volume safely for writing content on it. This is also explained in this official Veracrypt Documentation <https://www.veracrypt.fr/en/Protection%20of%20Hidden%20Volumes.html> <sup>[[Archive.org]][293]</sup>
...
Take some time to read again the "Possible Explanations for Existence of Two Veracrypt Partitions on Single Drive" of the Veracrypt documentation here <https://www.veracrypt.fr/en/VeraCrypt%20Hidden%20Operating%20System.html> <sup>[[Archive.org]][290]</sup>
...
(Illustration from Marcelo Martins, <https://stakey.club/en/decred-via-tor-network/> <sup>[[Archive.org]][301]</sup>)
...
-   <https://www.whonix.org/wiki/Stream_Isolation> <sup>[[Archive.org]][302]</sup>

-   <https://tails.boum.org/contribute/design/stream_isolation/> <sup>[[Archive.org]][303]</sup>

-   <https://www.whonix.org/wiki/Tunnels/Introduction#Comparison_Table> <sup>[[Archive.org]][304]</sup>
...
-   <https://www.whonix.org/wiki/Comparison_Of_Tor_with_CGI_Proxies,_Proxy_Chains,_and_VPN_Services#Tor_and_VPN_Services_Comparison> <sup>[[Archive.org]][306]</sup>

-   <https://www.whonix.org/wiki/Why_does_Whonix_use_Tor> <sup>[[Archive.org]][307]</sup>

-   <https://www.researchgate.net/publication/324251041_Anonymity_communication_VPN_and_Tor_a_comparative_study> <sup>[[Archive.org]][308]</sup>

-   <https://gist.github.com/joepie91/5a9909939e6ce7d09e29#file-vpn-md> <sup>[[Archive.org]][309]</sup>

-   <https://schub.wtf/blog/2019/04/08/very-precarious-narrative.html> <sup>[[Archive.org]][310]</sup>
...
-   Tor Project: <https://gitlab.torproject.org/legacy/trac/-/wikis/doc/TorPlusVPN> <sup>[[Archive.org]][311]</sup>

-   Tails Documentation:

    -   <https://gitlab.tails.boum.org/tails/blueprints/-/wikis/vpn_support/> <sup>[[Archive.org]][312]</sup>

    -   <https://tails.boum.org/support/faq/index.en.html#index20h2> <sup>[[Archive.org]][313]</sup>

-   Whonix Documentation (in this order):

    -   <https://www.whonix.org/wiki/Tunnels/Introduction> <sup>[[Archive.org]][314]</sup>

    -   <https://www.whonix.org/wiki/Tunnels/Connecting_to_Tor_before_a_VPN> <sup>[[Archive.org]][315]</sup>

    -   <https://www.whonix.org/wiki/Tunnels/Connecting_to_a_VPN_before_Tor> <sup>[[Archive.org]][305]</sup>
...
-   The latest version of the Virtualbox installer according to your Host OS <https://www.virtualbox.org/wiki/Downloads> <sup>[[Archive.org]][318]</sup>

-   (Skip this if you cannot use Tor natively of through a VPN) The latest Whonix OVA file from <https://www.whonix.org/wiki/Download> <sup>[[Archive.org]][319]</sup> according to your preference (Linux/Windows, with a Desktop interface XFCE for simplicity or only with the text-client for advanced users)
...
For ideal security, you should follow the recommendations provided here for each Virtualbox Virtual Machine <https://www.whonix.org/wiki/Virtualization_Platform_Security#VirtualBox_Hardening> <sup>[[Archive.org]][320]</sup> :
...
Finally, also follow this recommendation to desync the clock you are your VM compared to your host OS <https://www.whonix.org/wiki/Network_Time_Synchronization#Spoof_the_Initial_Virtual_Hardware_Clock_Offset> <sup>[[Archive.org]][321]</sup>
...
Finally consider the security advice from Virtualbox themselves here <https://www.virtualbox.org/manual/ch13.html> <sup>[[Archive.org]][322]</sup>
...
Remember at this stage that if you are having issues connecting to Tor due to censorship or blocking, you should consider connecting using Bridges as explained in this tutorial <https://www.whonix.org/wiki/Bridges> <sup>[[Archive.org]][323]</sup>.

-   Update the Whonix VMs by following the instructions on <https://www.whonix.org/wiki/Operating_System_Software_and_Updates#Updates> <sup>[[Archive.org]][324]</sup>
...
**Important Note: You should also read these very good recommendations over there <https://www.whonix.org/wiki/DoNot>** <sup>[[Archive.org]][325]</sup> **as most of those principles will also apply to this guide. You should also read their general documentation here <https://www.whonix.org/wiki/Documentation>** <sup>[[Archive.org]][326]</sup> **which will also provide tons of advice like this guide.**
...
If you want additional software on the Workstation (such as another Browser), follow their guide here <https://www.whonix.org/wiki/Install_Software> <sup>[[Archive.org]][327]</sup>

Consider running Whonix in Live Mode if for extra malware protection, See <https://www.whonix.org/wiki/Anti-Forensics_Precautions> <sup>[[Archive.org]][328]</sup>

Do not forget to apply the VM hardening recommendations here: [Virtualbox Hardening recommendations].

Consider using AppArmor on your Whonix Workstations by following this guide: <https://www.whonix.org/wiki/AppArmor> <sup>[[Archive.org]][329]</sup>

#### Linux (any distro):

**Be careful, any customization you make to the non-Whonix guest VMs (keyboard layout, language, time zone, screen resolution or other) could be used to fingerprint your VMs later. See <https://www.whonix.org/wiki/VM_Fingerprinting>** <sup>[[Archive.org]][330]</sup>
...
Refer to this tutorial <https://www.whonix.org/wiki/Other_Operating_Systems> <sup>[[Archive.org]][331]</sup> for detailed instructions.
...
-   Go with Windows AME (Ameliorated) from the <https://ameliorated.info/> <sup>[[Archive.org]][332]</sup> project which is a special Windows 10 build stripped from all telemetry/advertising and update components. **Note that you will not be able to update this version with the latest security patched and will have to just re-download a new release. See [Appendix Y: Windows AME installation][Appendix Y: Windows AME download and installation]**
...
-   Download and install Brave browser from <https://brave.com/download/> <sup>[[Archive.org]][333]</sup>
...
Skip these if you used Windows AME from <https://ameliorated.info/> <sup>[[Archive.org]][332]</sup>
...
Basically, follow the tutorial here: <https://www.android-x86.org/documentation/virtualbox.html> <sup>[[Archive.org]][334]</sup>
...
-   Windows Host OS:
    ...
    -   Virtualbox Catalina Tutorial: <https://www.wikigain.com/install-macos-catalina-on-virtualbox-on-windows/> <sup>[[Archive.org]][335]</sup>

    -   Virtualbox Big Sur Tutorial: <https://www.wikigain.com/how-to-install-macos-big-sur-on-virtualbox-on-windows-pc/> <sup>[[Archive.org]][336]</sup>
...
-   Whonix: [https://www.whonix.org/wiki/KeePassXC][] <sup>[[Archive.org]][338]</sup>

-   Linux:

    -   Download from <https://keepassxc.org/download/> <sup>[[Archive.org]][339]</sup>

    -   Follow the tutorial here <https://keepassxc.org/docs/KeePassXC_GettingStarted.html#_linux> <sup>[[Archive.org]][340]</sup>

-   Windows:

    -   Download from <https://keepassxc.org/download/> <sup>[[Archive.org]][339]</sup>

    -   Follow the tutorial here [https://KeePassXC.org/docs/KeePassXC_GettingStarted.html#_microsoft_windows][] <sup>[[Archive.org]][340]</sup>

-   MacOS:

    -   Download from <https://keepassxc.org/download/> <sup>[[Archive.org]][339]</sup>

    -   Follow the tutorial here <https://keepassxc.org/docs/KeePassXC_GettingStarted.html#_macos> <sup>[[Archive.org]][340]</sup>
...
Qubes OS is not a Linux distribution[^315] but a Xen distribution. It is different from Linux distributions because it will make extensive use of Virtualization and Compartmentalization so that any app will run in a different VM (qube). As a bonus, Qubes OS integrates Whonix by default and allows for increased privacy and anonymity. It is highly recommended that you document yourself over Qubes OS principles prior to going this route. Here are some recommended resources:

-   Qube OS Introduction, <https://www.qubes-os.org/intro/> <sup>[[Archive.org]][344]</sup>

-   Qube OS Video Tours, <https://www.qubes-os.org/video-tours/> <sup>[[Archive.org]][345]</sup>

-   Qube OS Getting Started, <https://www.qubes-os.org/doc/getting-started/> <sup>[[Archive.org]][346]</sup>

-   YouTube, Life Behind the Tinfoil: A Look at Qubes and Copperhead - Konstantin Ryabitsev, The Linux Foundation <https://www.youtube.com/watch?v=8cU4hQg6GvU> <sup>[[Invidious]][347]</sup>

-   YouTube, I used the reasonably-secure Qubes OS for 6 months and survived - Matty McFatty [@themattymcfatty] <https://www.youtube.com/watch?v=sbN5Bz3v-uA> <sup>[[Invidious]][348]</sup>

-   YouTube, Qubes OS: How it works, and a demo of this VM-centric OS <https://www.youtube.com/watch?v=YPAvoFsvSbg> <sup>[[Invidious]][349]</sup>

This OS is recommended by prominent figures such as Edward Snowden and Privacytools.io.

Qubes is the best option in this guide for people who are more comfortable with Linux and tech in general. But it has some downsides such as the lack of OS wide plausible deniability, its hardware requirements, and its hardware compatibility. While you can run this on 4GB of RAM as per their requirements[^316], the recommended RAM is 16GB. I would advise against using Qubes OS if you have less than 8GB of RAM. If you want a comfortable experience, you should have 16GB, if you want a very good experience, you should have 24GB or 32GB.
...
You should also check their hardware compatibility here <https://www.qubes-os.org/hcl/> <sup>[[Archive.org]][350]</sup> before proceeding. Your mileage might vary and you might experience several issues with regards to hardware compatibility that you will have to troubleshoot and solve yourself.
...
**This solution however has one main drawback to consider: Interference with Tor Stream Isolation**[^317].
...
VPN/Proxy over Tor falls on the right-side[^318] meaning using a VPN/Proxy over Tor forces Tor to use one circuit for all activities instead of multiple circuits for each. This means that using a VPN/Proxy over Tor can somewhat reduce the effectiveness of Tor in some cases and should therefore be used only for some specific cases:
...
Note, if you're having issues accessing the Tor Network due to blocking/censorship, you could try using Tor Bridges (see Tor Documentation <https://2019.www.torproject.org/docs/bridges> <sup>[[Archive.org]][232]</sup> and Whonix Documentation <https://www.whonix.org/wiki/Bridges> <sup>[[Archive.org]][323]</sup>).
...
We will follow the instructions from their own guide <https://www.qubes-os.org/doc/installation-guide/> <sup>[[Archive.org]][353]</sup>:

Secure Boot is not supported as per their FAQ: <https://www.qubes-os.org/faq/#is-secure-boot-supported> <sup>[[Archive.org]][354]</sup> so it should be disabled in the BIOS/UEFI settings.
...
-   Install Qubes OS according to the installation guide:
    ...
    -   **If you want to use Tor or VPN over Tor: Check the** "**Enabling system and template updates over the Tor anonymity network using Whonix" during the last step. This will force all Qubes OS updates to go through Tor. While this will significantly reduce your update speed, it will increase your anonymity from the start.** (If you are having issues connecting to Tor due to censorship or blocking, consider using Tor Bridges as recommended earlier. Just follow the tutorial provided here: <https://www.whonix.org/wiki/Bridges> <sup>[[Archive.org]][323]</sup>)
...
-   Select Random to randomize your Mac Address
    ...
    -   **Warning: This setting should work in most cases but can be unreliable on some network adapters. Please refer to this documentation if you want to be sure: <https://github.com/Qubes-Community/Contents/blob/master/docs/privacy/anonymizing-your-mac-address.md>** <sup>[[Archive.org]][355]</sup>
...
Basically, AppArmor[^320] is an application sandboxing system. By default, it is not enabled but supported by Qubes OS.
...
-   About the Debian VMs:
    ...
    -   Head out and read <https://wiki.debian.org/AppArmor> <sup>[[Archive.org]][356]</sup>

-   About any other Linux VM:

    -   Head out and read:

        -   <https://wiki.archlinux.org/title/AppArmor> <sup>[[Archive.org]][357]</sup>

        -   <https://wiki.debian.org/AppArmor> <sup>[[Archive.org]][356]</sup>

-   About the Whonix VMs, you should consider enabling it and using it, especially on the Whonix VMs of Qubes OS:

    -   First you should head out and read <https://www.whonix.org/wiki/AppArmor> <sup>[[Archive.org]][329]</sup>

    -   Secondly you should head out again and read <https://www.whonix.org/wiki/Qubes/AppArmor> <sup>[[Archive.org]][358]</sup>

##### SELinux:

SELinux[^321] is similar to AppArmor. The differences between SELinux and AppArmor are technical details we will not get into.

Here is a good explanation of what it is: <https://www.youtube.com/watch?v=_WOKRaM-HI4> <sup>[[Invidious]][359]</sup>
...
So, head out and read <https://docs.fedoraproject.org/en-US/quick-docs/getting-started-with-selinux/> <sup>[[Archive.org]][360]</sup>
...
This is based on the tutorial provided by Qube OS themselves (<https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/vpn.md> <sup>[[Archive.org]][361]</sup>). If you are familiar with this process, you can follow their tutorial. Here is mine:
...
-   Test your Connectivity:
    ...
    -   If you are going for VPN over Tor, Test the VM connectivity to Tor by launching a Browser within the ProxyVM and going to <https://check.torproject.org> <sup>[[Archive.org]][362]</sup> (It should say you are connected to Tor)
...
> (These will block outbound traffic when the VPN is down, it is a kill switch, more information here <https://linuxconfig.org/how-to-create-a-vpn-killswitch-using-iptables-on-linux> <sup>[[Archive.org]][363]</sup> )
...
-   Test the ProxyVM VPN connectivity by starting a Browser within it and going to your VPN provider test page. It should now say you are connected to a VPN:
    ...
    -   Mullvad: <https://mullvad.net/en/check/> <sup>[[Archive.org]][364]</sup>

    -   IVPN: <https://www.ivpn.net/> <sup>[[Archive.org]][365]</sup> (check the top banner)

    -   ProtonVPN: Follow their instructions here <https://protonvpn.com/support/vpn-ip-change/> <sup>[[Archive.org]][366]</sup>
...
-   Create a Whonix Workstation Disposable VM (follow this tutorial <https://www.whonix.org/wiki/Qubes/DisposableVM> <sup>[[Archive.org]][367]</sup>)
...
Apply the instructions from <https://brave.com/linux/> <sup>[[Archive.org]][368]</sup> (Fedora 28+ section) and run the following commands:
...
Edit the Whonix Disposable VM template and follow instructions here <https://www.whonix.org/wiki/Install_Software> <sup>[[Archive.org]][327]</sup>
...
Now you will have to follow the instructions from here: <https://github.com/anbox/anbox-modules> <sup>[[Archive.org]][369]</sup>
...
Now we will follow their other tutorial from here: <https://github.com/anbox/anbox/blob/master/docs/install.md> <sup>[[Archive.org]][370]</sup>
...
You will need something to store your data (logins/passwords, identities and TOTP[^322] information).

For this purpose, I strongly recommend KeePassXC because of their integrated TOTP feature. This is the ability to create entries for 2FA[^323] authentication with the authenticator feature.
...
Captcha[^324] stands for "Completely Automated Public Turing test to tell Computers and Humans Apart" are Turing tests[^325] puzzles you need to complete before accessing a form/website. You will mostly encounter those provided by Google (reCaptcha service[^326]) and Cloudflare (hCaptcha[^327]). hCaptcha is used on 15% of the internet by their own metrics[^328].
...
If you frequently use VPNs or Tor, you will quickly encounter many captchas everywhere[^329]. Quite often when using Tor, even if you succeed in solving all the puzzles (sometimes dozens in a row), you will still be denied after solving the puzzles.

See <https://gitlab.torproject.org/legacy/trac/-/wikis/org/doc/ListOfServicesBlockingTor> <sup>[[Archive.org]][298]</sup>

While most people think those puzzles are only about solving a little puzzle, it is important to understand that it is much more complex and that modern Captchas uses advanced machine learning and risk analysis algorithms to check if you are human[^330]:

-   They check your browser, cookies and browsing history using Browser fingerprinting[^331].

-   They track your cursor movements (speed, accuracy) and use algorithms to determine if it is "human/organic".

-   They track your behavior before/during/after the tests to ensure you are "human"[^332].
...
You will often experience several in a row (sometimes endlessly[^333]) and sometimes very difficult ones involving reading undecipherable characters or identifying various objects on endless pictures sets. You will also have more captchas if you use an ad blocking system (uBlock for example) or if your account was flagged for any reason for using VPNs or Tor previously.

You will also have (in my experience) more Captchas (Google's reCaptcha) if you do not use a Chromium based browser. But this can be mitigated by using Chromium based browsers such as Brave or Ungoogled-Chromium. There is also a Browser extension called Buster that could help you those <https://github.com/dessant/buster> <sup>[[Archive.org]][372]</sup>.

As for Cloudflare (hCaptcha), you could also use their Accessibility solution here (<https://www.hcaptcha.com/accessibility> <sup>[[Archive.org]][373]</sup>) which would allow you to sign-up (with your anonymous identity created later) and set a cookie within your Browser that would allow you to bypass their captchas. Another solution to mitigate hCaptcha would be to use their own solution called "Privacy Pass"[^334] <https://privacypass.github.io/> <sup>[[Archive.org]][374]</sup> in the form of a Browser extension you could install in your VM Browser.
...
Most platforms (including the privacy-oriented ones such as Signal/Telegram/ProtonMail will require a phone number to register and most countries now make it mandatory to submit a proof of ID to register[^335].
...
Browser and Device[^336] Fingerprinting are usually integrated into the Captcha services but also in other various services.

Many platforms (like Google[^337]) will check your browser for various capabilities and settings and block Browsers they do not like. This is one of the reasons I recommend using Chromium based Browsers such as Brave Browser over Tor Browser within this VM.
...
This is for instance now the case on YouTube for some European Users[^338] but also used by services like Amazon that requires a valid payment method for creating an account.
...
This option is often presented as the "default one", hiding away the "Sign-in with e-mail and password" with clever Dark Patterns[^339] and unfortunately sometimes required.
...
This guide will not cover this one (yet) as it is mainly used on financial platforms (that will be able to identify you with other means anyway) and some dating apps like Tinder[^340]. Unfortunately, this method is now also sometimes being used on Facebook[^341] and Instagram as part of their verification methods (tho I did not face it yet so far).
...
Recently even platforms such as PornHub decided to implement similar measures in the future[^342].

This verification is very hard to defeat but possible. A method to possibly defeat those would be to use "deep fake" technology software such as the open-source FaceSwap <https://github.com/deepfakes/faceswap> <sup>[[Archive.org]][378]</sup> to generate the required verification pictures using a randomly computer-generated face that would be swapped over the picture of a complicit model (or a stock photo).
...
Some countries have even developed hotlines where you can report any subversive content[^343].
...
So what? Well instead of not trusting anyone or anything, I would advise to **"Trust but verify"**[^344] (or alternatively "Never trust, always verify" if you are more hardcore about it and want to apply Zero-Trust Security[^345]) instead.
...
This is the fun part where you will now create your identities from thin air. These identities do not exist but should be plausible and look "organic". They should ideally have a story, a "legend" (yes this is the real term for this[^346]).
...
-   Every identity you should have a matching profile picture associated to it. For this purpose, I recommend you just go to <https://thispersondoesnotexist.com/> <sup>[[Archive.org]][379]</sup> and generate a computer-generated profile picture. You can also generate such pictures yourself from your computer if you prefer by using the open-source StyleGan project here <https://github.com/NVlabs/stylegan2> <sup>[[Archive.org]][380]</sup>. Just refresh the page until you find a picture that matches your identity in all aspects (age, sex, and ethnicity) and save that picture. It would be even better to have several pictures associated to that identity but I do not have an "easy way" of doing that yet.

    -   **Bonus**, you could also make it more real by using this service (with an anonymous identity) <https://www.myheritage.com/deep-nostalgia> <sup>[[Archive.org]][381]</sup> to make a picture more lifelike. Here is an example:
...
You could also achieve the same result without using MyHeritage and by doing it yourself using for example <https://github.com/AliaksandrSiarohin/first-order-model> <sup>[[Archive.org]][383]</sup> but this will require more manual operations (**and requires an NVIDIA GPU**).
...
-   Always use TOTP 2FA (not SMS to prevent Sim Swapping attacks[^347] and to keep your identity working when your pre-paid card expires) using KeePassXC when available to secure your logins to various platforms.
...
Here is also a good guide on this specific topic: <https://gendersec.tacticaltech.org/wiki/index.php/Complete_manual#.22Real.22_names> <sup>[[Archive.org]][384]</sup>
...
-   Whonix/Tails: Create/Edit a file ```/usr/local/etc/torrc.d/50_user.conf```[^348].

-   On Tor Browser: Edit the torrc file located at ```Browser/TorBrowser/Data/Tor```[^349].
...
**Please note that this is restricting Onion Routing could limit your Anonymity if you are too restrictive. You can see a visualized list of available Exit Nodes here: <https://www.bigdatacloud.com/insights/tor-exit-nodes>** <sup>[[Archive.org]][385]</sup>

Here is the list of possibilities (this is a general list and many of those countries might not have Exit nodes at all): <https://b3rn3d.herokuapp.com/blog/2014/03/05/tor-country-codes/> <sup>[[Archive.org]][386]</sup>
...
On my side, I strongly condemn this type of real-name policy. See for instance this Wikipedia article giving some examples: <https://en.wikipedia.org/wiki/Facebook_real-name_policy_controversy> <sup>[[Wikiless]][387]</sup> <sup>[[Archive.org]][388]</sup>

Here are some more references about the German case for reference:

-   <https://slate.com/technology/2018/02/why-some-americans-are-cheering-germany-for-taking-on-facebooks-real-name-policy.html> <sup>[[Archive.org]][389]</sup>

-   <https://www.theverge.com/2018/2/12/17005746/facebook-real-name-policy-illegal-german-court-rules> <sup>[[Archive.org]][390]</sup>

-   <https://www.pcmag.com/news/german-court-rules-facebooks-real-name-policy-is-illegal> <sup>[[Archive.org]][391]</sup>

-   <https://www.vzbv.de/sites/default/files/downloads/2018/02/14/18-02-12_vzbv_pm_facebook-urteil_en.pdf> <sup>[[Archive.org]][392]</sup>

-   <https://www.pcmag.com/news/german-court-rules-facebooks-real-name-policy-is-illegal> <sup>[[Archive.org]][391]</sup>

-   <https://www.reuters.com/article/us-germany-facebook/german-court-rules-facebook-use-of-personal-data-illegal-idUSKBN1FW1FI> <sup>[[Archive.org]][393]</sup>
...
-   South Korea (see <https://en.wikipedia.org/wiki/Real-name_system#South_Korea> <sup>[[Wikiless]][394]</sup> <sup>[[Archive.org]][395]</sup>)
...
-   **Consider using the recommended tools on <https://privacytools.io/>** <sup>[[Archive.org]][396]</sup> **for your better privacy instead of the usual mainstream ones.**

-   **Consider using the recommended tools on <https://www.whonix.org/wiki/Documentation>** <sup>[[Archive.org]][326]</sup> **as well instead of the usual mainstream ones such as E-mail providers: <https://www.whonix.org/wiki/E-Mail#Anonymity_Friendly_Email_Provider_List>** <sup>[[Archive.org]][397]</sup>

**The following overview does not mention the privacy practices of those platforms but only their requirements for registering an account. If you want to use privacy-aware tools and platforms, head on to <https://privacytools.io/>** <sup>[[Archive.org]][396]</sup>
...
-   Is this against their ToS? No but yes <https://www.amazon.com/gp/help/customer/display.html?nodeId=202140280> <sup>[[Archive.org]][398]</sup>
...
-   Is this against their ToS? Yes <https://www.apple.com/legal/internet-services/icloud/en/terms.html> <sup>[[Archive.org]][399]</sup>
...
-   Is this against their ToS? No <https://briarproject.org/privacy-policy/> <sup>[[Archive.org]][400]</sup>
...
-   Is this against their ToS? No <https://discord.com/terms> <sup>[[Archive.org]][401]</sup>
...
-   Is this against their ToS? No <https://element.io/terms-of-service> <sup>[[Archive.org]][402]</sup>
...
-   Is this against their ToS? Yes <https://www.facebook.com/terms.php> <sup>[[Archive.org]][403]</sup>
...
-   Can you create accounts through Tor? Yes, but it is very difficult and their onion address[^350] will not help. In most cases you'll just have a random error at sign-up and your account suspended after sign-in."
...
-   Is this against their ToS? No <https://docs.github.com/en/free-pro-team@latest/github/site-policy/github-terms-of-service> <sup>[[Archive.org]][404]</sup>
...
-   Is this against their ToS? No <https://about.gitlab.com/handbook/legal/subscription-agreement/> <sup>[[Archive.org]][405]</sup>
...
-   Is this against their ToS? No <https://policies.google.com/terms> <sup>[[Archive.org]][406]</sup>
...
If your account gets suspended [^353] (this can happen on sign-up, after signing-up or after using it in some Google services), you can still get it unsuspended by submitting[^354] an appeal/verification (which will again require your Phone number and possibly an e-mail contact with Google support with the reason). Suspension of the account does not disable the e-mail forwarding but suspended account will be deleted after a while.
...
It is also possible that Google will require an ID check through indirect financial KYC or ID picture check if you attempt to access/publish mature content on their platform[^355].

#### HackerNews:

-   Is this against their ToS? No <https://www.ycombinator.com/legal/#tou> <sup>[[Archive.org]][407]</sup>
...
-   Is this against their ToS? **Maybe?** I am not sure <https://help.instagram.com/581066165581870?ref=dp> <sup>[[Archive.org]][408]</sup>
...
-   Is this against their ToS? No <https://jami.net/privacy-policy/> <sup>[[Archive.org]][409]</sup>
...
-   Is this against their ToS? No <https://www.ivpn.net/tos/> <sup>[[Archive.org]][410]</sup>
...
-   Is this against their ToS? Yes <https://www.linkedin.com/legal/user-agreement> <sup>[[Archive.org]][411]</sup>
...
LinkedIn will then require you go through a verification process that will unfortunately require you to send an ID proof (identity card, passport, driver license). This ID verification is processed by a company called Jumio[^356] that specializes in ID proofing. This is most likely a dead end as this would force you to develop some strong Photoshop skills.
...
-   Is this against their ToS? No unless it is about crypto <https://policy.medium.com/medium-terms-of-service-9db0094a1e0f> <sup>[[Archive.org]][412]</sup>
...
-   Is this against their ToS? Yes <https://www.microsoft.com/en/servicesagreement/> <sup>[[Archive.org]][413]</sup>
...
-   Is this against their ToS? No <https://mullvad.net/en/help/terms-service/> <sup>[[Archive.org]][414]</sup>
...
-   Is this against their ToS? No <https://njal.la/tos/> <sup>[[Archive.org]][415]</sup>
...
-   Is this against their ToS? No <https://ProtonMail.com/terms-and-conditions> <sup>[[Archive.org]][416]</sup>
...
They are recommended by privacytools.io[^357]. Their only apparent issue is that they do require (in most cases) a phone number or another e-mail address for registration (when you try to register from a VPN or Tor at least).

They claim they do not store/link the phone/e-mail associated with the registration but only store a hash that is not linked to the account[^358]. If their claim is true and the hash is not linked to your account, and that you followed my guide regarding the phone number, you should be reasonably safe from tracking.
...
-   Is this against their ToS? No <https://protonvpn.com/terms-and-conditions> <sup>[[Archive.org]][417]</sup>
...
-   Is this against their ToS? No <https://www.redditinc.com/policies> <sup>[[Archive.org]][418]</sup>
...
-   Is this against their ToS? Yes <https://slashdotmedia.com/terms-of-use/> <sup>[[Archive.org]][419]</sup>
...
-   Is this against their ToS? No <https://telegram.org/tos> <sup>[[Archive.org]][420]</sup>
...
Their appeal process is just sending an e-mail to <recover@telegram.org> <sup>[[Archive.org]][421]</sup> stating your phone number and issue and hope they answer.
...
-   Is this against their ToS? No <https://tutanota.com/terms/> <sup>[[Archive.org]][422]</sup>
...
This time you will need to submit an appeal using a form[^359], provide a good reason and wait for the appeal to be processed by Twitter. During that process, it is possible that you will receive an e-mail (on ProtonMail) asking you to reply to a customer service ticket to prove that you do have access to your e-mail and that it is you. This will be directed toward your Gmail address but will arrive on your ProtonMail.
...
-   Is this against their ToS? No <https://www.twitch.tv/p/en/legal/terms-of-service/> <sup>[[Archive.org]][423]</sup>
...
-   Is this against their ToS? **Yes** <https://www.whatsapp.com/legal/updates/terms-of-service-eea> <sup>[[Archive.org]][424]</sup>
...
You are going to have to find a different way to post there using at least seven proxies[^360] that are not known by 4chan blocking system (hint: Anonymous VPS using Monero is probably your best option).
...
End-to-end Encryption[^361] (aka e2ee) is a rather simple concept. It just means only you and your destination know each-others public encryption keys and no one in between that would be eavesdropping would be able to decrypt the communication.
...
More on this topic on this YouTube video: <https://www.youtube.com/watch?v=zSQtyW_ywZc> <sup>[[Invidious]][427]</sup>
...
Zero-Access Encryption[^363] at rest is used when you store data at some provider (let us say your chat history or chat backups) but this history or backup is encrypted on your side and cannot be read or decrypted by the provider hosting it.
...
Such feature would have prevented important hacks such as the Cambridge Analytica scandal[^364] if it was implemented.
...
-   The Sealed Sender option[^365].

-   The Private Contact Discovery[^366].

-   The Private Group System[^367].
...
-   Wikipedia, <https://en.wikipedia.org/wiki/Comparison_of_instant_messaging_protocols> <sup>[[Wikiless]][428]</sup> <sup>[[Archive.org]][429]</sup>

-   Wikipedia, <https://en.wikipedia.org/wiki/Comparison_of_cross-platform_instant_messaging_clients> <sup>[[Wikiless]][430]</sup> <sup>[[Archive.org]][431]</sup>

-   Secure Messaging Apps <https://www.securemessagingapps.com/> <sup>[[Archive.org]][432]</sup>

-   ProtonMail Blog, <https://protonmail.com/blog/whatsapp-alternatives/> <sup>[[Archive.org]][433]</sup>

-   Whonix Documentation, Instant Messenger Chat <https://www.whonix.org/wiki/Chat> <sup>[[Archive.org]][434]</sup>
...
I will recommend these options in that order (as also recommend by privacytools.io[^368]'[^369] except for Session):

-   Native Tor Onion Routing Support (**preferred**):

    -   Briar (<https://briarproject.org/> <sup>[[Archive.org]][435]</sup>)* **(Android/Linux only)**

    -   OnionShare version >2.3 (<https://onionshare.org/> <sup>[[Archive.org]][436]</sup>)* (**Desktop multiplatform only)**

-   Non-Native Tor Support (needs additional steps for ideal anonymity):

    -   Jami (<https://jami.net/> <sup>[[Archive.org]][437]</sup>)

    -   Element/Matrix.org (<https://element.io/> <sup>[[Archive.org]][438]</sup>)
...
If you must do so, you should take some steps because you cannot really trust any organization to protect your anonymity[^370]:
...
For this, I strongly recommend the use of SecureDrop[^371] (<https://securedrop.org/> <sup>[[Archive.org]][439]</sup>) which is an open-source project from the Freedom of the Press foundation.

Ideally you should use SecureDrop over Tor and you will find a curated list of those here <https://github.com/alecmuffett/real-world-onion-sites> <sup>[[Archive.org]][440]</sup>
...
-   Check regularly the eventual appearance of compromise of any of your identities using <https://haveibeenpwned.com/> <sup>[[Archive.org]][441]</sup> (obviously from a safe environment).
...
The process is fairly simple and all you will need is to follow Veracrypt tutorial here: <https://www.veracrypt.fr/en/Beginner%27s%20Tutorial.html> <sup>[[Archive.org]][442]</sup>
...
Qubes OS recommends using their own utility for backups as documented here <https://www.qubes-os.org/doc/backup-restore/> <sup>[[Archive.org]][443]</sup> . But I think it is just a hassle and provides limited added value unless you just want to back-up a single Qube. So instead, I am also recommending just making a full image with Clonezilla which will remove all the hassle and bring you back a working system in a few easy steps.
...
For smaller files, consider Cryptpad.fr as recommended by Privacytools.io at <https://privacytools.io/providers/cloud-storage/> <sup>[[Archive.org]][447]</sup> (limited to 1GB total).
...
If you just want to save information (text), I will recommend the use secure and private pastebins[^373]. Mostly I will stick to the ones recommended by privacytools.io (<https://privacytools.io/providers/paste/> <sup>[[Archive.org]][448]</sup> ):
...
To that the answer is very simple and a clear consensus for everyone: <https://syncthing.net/> <sup>[[Archive.org]][449]</sup>
...
So, the fact is that it is very unlikely[^379]'[^380] and difficult for a forensic examiner to be able to recover data from a Trimmed SSD but it is not completely impossible either[^381]'[^382]'[^383] if they are fast enough and have access to extensive equipment, skills and motivation.
...
-   Easy options for less experienced users:
    ...
    -   Buy PartedMagic[^384] for 11$ and use it to erase any disk.
...
Trim should be sufficient in most cases and you could just use the blkdiscard command to force an entire device trim as explained here: <https://wiki.archlinux.org/index.php/Solid_state_drive#Trim_an_entire_device> <sup>[[Archive.org]][456]</sup>
...
-   Option A: Follow one of these tutorials:
    ...
    -   <https://linuxhint.com/completely_wipe_hard_drive_ubuntu/> <sup>[[Archive.org]][459]</sup>

    -   <https://linoxide.com/linux-command/commands-wipe-disk-linux/> <sup>[[Archive.org]][460]</sup>

    -   <https://wiki.archlinux.org/index.php/Securely_wipe_disk> <sup>[[Archive.org]][461]</sup>

I recommend using dd or shred for this purpose.

-   Option B: Install and use BleachBit <https://www.bleachbit.org/download/linux> <sup>[[Archive.org]][457]</sup> or follow this EFF tutorial <https://ssd.eff.org/en/module/how-delete-your-data-securely-linux> <sup>[[Archive.org]][462]</sup>
...
-   Option B: Use external tools such as:
    ...
    -   Eraser (open-source): <https://eraser.heidi.ie/download/> <sup>[[Archive.org]][463]</sup>

    -   KillDisk Free: <http://killdisk.com/killdisk-freeware.htm> <sup>[[Archive.org]][464]</sup>
...
Unfortunately, the MacOS Recovery disk utility will not be able to perform a secure erase of your SSD drive as stated in Apple documentation <https://support.apple.com/en-gb/guide/disk-utility/dskutl14079/mac> <sup>[[Archive.org]][465]</sup>.
...
-   <https://support.apple.com/guide/disk-utility/erase-and-reformat-a-storage-device-dskutl14079/mac> <sup>[[Archive.org]][466]</sup>

-   <https://support.apple.com/guide/disk-utility/encrypt-protect-a-storage-device-password-dskutl35612/mac> <sup>[[Archive.org]][467]</sup> or using Veracrypt full disk encryption.
...
Follow this tutorial: <https://support.apple.com/guide/disk-utility/erase-and-reformat-a-storage-device-dskutl14079/mac> <sup>[[Archive.org]][466]</sup> and use the secure erase option from Disk Utility which should work fine on HDD and Thumb drives.
...
-   Right Click a file/folder:
    ...
    -   BleachBit: Shred with BleachBit (or see this tutorial from the EFF <https://ssd.eff.org/en/module/how-delete-your-data-securely-windows> <sup>[[Archive.org]][469]</sup>)
...
-   Decrypt and re-encrypt (using LUKS for instance following this tutorial <https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption#Re-encrypting_devices> <sup>[[Archive.org]][470]</sup>) the whole drive to overwrite all free space after data deletion. This will ensure overwriting of all the free space.

-   Trim using ```fstrim --all``` and then fill up the entire free space of the disk using a utility such as:

    -   BleachBit <https://www.bleachbit.org/download/linux> <sup>[[Archive.org]][457]</sup>
    ...
    -   Use the old school dd method (taken from this answer <https://superuser.com/questions/19326/how-to-wipe-free-disk-space-in-linux> <sup>[[Archive.org]][458]</sup>) run these commands on the drive you want to fill:
...
-   You can do this the graphical way with BleachBit following this tutorial from the EFF: <https://ssd.eff.org/en/module/how-delete-your-data-securely-linux> <sup>[[Archive.org]][462]</sup>

-   Or you can do this from the command line following this tutorial: <https://linuxhint.com/completely_wipe_hard_drive_ubuntu/> <sup>[[Archive.org]][459]</sup> (For this purpose I recommend wipe and shred).
...
-   Decrypt and re-encrypt (using LUKS using this tutorial <https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption#Re-encrypting_devices> <sup>[[Archive.org]][470]</sup> or Veracrypt from the graphical interface for instance) the whole drive to overwrite all free space after data deletion. This will ensure overwriting of all the free space.
...
-   Fill the free space using one of those methods:
    ...
    -   Use the old school dd method (taken from this answer <https://superuser.com/questions/19326/how-to-wipe-free-disk-space-in-linux> <sup>[[Archive.org]][458]</sup>) run these commands:
...
Please follow this documentation to Trim within Qubes OS: <https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md> <sup>[[Archive.org]][471]</sup>
...
-   Decrypt and re-encrypt the whole drive to overwrite all free space after data deletion. This will ensure overwriting of all the free space. I didn't find a reliable tutorial on how to do this safely on Qubes OS but it's possible this Tutorial could work as well <https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption#Re-encrypting_devices> <sup>[[Archive.org]][470]</sup> (at your own risk, this has not been tested yet).

-   Refer to this Documentation (<https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md> <sup>[[Archive.org]][471]</sup>) and then trim using "fstrim --all" and then fill up the entire free space of the disk using an utility such as:
...
If Trim is supported and enabled by your Linux Distribution for your external SSD drive. There should be no issue in securely deleting data normally and just issue an "fstrim --all" from terminal to trim the drive. Refer to this Documentation (<https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md> <sup>[[Archive.org]][471]</sup>) to enable trim on a drive.
...
-   If your file system is APFS, you do not need to worry about Trim, it apparently happens asynchronously as the OS writes data[^390] according to their own documentation.
...
-   If your file system is HFS+, you could run First Aid on your System Drive from the Disk Utility which should perform a Trim operation in the details (<https://support.apple.com/en-us/HT210898> <sup>[[Archive.org]][472]</sup>)

![][473]

#### System/Internal, External HDD drive or a Thumb Drive:

Unfortunately, Apple has removed the secure erase options from the trash bin even for HDD drives[^391]. So, you are left with using other tools:

-   Permanent Eraser <http://www.edenwaith.com/products/permanent%20eraser/> <sup>[[Archive.org]][474]</sup>

-   From the terminal you can use the "rm --P filename" command which should erase the file and overwrite it as explained in this EFF tutorial <https://ssd.eff.org/en/module/how-delete-your-data-securely-macos> <sup>[[Archive.org]][475]</sup>.
...
Consider also reading this documentation if you're going with Whonix <https://www.whonix.org/wiki/Anti-Forensics_Precautions> <sup>[[Archive.org]][328]</sup> as well as their general hardening tutorial for all platforms here <https://www.whonix.org/wiki/System_Hardening_Checklist> <sup>[[Archive.org]][476]</sup>

### Removing Metadata from Files/Documents/Pictures:

#### Pictures and videos:

On Windows, MacOS and Linux I would recommend ExifTool (<https://exiftool.org/> <sup>[[Archive.org]][477]</sup>) and/or ExifCleaner (<https://exifcleaner.com/> <sup>[[Archive.org]][478]</sup>) that allows viewing and/or removing those properties.

**ExifTool is natively available on TAILS and Whonix Workstation.**

##### ExifCleaner:

Just install it from <https://exifcleaner.com/> <sup>[[Archive.org]][478]</sup>, run and drag and drop the files into the GUI.
...
Here is a tutorial to remove metadata from a Picture using OS provided tools: <https://www.purevpn.com/internet-privacy/how-to-remove-metadata-from-photos> <sup>[[Archive.org]][479]</sup>

##### Cloaking/Obfuscating to prevent picture recognition:

Consider the use of Fawkes <https://sandlab.cs.uchicago.edu/fawkes/> <sup>[[Archive.org]][480]</sup> (<https://github.com/Shawn-Shan/fawkes> <sup>[[Archive.org]][481]</sup>) to cloak the images from picture recognition tech on various platforms.

Or if you want on-line versions, consider:

-   <https://lowkey.umiacs.umd.edu/> <sup>[[Archive.org]][482]</sup>

-   <https://adversarial.io/> <sup>[[Archive.org]][483]</sup>

#### PDF Documents:

##### PDFParanoia (Linux/Windows/MacOS/QubesOS):

Consider using <https://github.com/kanzure/pdfparanoia> <sup>[[Archive.org]][484]</sup> which will remove metadata and watermarks on any PDF.
...
First, here is a tutorial to remove metadata from Office documents: <https://support.microsoft.com/en-us/office/remove-hidden-data-and-personal-information-by-inspecting-documents-presentations-or-workbooks-356b7b5d-77af-44fe-a07f-9aa4d085966f> <sup>[[Archive.org]][485]</sup>. Make sure however that you do use the latest version of Office with the latest security updates.

Alternatively, on Windows, MacOS, Qubes OS, and Linux I would recommend ExifTool (<https://exiftool.org/> <sup>[[Archive.org]][477]</sup>) and/or ExifCleaner (<https://exifcleaner.com/> <sup>[[Archive.org]][478]</sup>) that allows viewing and/or removing those properties
...
Another option good tool IMHO to remove metadata from various documents is the open-source mat2 recommended by privacytools.io[^392] (<https://0xacab.org/jvoisin/mat2> <sup>[[Archive.org]][486]</sup>) which you can use on Linux quite easily. I never managed to make it work properly within Windows due various dependencies issues despite the provided instructions. It is however very straightforward to install and use on Linux.
...
Mat2 is also pre-installed on the Whonix Workstation VM[^393] and available on TAILS by default[^394].
...
Note that it's possible to run Whonix in Live mode leaving no traces when you shut down the VMs, consider reading their documentation here <https://www.whonix.org/wiki/VM_Live_Mode> <sup>[[Archive.org]][488]</sup> and here <https://www.whonix.org/wiki/Warning#Whonix_.E2.84.A2_Persistence_vs_Live_vs_Amnesic> <sup>[[Archive.org]][213]</sup>.
...
Most of the info from this section can also be found at this nice guide <https://github.com/drduh/macOS-Security-and-Privacy-Guide> <sup>[[Archive.org]][281]</sup>
...
Lastly you can also disable Gatekeeper altogether by issuing the following command in terminal[^395]:

-   ```sudo spctl --master-disable```

Refer to this section of this guide for further information <https://github.com/drduh/macOS-Security-and-Privacy-Guide#gatekeeper-and-xprotect> <sup>[[Archive.org]][281]</sup>
...
See this section of this guide for guidance on where to find and how to delete such artifacts: <https://github.com/drduh/macOS-Security-and-Privacy-Guide#metadata-and-artifacts> <sup>[[Archive.org]][281]</sup>

Many of those can be deleted using some various commercial third-party tools but I would personally recommend using the free and well-known Onyx which you can find here: <https://www.titanium-software.fr/en/onyx.html> <sup>[[Archive.org]][489]</sup>. Unfortunately, it is closed-source but it is notarized, signed and has been trusted for many years.
...
-   If your file system is HFS+ (or any other than APFS), you could run First Aid on your System Drive from the Disk Utility which should perform a Trim operation in the details (<https://support.apple.com/en-us/HT210898> <sup>[[Archive.org]][472]</sup>).

![][473]

### Linux (Qubes OS):

Please consider their guidelines <https://github.com/Qubes-Community/Contents/blob/master/docs/security/security-guidelines.md> <sup>[[Archive.org]][490]</sup>

If you are using Whonix on Qubes OS, please consider following some of their guides:

-   Whonix System Hardening guide <https://www.whonix.org/wiki/System_Hardening_Checklist> <sup>[[Archive.org]][476]</sup>

-   Enabling App Armor on Qubes <https://www.whonix.org/wiki/Qubes/AppArmor> <sup>[[Archive.org]][358]</sup>

-   Also consider the use of Linux Kernel Guard <https://www.whonix.org/wiki/Linux_Kernel_Runtime_Guard_LKRG> <sup>[[Archive.org]][491]</sup>
...
Nevertheless, you might want to clean some logs. Just use this convenient tool: <https://github.com/sundowndev/go-covermyass> <sup>[[Archive.org]][492]</sup> (instructions on the page)
...
Consider the use of Linux Kernel Guard as an added measure <https://www.whonix.org/wiki/Linux_Kernel_Runtime_Guard_LKRG> <sup>[[Archive.org]][491]</sup>
...
-   Launch Regedit using this tutorial: <https://support.microsoft.com/en-us/windows/how-to-open-registry-editor-in-windows-10-deab38e6-91d6-e0aa-4b7c-8878d9e07b11> <sup>[[Archive.org]][493]</sup>
...
-   Download Shellbag Analyzer & Cleaner from <https://privazer.com/en/download-shellbag-analyzer-shellbag-cleaner.php> <sup>[[Archive.org]][494]</sup>
...
-   Download and install PrivaZer from <https://privazer.com/en/download.php> <sup>[[Archive.org]][495]</sup>
...
-   Get and install the latest version from BleachBit here <https://www.bleachbit.org/download> <sup>[[Archive.org]][496]</sup>
...
-   <https://justdeleteme.xyz/> <sup>[[Archive.org]][497]</sup>

-   <https://justgetmydata.com/> <sup>[[Archive.org]][498]</sup>
...
Go to their "Remove outdated content from Google Search" page here: <https://search.google.com/search-console/remove-outdated-content> <sup>[[Archive.org]][499]</sup> and submit a request accordingly.
...
Go to their "Content Removal" page here: <https://www.bing.com/webmasters/tools/contentremoval> <sup>[[Archive.org]][500]</sup> and submit a request accordingly.
...
DuckDuckGo does not store cached version of pages[^396] and will instead forward you to a Google/Bing cached version if available.

In addition, DuckDuckGo source most of their searches from Bing (and not google)[^397] and therefore removing the content from Bing should in time have it removed it from DuckDuckGo too.
...
Once have your Yandex account, head to the Yandex Webmaster tools <https://webmaster.yandex.com> <sup>[[Archive.org]][501]</sup> and then select Tools and Delete URL <https://webmaster.yandex.com/tools/del-url/> <sup>[[Archive.org]][502]</sup>
...
Yes, Yahoo Search still exists but as per their help page <https://help.yahoo.com/kb/SLN4530.html> <sup>[[Archive.org]][503]</sup> , there is no way to remove information or refresh information besides waiting. This could take 6 to 8 weeks.
...
A commonly used technique which combines the idea of a Dead Drop[^398] and Secure Communication Obfuscation[^399] through Steganography[^400] and/or Kleptography[^401] and has many names such as Koalang[^402] or "Talking Around" or even "Social Steganography". This technique is very old and still widely used nowadays by teenagers to bypass parental control. It is hiding in plain sight.
...
Wait, what is OPSEC? Well, OPSEC means Operations Security[^403]. The basic definition is: "OPSEC is the process of protecting individual pieces of data that could be grouped together to give the bigger picture ".
...
-   Consider the use of Haven <https://guardianproject.github.io/haven/> <sup>[[Archive.org]][506]</sup> on some old android phone to keep watch on your home/room while you are away.

-   Doxx "yourself" and your identities from time to time by looking for them yourself online using various search engines to monitor your online identities. You can even automate the process somewhat using various tools such as Google Alerts <https://www.google.com/alerts> <sup>[[Archive.org]][507]</sup>.
...
-   Never ever leave your laptop unattended/on/unlocked anywhere when conducting sensitive activities. Remember the story of Ross Ulbricht and his arrest <https://en.wikipedia.org/wiki/Ross_Ulbricht#Silk_Road,_arrest_and_trial> <sup>[[Wikiless]][508]</sup> <sup>[[Archive.org]][509]</sup>.

-   Check for tampering regularly (not only your devices but also your home/room).

-   If you can, do not talk to the police/authorities (at least if you are in the US) <https://www.youtube.com/watch?v=d-7o9xYp7eE> <sup>[[Invidious]][510]</sup> without a lawyer. Remain silent.
...
-   Read those tips here <https://www.whonix.org/wiki/DoNot> <sup>[[Archive.org]][325]</sup>

-   **Finally, have common sense, do not be dumb, look and learn from others' mistakes, watch these:**

    -   2020, Sinwindie, OSINT and Dark Web Markets, Why OPSEC Still Matters <https://www.youtube.com/watch?v=IqZZU9lFlF4> <sup>[[Invidious]][511]</sup>

    -   2020, RSA Conference 2020, When Cybercriminals with Good OpSec Attack <https://www.youtube.com/watch?v=zXmZnU2GdVk> <sup>[[Invidious]][512]</sup>

    -   2015, DEFCON 22, Adrian Crenshaw- Dropping Docs on Darknets: How People Got Caught, <https://www.youtube.com/watch?v=eQ2OZKitRwc> <sup>[[Invidious]][513]</sup> ([Slides][] <sup>[[Archive.org]][514]</sup>)

    -   2017, Ochko123 - How the Feds Caught Russian Mega-Carder Roman Seleznev <https://www.youtube.com/watch?v=6Chp12sEnWk> <sup>[[Invidious]][515]</sup>

    -   2015, DEF CON 22 - Zoz - Don't Fuck It Up! <https://www.youtube.com/watch?v=J1q4Ir2J8P8> <sup>[[Invidious]][516]</sup>

    -   2020, Bad Opsec - How Tor Users Got Caught, <https://www.youtube.com/watch?v=GR_U0G-QGA0> <sup>[[Invidious]][517]</sup>
...
Keep in mind that many countries have specific laws to compel you to reveal your passwords that could override your "right to remain silent". See this Wikipedia article: <https://en.wikipedia.org/wiki/Key_disclosure_law> <sup>[[Wikiless]][518]</sup> <sup>[[Archive.org]][519]</sup> and this other visual resource with law references <https://www.gp-digital.org/world-map-of-encryption/> <sup>[[Archive.org]][520]</sup>.
...
-   **Extend time for Tor-Exit node hosting (current expiration date is September 30, 2021. About 60$-54€/year needed total for this.**
...
Donate at <https://anonymousplanet.org/donations.html> <sup>[[Mirror]][521]</sup> <sup>[[Archive.org]][522]</sup> <sup>[[Tor Mirror]][523]</sup> or directly by sending Monero (XMR) to this address: ```4549BGJrEPBfpiPRL9CVGzGMgJnC1Dzf8EXLVfY8Ukrnj7LzkTV611dGf9tuQHiSQjbixsNWiffNiV5fPB3LkyF7UXi3vwQ```
...
-   The Easiest:
    ...
    -   Using the Snowflake addon on your browser (<https://snowflake.torproject.org/> <sup>[[Archive.org]][527]</sup>)

-   Slightly more work:

    -   Running a Tor relay node (<https://community.torproject.org/relay/> <sup>[[Archive.org]][528]</sup>)

        -   See [Recommended VPS hosting providers]

        -   Additional Tutorial: <https://torrelay.ca/> <sup>[[Archive.org]][529]</sup>

If you want a bit more challenge, you can also run a Tor Exit node anonymously using the recommended VPS providers above.

For this, see <https://blog.torproject.org/tips-running-exit-node> <sup>[[Archive.org]][530]</sup>

[]{#_Toc76996359 .anchor}This project for instance is running a Tor Exit node using the donations from readers. You can see it here: <https://metrics.torproject.org/rs.html#details/970814F267BF3DE9DFF2A0F8D4019F80C68AEE26> <sup>[[Archive.org]][531]</sup>
...
-   **Special Thanks to Edward Snowden and who inspired me to write this guide (buy and read his book please <https://en.wikipedia.org/wiki/Permanent_Record_(autobiography)>** <sup>[[Wikiless]][532]</sup> <sup>[[Archive.org]][533]</sup>**)**
...
-   Download and install W10Privacy from <https://www.w10privacy.de/english-home/> <sup>[[Archive.org]][534]</sup>
...
-   Download and run WindowsSpyBlocker from <https://crazymax.dev/WindowsSpyBlocker/download/> <sup>[[Archive.org]][535]</sup>
...
<https://www.microsoft.com/en-us/software-download/windows10> <sup>[[Archive.org]][536]</sup>
...
-   System Rescue:
    ...
    -   Create a System Rescue USB disk following these instructions <https://www.system-rescue.org/Installing-SystemRescue-on-a-USB-memory-stick/> <sup>[[Archive.org]][537]</sup> (download the ISO and write to an USB stick with Rufus).
...
-   SATA SSD:
    ...
    -   ATA Secure Erase:
        ...
        -   Follow one of these tutorials
            ...
            -   <https://wiki.archlinux.org/index.php/Solid_state_drive/Memory_cell_clearing> <sup>[[Archive.org]][538]</sup>

            -   <https://ata.wiki.kernel.org/index.php/ATA_Secure_Erase> <sup>[[Archive.org]][539]</sup>

            -   <https://tinyapps.org/docs/wipe_drives_hdparm.html> <sup>[[Archive.org]][540]</sup>

    -   ATA Sanitize:

        -   Follow this tutorial <https://tinyapps.org/docs/ata_sanitize_hdparm.html> <sup>[[Archive.org]][541]</sup>
...
-   NVMe SSD:
    ...
    -   Follow one of these tutorials:
        ...
        -   <https://tinyapps.org/docs/nvme-secure-erase.html> <sup>[[Archive.org]][542]</sup>

        -   <https://tinyapps.org/docs/nvme-sanitize.html> <sup>[[Archive.org]][543]</sup>

# Appendix E: Clonezilla

-   Get Clonezilla by just following these instructions: <https://clonezilla.org/liveusb.php> <sup>[[Archive.org]][544]</sup> (I recommend the Alternative version AMD64 that should work with most recent laptops)

-   Boot from Clonezilla

-   Follow these steps to make a backup: <https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/01_Save_disk_image> <sup>[[Archive.org]][545]</sup>
...
-   You are done, if you need to restore, follow these instructions: <https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/02_Restore_disk_image> <sup>[[Archive.org]][546]</sup>
...
-   Download and install Tor Browser according to the instructions from <https://www.torproject.org/download/> <sup>[[Archive.org]][547]</sup>

-   Open Tor Browser

-   Click the little shield Icon and select your Security level (see <https://tb-manual.torproject.org/security-settings/> <sup>[[Archive.org]][548]</sup> for details):
...
If you are experiencing issues connecting to Tor due to Censorship or Blocking, you might consider using Tor bridges as explained here: <https://bridges.torproject.org/> <sup>[[Archive.org]][549]</sup>
...
-   Native Tools:
    ...
    -   Windows 10 Disk Cleanup Utility: <https://support.microsoft.com/en-us/windows/disk-cleanup-in-windows-10-8a96ff42-5751-39ad-23d6-434b4d5b9a68> <sup>[[Archive.org]][550]</sup>
...
-   Windows 10 Optimize Utility (Defrag on HDD Drives): <https://support.microsoft.com/en-us/windows/defragment-your-windows-10-pc-048aefac-7f1f-4632-d48a-9700c4ec702a> <sup>[[Archive.org]][551]</sup>
...
-   Third Party Tools:
    ...
    -   The open-source utility BleachBit <https://www.bleachbit.org/> <sup>[[Archive.org]][552]</sup>

    -   The closed-source utility PrivaZer <https://privazer.com/> <sup>[[Archive.org]][553]</sup>
...
There are several utilities that are recommend (like the old unmaintained DBAN[^409]) or System Rescue CD (<https://www.system-rescue.org/> <sup>[[Archive.org]][554]</sup>) for this but personally, I will recommend the use of ShredOS.

Feel free do go with DBAN instead if you want (using this tutorial: <https://www.lifewire.com/how-to-erase-a-hard-drive-using-dban-2619148> <sup>[[Archive.org]][555]</sup>), the process is basically the same but will not work out of the box with UEFI laptops.

If you want to go with System-Rescue, just head to their website and follow the instructions.

## Windows:

-   Download ShredOS from <https://github.com/PartialVolume/shredos.2020.02> <sup>[[Archive.org]][556]</sup>

-   Unzip the ISO file

-   Download Rufus from <https://rufus.ie/> <sup>[[Archive.org]][557]</sup>
...
-   Follow instructions on <https://github.com/PartialVolume/shredos.2020.02> <sup>[[Archive.org]][556]</sup>
...
-   SanDisk DashBoard: <https://kb.sandisk.com/app/answers/detail/a_id/15108/~/dashboard-support-information> <sup>[[Archive.org]][558]</sup>

-   Seagate SeaTools: <https://www.seagate.com/support/downloads/seatools/> <sup>[[Archive.org]][559]</sup>

-   Samsung Magican: <https://www.samsung.com/semiconductor/minisite/ssd/download/tools/> <sup>[[Archive.org]][560]</sup>

-   Kingston SSD Manager: <https://www.kingston.com/unitedstates/en/support/technical/ssdmanager> <sup>[[Archive.org]][561]</sup>

-   Lenovo:

    -   Most likely native utility available within the BIOS/UEFI, please check

    -   Drive Erase Utility: <https://support.lenovo.com/us/en/downloads/ds019026-thinkpad-drive-erase-utility-for-resetting-the-cryptographic-key-and-erasing-the-solid-state-drive-thinkpad> <sup>[[Archive.org]][562]</sup>

-   Crucial Storage Executive: <https://www.crucial.com/support/storage-executive> <sup>[[Archive.org]][563]</sup>

-   Western Digital Dashboard: <https://support.wdc.com/downloads.aspx?p=279> <sup>[[Archive.org]][564]</sup>

-   HP: Follow instructions on <https://store.hp.com/us/en/tech-takes/how-to-secure-erase-ssd> <sup>[[Archive.org]][565]</sup>

-   Transcend SSD Scope: <https://www.transcend-info.com/Support/Software-10/> <sup>[[Archive.org]][566]</sup>

-   Dell:

    -   Most likely native utility available within the BIOS/UEFI, please check <https://www.dell.com/support/kbdoc/en-us/000134997/using-the-dell-bios-data-wipe-function-for-optiplex-precision-and-latitude-systems-built-after-november-2015?lwp=rt> <sup>[[Archive.org]][567]</sup>

## Tools that provide only support from running OS (for external drives).

-   Toshiba Storage Tools: <https://www.toshiba-storage.com/downloads/> <sup>[[Archive.org]][568]</sup>
...
Follow this good tutorial: <https://www.glump.net/howto/desktop/enable-trim-on-an-external-ssd-on-linux> <sup>[[Archive.org]][569]</sup>

### ATA/NVMe Operations (Secure Erase/Sanitize):

**It is not "recommended". Please read the disclaimers here <https://ata.wiki.kernel.org/index.php/ATA_Secure_Erase>** <sup>[[Archive.org]][539]</sup> **and here <https://wiki.archlinux.org/index.php/Solid_state_drive/Memory_cell_clearing>** <sup>[[Archive.org]][538]</sup>
...
See also this tutorial <https://code.mendhak.com/securely-wipe-ssd/> <sup>[[Archive.org]][570]</sup>
...
If your disk supports it but it is not enabled in MacOS. You could try issuing a "sudo trimforce enable" command from the Terminal and see if it enables Trim on your external SSD. And then again check the first aid command if it is not APFS (see this Tutorial for info <https://www.lifewire.com/enable-trim-for-ssd-in-os-x-yosemite-2260789> <sup>[[Archive.org]][571]</sup>)

If it does not work, I am not aware of any reliable method to enable TRIM besides the commercial utility Trim Enabler here <https://cindori.org/trimenabler/> <sup>[[Archive.org]][572]</sup> which claims support for external drives.
...
Download the latest Debian testing amd64 netinst ISO from <https://www.debian.org/CD/netinst/> <sup>[[Archive.org]][573]</sup>
...
-   Lenovo ThinkPads: <https://support.lenovo.com/be/en/solutions/migr-68369> <sup>[[Archive.org]][574]</sup>

-   HP (all): <https://support.hp.com/gb-en/document/c06204100> <sup>[[Archive.org]][575]</sup>

-   Dell (all): <https://www.dell.com/support/kbdoc/en-us/000146892/dell-data-wipe> <sup>[[Archive.org]][576]</sup>

-   Acer (Travelmate only): <https://us.answers.acer.com/app/answers/detail/a_id/41567/~/how-to-use-disk-sanitizer-on-acer-travelmate-notebooks> <sup>[[Archive.org]][577]</sup>
...
-   **Encrochat: <https://en.wikipedia.org/wiki/EncroChat>** <sup>[[Wikiless]][578]</sup> <sup>[[Archive.org]][579]</sup>

-   **Sky ECC: <https://en.wikipedia.org/wiki/Sky_ECC>** <sup>[[Wikiless]][580]</sup> <sup>[[Archive.org]][581]</sup>
...
There are three VPN companies recommended by privacytools.io (<https://privacytools.io/providers/vpn/> <sup>[[Archive.org]][582]</sup>) that accept cash payments: Mullvad, iVPN and ProtonVPN.
...
This does offer some disadvantage as Monero is not perfect as explained earlier in this guide and some global adversaries could maybe still track you. You will need to get Monero from an Exchange using the normal financial system and then pick a hosting (list here <https://www.getmonero.org/community/merchants/#exchanges> <sup>[[Archive.org]][583]</sup>)
...
There are plenty of tutorials on how to do this like this one <https://proprivacy.com/vpn/guides/create-your-own-vpn-server> <sup>[[Archive.org]][584]</sup>
...
-   (Windows/Linux/MacOS) <https://linuxize.com/post/how-to-setup-ssh-socks-tunnel-for-private-browsing/> <sup>[[Archive.org]][585]</sup>

-   (Windows/Linux/MacOS) <https://www.digitalocean.com/community/tutorials/how-to-route-web-traffic-securely-without-a-vpn-using-a-socks-tunnel> <sup>[[Archive.org]][586]</sup>

-   (Windows) <https://www.forwardproxy.com/2018/12/using-putty-to-setup-a-quick-socks-proxy/> <sup>[[Archive.org]][587]</sup>

-   (Linux/MacOS) <https://ma.ttias.be/socks-proxy-linux-ssh-bypass-content-filters/> <sup>[[Archive.org]][588]</sup>
...
-   Download and install Putty from <https://www.putty.org/> <sup>[[Archive.org]][589]</sup>
...
In that case my last resort recommendation is to connect safely **from a distance** to a Public Wi-Fi (See [Find some safe places with decent public Wi-Fi][Find some safe places with decent public Wi-Fi:]) using your laptop and TAILS "unsafe browser". See <https://tails.boum.org/contribute/design/Unsafe_Browser/> <sup>[[Archive.org]][591]</sup>.
...
Consider reading this older but still relevant guide <https://archive.flossmanuals.net/bypassing-censorship/index.html> <sup>[[Archive.org]][592]</sup>
...
**Personally, I would recommend the AWUS036 series in the Alfa brand of adapters (see <https://www.alfa.com.tw/>** <sup>[[Archive.org]][594]</sup>**).** But you could also go with some other brands if you want such as the TP-Link TL-WN722 (see <https://www.tp-link.com/us/home-networking/usb-adapter/tl-wn722n/> <sup>[[Archive.org]][595]</sup>).

See this post for a comparison of various adapters: <https://www.wirelesshack.org/best-kali-linux-compatible-usb-adapter-dongles.html> <sup>[[Archive.org]][596]</sup> (Usually those antennas are used by Penetration Testers to probe Wi-Fis from a distance and are often discussed within the scope of the Kali Linux distribution).
...
**Do not forget tho that this will only delay a motivated adversary. Your signal can be triangulated easily by a motivated adversary in a matter of minutes once they reach the physical location of the Wi-Fi you're connecting to (for instance using a device such as AirCheck <https://www.youtube.com/watch?v=8FV2QZ1BPnw>** <sup>[[Invidious]][597]</sup>**, also see their other products here <https://www.netally.com/products/#wifi_s>** <sup>[[Archive.org]][598]</sup>**). These products can easily be deployed on mobile units (in a Car for instance) and pinpoint your location in a matter of minutes.**
...
-   Whonix Tutorial (should work with any VPN provider): <https://www.whonix.org/wiki/Tunnels/Connecting_to_a_VPN_before_Tor> <sup>[[Archive.org]][305]</sup> (use the Linux configurations below to get the necessary configuration files)

-   Windows Tutorials:

    -   Mullvad: <https://mullvad.net/en/help/install-mullvad-app-windows/> <sup>[[Archive.org]][599]</sup>

    -   iVPN: <https://www.ivpn.net/apps-windows> <sup>[[Archive.org]][600]</sup>

    -   ProtonVPN: <https://protonvpn.com/support/protonvpn-windows-vpn-application/> <sup>[[Archive.org]][601]</sup>

-   MacOS:

    -   Mullvad: <https://mullvad.net/en/help/install-and-use-mullvad-app-macos/> <sup>[[Archive.org]][602]</sup>

    -   IVPN: <https://www.ivpn.net/apps-macos/> <sup>[[Archive.org]][603]</sup>

    -   ProtonVPN: <https://protonvpn.com/support/protonvpn-mac-vpn-application/> <sup>[[Archive.org]][604]</sup>

-   Linux:

    -   Mullvad: <https://mullvad.net/en/help/install-mullvad-app-linux/> <sup>[[Archive.org]][605]</sup>

    -   iVPN: <https://www.ivpn.net/apps-linux/> <sup>[[Archive.org]][606]</sup>

    -   ProtonVPN: <https://protonvpn.com/support/linux-vpn-setup/> <sup>[[Archive.org]][607]</sup>
...
-   Windows:
    ...
    -   iVPN: <https://www.ivpn.net/knowledgebase/general/do-you-offer-a-kill-switch-or-vpn-firewall/> <sup>[[Archive.org]][608]</sup>

    -   ProtonVPN: <https://protonvpn.com/support/what-is-kill-switch/> <sup>[[Archive.org]][609]</sup>

    -   Mullvad: <https://mullvad.net/en/help/using-mullvad-vpn-app/#killswitch> <sup>[[Archive.org]][610]</sup>
...
-   MacOS:
    ...
    -   ProtonVPN same as Windows with the client, the option should be in the provided VPN client <https://protonvpn.com/blog/macos-vpn-kill-switch/> <sup>[[Archive.org]][611]</sup>

-   Linux:

    -   Mullvad:

        -   <https://mullvad.net/en/help/wireguard-and-mullvad-vpn/> <sup>[[Archive.org]][612]</sup>

        -   <https://mullvad.net/en/help/linux-openvpn-installation/> <sup>[[Archive.org]][613]</sup>

    -   ProtonVPN: <https://github.com/ProtonVPN/linux-cli/blob/master/USAGE.md#kill-switch> <sup>[[Archive.org]][614]</sup>

    -   iVPN:

        -   <https://www.ivpn.net/knowledgebase/linux/linux-wireguard-kill-switch/> <sup>[[Archive.org]][615]</sup>

        -   <https://www.ivpn.net/knowledgebase/linux/linux-kill-switch-using-the-uncomplicated-firewall-ufw/> <sup>[[Archive.org]][616]</sup>
...
The probe can be found here: <https://ooni.org/install/> <sup>[[Archive.org]][617]</sup> for various platforms (iOS, Android, Windows, MacOS, and Linux).
...
-   Install GPG for your OS:
    ...
    -   Windows: gpg4win (<https://www.gpg4win.org/> <sup>[[Archive.org]][618]</sup>)

    -   MacOS: GPGTools (<https://gpgtools.org/> <sup>[[Archive.org]][619]</sup>)
...
-   <https://support.torproject.org/tbb/how-to-verify-signature/> <sup>[[Archive.org]][620]</sup>

-   <https://tails.boum.org/install/vm-download/index.en.html> <sup>[[Archive.org]][621]</sup> (See Basic OpenPGP verification).

-   <https://www.whonix.org/wiki/Verify_the_Whonix_images> <sup>[[Archive.org]][622]</sup>
...
-   Yes, there are viruses and malware for MacOS[^446]'[^440][^441]'[^442][^443]
...
-   Do use Open-Source non-real time offline Anti-Virus/Anti-Malware tools as an added measure to scan some files such as:
    ...
    -   Windows/Linux/MacOS/Qubes OS: ClamAV (<https://www.clamav.net/> <sup>[[Archive.org]][623]</sup>)

    -   Linux/Qubes OS: RFXN Linux Malware Detect (<https://github.com/rfxn/linux-malware-detect> <sup>[[Archive.org]][624]</sup>)

    -   Linux/Qubes OS: Chkrootkit (<http://www.chkrootkit.org/> <sup>[[Archive.org]][625]</sup>)
...
-   You could also use online services for **non-sensitive files*** such as VirusTotal (<https://www.virustotal.com/gui>) or Hybrid-analysis (<https://hybrid-analysis.com/>).
    ...
    -   You could also just check the VirusTotal database for the hash of your file if you don't want to send it over (see <https://developers.virustotal.com/v3.0/docs/search-by-hash> <sup>[[Archive.org]][626]</sup> (See the [Integrity (if available):] section again for guidance on how to generate hashes).

    -   Other tools are also available for non-sensitive files and a convenient list is right here: <https://github.com/rshipp/awesome-malware-analysis#online-scanners-and-sandboxes> <sup>[[Archive.org]][627]</sup>

* **Please be aware that while VirusTotal might seem very practical for scanning various files, their "privacy policy" is problematic (see <https://support.virustotal.com/hc/en-us/articles/115002168385-Privacy-Policy>** <sup>[[Archive.org]][628]</sup>**) and states:**
...
Again, regarding the PDFs of this guide and as explained in the README of my repository, you could check for anomalies using PDFID which you can download at <https://blog.didierstevens.com/programs/pdf-tools/> <sup>[[Archive.org]][629]</sup>
...
-   **Qubes OS:** Consider using <https://github.com/QubesOS/qubes-app-linux-pdf-converter> <sup>[[Archive.org]][630]</sup> which will convert your PDF into a flattened image file. This should theoretically remove any malicious code in it. Note that this will also render the PDF formatting useless (such as links, headings, bookmarks, and references).

-   **(Deprecated) Linux/Qubes OS** (or possibly MacOS through Homebrew or Windows through Cygwin): Consider not using <https://github.com/firstlookmedia/pdf-redact-tools> <sup>[[Archive.org]][631]</sup> which will also turn your PDF into a flattened image file. Again, this should theoretically remove any malicious code in it. Again, this will also render the PDF formatting useless (such as links, headings, bookmarks, and references). **Note that this tool is deprecated and relies on a library called "ImageMagick" which is known for several security issues**[^444]**. You should not use this tool even if it is recommended in some other guides.**

-   **Windows/Linux/Qubes/OS/MacOS:** Consider using <https://github.com/firstlookmedia/dangerzone> <sup>[[Archive.org]][632]</sup> which was inspired by Qubes PDF Converted above and does the same but is well maintained and works on all OSes. This tool also works with Images, ODF files and Office files (Warning: On Windows, this tool requires Docker-Desktop installed and this might (will) interfere with Virtualbox and other Virtualization software because it requires enabling Hyper-V. VirtualBox and Hyper-V do not play nice together[^445]. Consider installing this within a Linux VM for convenience instead of a Windows OS).
...
-   This practical cheat sheet from SANS: <https://digital-forensics.sans.org/media/analyzing-malicious-document-files.pdf> <sup>[[Archive.org]][633]</sup> (warning, many of those tools might be harder to use on Windows and you might consider using them from a Linux OS such as Tails, Whonix Workstation or a Linux distribution of your choice as explained later in this guide. There are also other guides out there[^447] that might be of use).

-   This GitHub repository with various resources on malware analysis: <https://github.com/rshipp/awesome-malware-analysis> <sup>[[Archive.org]][627]</sup>

-   This interesting PDF detailing which tool to use for which file type <https://www.winitor.com/pdf/Malware-Analysis-Fundamentals-Files-Tools.pdf> <sup>[[Archive.org]][634]</sup>
...
In those cases, it might be necessary to use Tor bridges to connect to the Tor network (see Tor Documentation <https://2019.www.torproject.org/docs/bridges> <sup>[[Archive.org]][232]</sup> and Whonix Documentation <https://www.whonix.org/wiki/Bridges> <sup>[[Archive.org]][323]</sup>).
...
Lastly, there are also bridges called Snowflake bridges that rely on users running the snowflake extension in their browser to become themselves entry nodes. See <https://snowflake.torproject.org/> <sup>[[Archive.org]][527]</sup>.

First you should, proceed with the following checklist to make sure you cannot circumvent Tor Blocking (double-check) and try to use Tor Bridges (<https://bridges.torproject.org/> <sup>[[Archive.org]][549]</sup>).
...
-   **This project is more known than you think: <https://www.youtube.com/watch?v=nwkiU6GG-YU>** <sup>[[Invidious]][637]</sup>
...
The official guide is here: <https://telegra.ph/AME-Download-Guide-09-07> <sup>[[Archive.org]][638]</sup>

You can also build this ISO yourself from their scripts if you do not trust their provided ISO release using the guide here: <https://wiki.ameliorated.info/doku.php?id=documentation_20H2> <sup>[[Archive.org]][639]</sup>
...
-   You might want to consider the use of Wasabi (<https://wasabiwallet.io/> <sup>[[Archive.org]][640]</sup>) for your BTC transactions using their "CoinJoin feature"[^454] to further cover your tracks. This would mean swapping your Monero for BTC to a Wasabi Wallet instead of a normal Wallet. And then using that Wasabi Wallet for your BTC transactions using their CoinJoin feature.
...
-   **Njalla <https://njal.la/>** <sup>[[Archive.org]][641]</sup> **(my personal favorite, recommended by Privacytools.Io (<https://privacytools.io/providers/hosting/>** <sup>[[Archive.org]][642]</sup>**).**

-   **1984.is <https://www.1984.is>** <sup>[[Archive.org]][643]</sup>**.**

Also consider these lists:

-   Tor Project: <https://community.torproject.org/relay/community-resources/good-bad-isps/> <sup>[[Archive.org]][644]</sup>

-   Privacytools.io: <https://privacytools.io/providers/hosting/> <sup>[[Archive.org]][642]</sup>

Lastly, you could pick one from the list here that does accept Monero: <https://www.getmonero.org/community/merchants/#hosting> <sup>[[Archive.org]][583]</sup>

**Pease do read the [Monero Disclaimer].**
...
The anonymity of Monero depends on its crypto algorithms. If you do use Monero from a KYC Exchange. You can be almost certain that you are safe today. But you might not be in the long-term future if Monero algorithms are ever broken[^455] (think Quantum Computing). Do keep in mind that KYC regulations might force operators (such as Crypto Exchanges) to keep your financial records for up to 10 years and that you therefore need Monero algorithms to not be broken for the next 10 years as well. **Use at your own risk, sending cash payments to providers accepting cash (through the postal service) is always a better solution if/when possible.**

You may want to watch this insightful video for more details: [**https://www.youtube.com/watch?v=j02QoI4ZlnU**][] <sup>[[Invidious]][645]</sup>

Also please consider reading: **<https://github.com/monero-project/monero/blob/master/docs/ANONYMITY_NETWORKS.md#privacy-limitations>** <sup>[[Archive.org]][646]</sup>

[^1]: English translation of German Telemedia Act <https://www.huntonprivacyblog.com/wp-content/uploads/sites/28/2016/02/Telemedia_Act__TMA_.pdf> <sup>[[Archive.org]][647]</sup>. Section 13, Article 6, "The service provider must enable the use of Telemedia and payment for them to occur anonymously or via a pseudonym where this is technically possible and reasonable. The recipient of the service is to be informed about this possibility. ".

[^2]: Wikipedia, Real-Name System Germany <https://en.wikipedia.org/wiki/Real-name_system#Germany> <sup>[[Wikiless]][394]</sup> <sup>[[Archive.org]][395]</sup>

[^3]: Wikipedia, Don't be evil <https://en.wikipedia.org/wiki/Don%27t_be_evil> <sup>[[Wikiless]][648]</sup> <sup>[[Archive.org]][649]</sup>

[^4]: YouTube, <https://www.youtube.com/watch?v=6DGNZnfKYnU> <sup>[[Invidious]][650]</sup>

[^5]: Wikipedia, OSINT <https://en.wikipedia.org/wiki/Open-source_intelligence> <sup>[[Wikiless]][651]</sup> <sup>[[Archive.org]][652]</sup>

[^6]: YouTube Internet Historian Playlist, HWNDU <https://www.youtube.com/playlist?list=PLna1KTNJu3y09Tu70U6yPn28sekaNhOMY> <sup>[[Invidious]][653]</sup>

[^7]: Wikipedia, 4chan <https://en.wikipedia.org/wiki/4chan> <sup>[[Wikiless]][654]</sup> <sup>[[Archive.org]][655]</sup>

[^8]: PIA, See this good article on the matter <https://www.privateinternetaccess.com/blog/how-does-privacy-differ-from-anonymity-and-why-are-both-important/> <sup>[[Archive.org]][656]</sup> (disclaimer: this is not an endorsement or recommendation for this commercial service).
...
[^10]: This World of Ours, James Mickens <https://scholar.harvard.edu/files/mickens/files/thisworldofours.pdf> <sup>[[Archive.org]][657]</sup>

[^11]: XKCD, Security <https://xkcd.com/538/> <sup>[[Archive.org]][658]</sup>

[^12]: Wikipedia, Threat Model <https://en.wikipedia.org/wiki/Threat_model> <sup>[[Wikiless]][659]</sup> <sup>[[Archive.org]][660]</sup>

[^13]: Bellingcat <https://www.bellingcat.com/> <sup>[[Archive.org]][661]</sup>

[^14]: Wikipedia, Doxing <https://en.wikipedia.org/wiki/Doxing> <sup>[[Wikiless]][662]</sup> <sup>[[Archive.org]][663]</sup>

[^15]: YouTube, Internet Historian, The Bikelock Fugitive of Berkeley <https://www.youtube.com/watch?v=muoR8Td44UE> <sup>[[Invidious]][664]</sup>

[^16]: BBC News, Tor Mirror <https://www.bbc.com/news/technology-50150981> <sup>[[Archive.org]][665]</sup>

[^17]: GitHub, Real World Onion websites <https://github.com/alecmuffett/real-world-onion-sites> <sup>[[Archive.org]][440]</sup>

[^18]: Tor Project, Who Uses Tor <https://2019.www.torproject.org/about/torusers.html.en> <sup>[[Archive.org]][666]</sup>

[^19]: Whonix Documentation, The importance of Anonymity <https://www.whonix.org/wiki/Anonymity> <sup>[[Archive.org]][667]</sup>

[^20]: Geek Feminism, <https://geekfeminism.wikia.org/wiki/Who_is_harmed_by_a_%22Real_Names%22_policy%3F> <sup>[[Archive.org]][668]</sup>

[^21]: Tor Project, Tor Users <https://2019.www.torproject.org/about/torusers.html.en> <sup>[[Archive.org]][666]</sup>

[^22]: PrivacyHub, Internet Privacy in the Age of Surveillance <https://www.cyberghostvpn.com/privacyhub/internet-privacy-surveillance/> <sup>[[Archive.org]][669]</sup>

[^23]: Wikipedia, IANAL <https://en.wikipedia.org/wiki/IANAL> <sup>[[Wikiless]][670]</sup> <sup>[[Archive.org]][671]</sup>

[^24]: Wikipedia, Trust but verify <https://en.wikipedia.org/wiki/Trust,_but_verify> <sup>[[Wikiless]][672]</sup> <sup>[[Archive.org]][673]</sup>

[^25]: Wikipedia, IP Address, <https://en.wikipedia.org/wiki/IP_address> <sup>[[Wikiless]][674]</sup> <sup>[[Archive.org]][675]</sup>

[^26]: Wikipedia; Data Retention <https://en.wikipedia.org/wiki/Data_retention> <sup>[[Wikiless]][676]</sup> <sup>[[Archive.org]][677]</sup>

[^27]: Wikipedia, Tor Anonymity Network <https://en.wikipedia.org/wiki/Tor_(anonymity_network)> <sup>[[Wikiless]][678]</sup> <sup>[[Archive.org]][679]</sup>

[^28]: Wikipedia, VPN <https://en.wikipedia.org/wiki/Virtual_private_network> <sup>[[Wikiless]][680]</sup> <sup>[[Archive.org]][681]</sup>

[^29]: Wikipedia, DNS <https://en.wikipedia.org/wiki/Domain_Name_System> <sup>[[Wikiless]][682]</sup> <sup>[[Archive.org]][683]</sup>

[^30]: Wikipedia, DNS Blocking <https://en.wikipedia.org/wiki/DNS_blocking> <sup>[[Wikiless]][684]</sup> <sup>[[Archive.org]][685]</sup>

[^31]: CensoredPlanet <https://censoredplanet.org/> <sup>[[Archive.org]][218]</sup>

[^32]: ArXiv, Characterizing Smart Home IoT Traffic in the Wild <https://arxiv.org/pdf/2001.08288.pdf> <sup>[[Archive.org]][686]</sup>

[^33]: Labzilla.io, Your Smart TV is probably ignoring your Pi-Hole <https://labzilla.io/blog/force-dns-pihole> <sup>[[Archive.org]][687]</sup>

[^34]: Wikipedia, DNS over HTTPS: <https://en.wikipedia.org/wiki/DNS_over_HTTPS> <sup>[[Wikiless]][688]</sup> <sup>[[Archive.org]][689]</sup>

[^35]: Wikipedia, DNS over TLS, <https://en.wikipedia.org/wiki/DNS_over_TLS> <sup>[[Wikiless]][690]</sup> <sup>[[Archive.org]][691]</sup>

[^36]: Wikipedia, Pi-Hole <https://en.wikipedia.org/wiki/Pi-hole> <sup>[[Wikiless]][692]</sup> <sup>[[Archive.org]][693]</sup>

[^37]: Wikipedia, SNI <https://en.wikipedia.org/wiki/Server_Name_Indication> <sup>[[Wikiless]][694]</sup> <sup>[[Archive.org]][695]</sup>

[^38]: Wikipedia, ECH, <https://en.wikipedia.org/wiki/Server_Name_Indication#Encrypted_Client_Hello> <sup>[[Wikiless]][694]</sup> <sup>[[Archive.org]][695]</sup>

[^39]: Wikipedia, eSNI <https://en.wikipedia.org/wiki/Server_Name_Indication#Encrypted_Client_Hello> <sup>[[Wikiless]][694]</sup> <sup>[[Archive.org]][695]</sup>

[^40]: Usenix.org, On the Importance of Encrypted-SNI (ESNI) to Censorship Circumvention <https://www.usenix.org/system/files/foci19-paper_chai_0.pdf> <sup>[[Archive.org]][696]</sup>

[^41]: Wikipedia, CDN <https://en.wikipedia.org/wiki/Content_delivery_network> <sup>[[Wikiless]][697]</sup> <sup>[[Archive.org]][698]</sup>

[^42]: Cloudflare, Good-bye ESNI, hello ECH! <https://blog.cloudflare.com/encrypted-client-hello/> <sup>[[Archive.org]][699]</sup>

[^43]: ZDNET, Russia wants to ban the use of secure protocols such as TLS 1.3, DoH, DoT, ESNI <https://www.zdnet.com/article/russia-wants-to-ban-the-use-of-secure-protocols-such-as-tls-1-3-doh-dot-esni/> <sup>[[Archive.org]][700]</sup>

[^44]: ZDNET, China is now blocking all encrypted HTTPS traffic that uses TLS 1.3 and ESNI <https://www.zdnet.com/article/china-is-now-blocking-all-encrypted-https-traffic-using-tls-1-3-and-esni/> <sup>[[Archive.org]][701]</sup>

[^45]: Wikipedia, OCSP <https://en.wikipedia.org/wiki/Online_Certificate_Status_Protocol> <sup>[[Wikiless]][702]</sup> <sup>[[Archive.org]][703]</sup>

[^46]: Madaidans Insecurities, Why encrypted DNS is ineffective <https://madaidans-insecurities.github.io/encrypted-dns.html> <sup>[[Archive.org]][704]</sup>

[^47]: Wikipedia, OCSP Stapling <https://en.wikipedia.org/wiki/OCSP_stapling> <sup>[[Wikiless]][705]</sup> <sup>[[Archive.org]][706]</sup>

[^48]: Chromium Documentation, CRLSets <https://dev.chromium.org/Home/chromium-security/crlsets> <sup>[[Archive.org]][707]</sup>

[^49]: ZDNet, Chrome does certificate revocation better <https://www.zdnet.com/article/chrome-does-certificate-revocation-better/> <sup>[[Archive.org]][708]</sup>

[^50]: KUL, Encrypted DNS=⇒Privacy? A Traffic Analysis Perspective <https://www.esat.kuleuven.be/cosic/publications/article-3153.pdf> <sup>[[Archive.org]][709]</sup>

[^51]: ResearhGate, Oblivious DNS: Practical Privacy for DNS Queries <https://www.researchgate.net/publication/332893422_Oblivious_DNS_Practical_Privacy_for_DNS_Queries> <sup>[[Archive.org]][710]</sup>

[^52]: Nymity.ch, The Effect of DNS on Tor's Anonymity <https://nymity.ch/tor-dns/> <sup>[[Archive.org]][711]</sup>

[^53]: Wikipedia, RFID <https://en.wikipedia.org/wiki/Radio-frequency_identification> <sup>[[Wikiless]][67]</sup> <sup>[[Archive.org]][68]</sup>

[^54]: Wikipedia, NFC <https://en.wikipedia.org/wiki/Near-field_communication> <sup>[[Wikiless]][712]</sup> <sup>[[Archive.org]][713]</sup>

[^55]: Samsonite Online Shop, RFID accessories, <https://shop.samsonite.com/accessories/rfid-accessories/> <sup>[[Archive.org]][714]</sup>

[^56]: Google Android Help, Android Location Services <https://support.google.com/accounts/answer/3467281?hl=en> <sup>[[Archive.org]][715]</sup>

[^57]: Apple Support, Location Services and Privacy <https://support.apple.com/en-us/HT207056> <sup>[[Archive.org]][716]</sup>

[^58]: State University of New York, Towards 3D Human Pose Construction Using Wi-Fi <https://cse.buffalo.edu/~lusu/papers/MobiCom2020.pdf> <sup>[[Archive.org]][717]</sup>

[^59]: Digi.Ninja, Jasager <https://digi.ninja/jasager/> <sup>[[Archive.org]][718]</sup>

[^60]: Hak5 Shop, Wi-Fi Pineapple <https://shop.hak5.org/products/wifi-pineapple> <sup>[[Archive.org]][719]</sup>

[^61]: Wikipedia, Deautentication Attack <https://en.wikipedia.org/wiki/Wi-Fi_deauthentication_attack> <sup>[[Wikiless]][720]</sup> <sup>[[Archive.org]][721]</sup>

[^62]: Wikipedia, Capture Portal <https://en.wikipedia.org/wiki/Captive_portal> <sup>[[Wikiless]][722]</sup> <sup>[[Archive.org]][723]</sup>

[^63]: HackerFactor Blog, Deanonymizing Tor Circuits <https://www.hackerfactor.com/blog/index.php?/archives/868-Deanonymizing-Tor-Circuits.html> <sup>[[Archive.org]][724]</sup>

[^64]: KU Leuven, Website Fingerprinting through Deep Learning <https://distrinet.cs.kuleuven.be/software/tor-wf-dl/> <sup>[[Archive.org]][725]</sup>

[^65]: DailyDot, How Tor helped catch the Harvard bomb threat suspect <https://www.dailydot.com/unclick/tor-harvard-bomb-suspect/> <sup>[[Archive.org]][726]</sup>

[^66]: ArsTechnica, How the NSA can break trillions of encrypted Web and VPN connections <https://arstechnica.com/information-technology/2015/10/how-the-nsa-can-break-trillions-of-encrypted-web-and-vpn-connections/> <sup>[[Archive.org]][727]</sup>

[^67]: ArsTechnica, Does Tor provide more benefit or harm? New paper says it depends <https://arstechnica.com/gadgets/2020/11/does-tor-provide-more-benefit-or-harm-new-paper-says-it-depends/> <sup>[[Archive.org]][728]</sup>

[^68]: ResearchGate, The potential harms of the Tor anonymity network cluster disproportionately in free countries <https://www.pnas.org/content/early/2020/11/24/2011893117> <sup>[[Archive.org]][729]</sup>

[^69]: CryptoEngineering, How does Apple (privately) find your offline devices? <https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/> <sup>[[Archive.org]][730]</sup>

[^70]: Apple Support <https://support.apple.com/en-us/HT210515> <sup>[[Archive.org]][731]</sup>

[^71]: XDA, Samsung's Find My Mobile app can locate Galaxy devices even when they're offline <https://www.xda-developers.com/samsung-find-my-mobile-app-locate-galaxy-devices-offline/> <sup>[[Archive.org]][732]</sup>

[^72]: Apple Support, If your Mac is lost or stolen <https://support.apple.com/en-us/HT204756> <sup>[[Archive.org]][733]</sup>

[^73]: Wikipedia, BLE <https://en.wikipedia.org/wiki/Bluetooth_Low_Energy> <sup>[[Wikiless]][734]</sup> <sup>[[Archive.org]][735]</sup>

[^74]: Cryptography Engineering Blog, How does Apple (privately) find your offline devices? <https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/> <sup>[[Archive.org]][730]</sup>

[^75]: Wikipedia, IMEI <https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity> <sup>[[Wikiless]][736]</sup> <sup>[[Archive.org]][737]</sup>

[^76]: Wikipedia, IMSI <https://en.wikipedia.org/wiki/International_mobile_subscriber_identity> <sup>[[Wikiless]][738]</sup> <sup>[[Archive.org]][739]</sup>

[^77]: Android Documentation, Device Identifiers <https://source.android.com/devices/tech/config/device-identifiers> <sup>[[Archive.org]][740]</sup>

[^78]: Google Privacy Policy, Look for IMEI <https://policies.google.com/privacy/embedded?hl=en-US> <sup>[[Archive.org]][741]</sup>

[^79]: Wikipedia, IMEI and the Law <https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity#IMEI_and_the_law> <sup>[[Wikiless]][736]</sup> <sup>[[Archive.org]][737]</sup>

[^80]: Bellingcat, The GRU Globetrotters: Mission London <https://www.bellingcat.com/news/uk-and-europe/2019/06/28/the-gru-globetrotters-mission-london/> <sup>[[Archive.org]][742]</sup>

[^81]: Bellingcat,"V" For "Vympel": FSB's Secretive Department "V" Behind Assassination Of Georgian Asylum Seeker In Germany <https://www.bellingcat.com/news/uk-and-europe/2020/02/17/v-like-vympel-fsbs-secretive-department-v-behind-assassination-of-zelimkhan-khangoshvili/> <sup>[[Archive.org]][743]</sup>

[^82]: Wikipedia, CCTV <https://en.wikipedia.org/wiki/Closed-circuit_television> <sup>[[Wikiless]][744]</sup> <sup>[[Archive.org]][745]</sup>

[^83]: Apple, Transparency Report, Device Requests <https://www.apple.com/legal/transparency/device-requests.html> <sup>[[Archive.org]][746]</sup>

[^84]: The Intercept, How Cops Can Secretly Track Your Phone <https://theintercept.com/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/> <sup>[[Archive.org]][747]</sup>

[^85]: Wikipedia, IMSI Catcher <https://en.wikipedia.org/wiki/IMSI-catcher> <sup>[[Wikiless]][748]</sup> <sup>[[Archive.org]][749]</sup>

[^86]: Wikipedia, Stingray <https://en.wikipedia.org/wiki/Stingray_phone_tracker> <sup>[[Wikiless]][750]</sup> <sup>[[Archive.org]][751]</sup>

[^87]: Gizmodo, Cops Turn to Canadian Phone-Tracking Firm After Infamous 'Stingrays' Become 'Obsolete' <https://gizmodo.com/american-cops-turns-to-canadian-phone-tracking-firm-aft-1845442778> <sup>[[Archive.org]][752]</sup>

[^88]: Wikipedia, MITM <https://en.wikipedia.org/wiki/Man-in-the-middle_attack> <sup>[[Wikiless]][753]</sup> <sup>[[Archive.org]][754]</sup>

[^89]: Purism, Librem 5 <https://shop.puri.sm/shop/librem-5/> <sup>[[Archive.org]][755]</sup>

[^90]: Wikipedia, MAC Address <https://en.wikipedia.org/wiki/MAC_address> <sup>[[Wikiless]][756]</sup> <sup>[[Archive.org]][757]</sup>

[^91]: Acyclica Road Trend Product Sheet, <https://amsignalinc.com/data-sheets/Acyclica/Acyclica-RoadTrend-Product-Sheet.pdf> <sup>[[Archive.org]][758]</sup>

[^92]: ResearchGate, Tracking Anonymized Bluetooth Devices <https://www.researchgate.net/publication/334590931_Tracking_Anonymized_Bluetooth_Devices/fulltext/5d3308db92851cd04675a469/Tracking-Anonymized-Bluetooth-Devices.pdf> <sup>[[Archive.org]][759]</sup>

[^93]: Wikipedia, CPU <https://en.wikipedia.org/wiki/Central_processing_unit> <sup>[[Wikiless]][760]</sup> <sup>[[Archive.org]][761]</sup>

[^94]: Wikipedia, Intel Management Engine <https://en.wikipedia.org/wiki/Intel_Management_Engine> <sup>[[Wikiless]][762]</sup> <sup>[[Archive.org]][763]</sup>

[^95]: Wikipedia, AMD Platform Security Processor <https://en.wikipedia.org/wiki/AMD_Platform_Security_Processor> <sup>[[Wikiless]][764]</sup> <sup>[[Archive.org]][765]</sup>

[^96]: Wikipedia, IME, Security Vulnerabilities <https://en.wikipedia.org/wiki/Intel_Management_Engine#Security_vulnerabilities> <sup>[[Wikiless]][762]</sup> <sup>[[Archive.org]][763]</sup>

[^97]: Wikipedia, IME, Assertions that ME is a backdoor <https://en.wikipedia.org/wiki/Intel_Management_Engine#Assertions_that_ME_is_a_backdoor> <sup>[[Wikiless]][762]</sup> <sup>[[Archive.org]][763]</sup>

[^98]: Wikipedia, IME, Disabling the ME <https://en.wikipedia.org/wiki/Intel_Management_Engine#Disabling_the_ME> <sup>[[Wikiless]][762]</sup> <sup>[[Archive.org]][763]</sup>

[^99]: Libreboot, <https://libreboot.org/> <sup>[[Archive.org]][766]</sup>

[^100]: Apple, Differential Privacy White Paper <https://www.apple.com/privacy/docs/Differential_Privacy_Overview.pdf> <sup>[[Archive.org]][767]</sup>

[^101]: Wikipedia, Differential Privacy <https://en.wikipedia.org/wiki/Differential_privacy> <sup>[[Wikiless]][768]</sup> <sup>[[Archive.org]][769]</sup>
...
[^103]: Reuters, Exclusive: Apple dropped plan for encrypting backups after FBI complained -- sources <https://www.reuters.com/article/us-apple-fbi-icloud-exclusive-idUSKBN1ZK1CT> <sup>[[Archive.org]][770]</sup>

[^104]: ZDnet, I asked Apple for all my data. Here's what was sent back <https://www.zdnet.com/article/apple-data-collection-stored-request/> <sup>[[Archive.org]][771]</sup>

[^105]: De Correspondent, Here's how we found the names and addresses of soldiers and secret agents using a simple fitness app <https://decorrespondent.nl/8481/heres-how-we-found-the-names-and-addresses-of-soldiers-and-secret-agents-using-a-simple-fitness-app/412999257-6756ba27> <sup>[[Archive.org]][772]</sup>

[^106]: Wired, The Strava Heat Map and the End of Secrets <https://www.wired.com/story/strava-heat-map-military-bases-fitness-trackers-privacy/> <sup>[[Archive.org]][773]</sup>

[^107]: Bellingcat, How to Use and Interpret Data from Strava's Activity Map <https://www.bellingcat.com/resources/how-tos/2018/01/29/strava-interpretation-guide/> <sup>[[Archive.org]][774]</sup>

[^108]: The Guardian, Fitness tracking app Strava gives away location of secret US army bases <https://www.theguardian.com/world/2018/jan/28/fitness-tracking-app-gives-away-location-of-secret-us-army-bases> <sup>[[Archive.org]][775]</sup>

[^109]: Telegraph, Running app reveals locations of secret service agents in MI6 and GCHQ <https://www.telegraph.co.uk/technology/2018/07/08/running-app-exposes-mi6-gchq-workers-whereabouts/> <sup>[[Archive.org]][776]</sup>

[^110]: Washington Post, Alexa has been eavesdropping on you this whole time <https://www.washingtonpost.com/technology/2019/05/06/alexa-has-been-eavesdropping-you-this-whole-time/?itid=lk_interstitial_manual_59> <sup>[[Archive.org]][777]</sup>

[^111]: Washington Post, What does your car know about you? We hacked a Chevy to find out <https://www.washingtonpost.com/technology/2019/12/17/what-does-your-car-know-about-you-we-hacked-chevy-find-out/> <sup>[[Archive.org]][778]</sup>

[^112]: Using Metadata to find Paul Revere (<https://kieranhealy.org/blog/archives/2013/06/09/using-metadata-to-find-paul-revere/> <sup>[[Archive.org]][779]</sup>)

[^113]: Wikipedia, Google SensorVault, <https://en.wikipedia.org/wiki/Sensorvault> <sup>[[Wikiless]][780]</sup> <sup>[[Archive.org]][781]</sup>

[^114]: NRKBeta, My Phone Was Spying on Me, so I Tracked Down the Surveillants <https://nrkbeta.no/2020/12/03/my-phone-was-spying-on-me-so-i-tracked-down-the-surveillants/> <sup>[[Archive.org]][782]</sup>

[^115]: New York Times <https://www.nytimes.com/interactive/2019/12/19/opinion/location-tracking-cell-phone.html> <sup>[[Archive.org]][783]</sup>

[^116]: Sophos, Google data puts innocent man at the scene of a crime <https://nakedsecurity.sophos.com/2020/03/10/google-data-puts-innocent-man-at-the-scene-of-a-crime/> <sup>[[Archive.org]][784]</sup>

[^117]: Wikipedia, Geofence Warrant <https://en.wikipedia.org/wiki/Geo-fence_warrant> <sup>[[Wikiless]][785]</sup> <sup>[[Archive.org]][786]</sup>

[^118]: Vice.com, Military Unit That Conducts Drone Strikes Bought Location Data From Ordinary Apps <https://www.vice.com/en/article/y3g97x/location-data-apps-drone-strikes-iowa-national-guard> <sup>[[Archive.org]][787]</sup>

[^119]: Wikipedia, Room 641A <https://en.wikipedia.org/wiki/Room_641A> <sup>[[Wikiless]][788]</sup> <sup>[[Archive.org]][789]</sup>

[^120]: Wikipedia, Edward Snowden <https://en.wikipedia.org/wiki/Edward_Snowden> <sup>[[Wikiless]][790]</sup> <sup>[[Archive.org]][791]</sup>

[^121]: Wikipedia, Permanent Record <https://en.wikipedia.org/wiki/Permanent_Record_(autobiography)> <sup>[[Wikiless]][532]</sup> <sup>[[Archive.org]][533]</sup>

[^122]: Wikipedia, XKEYSCORE <https://en.wikipedia.org/wiki/XKeyscore> <sup>[[Wikiless]][792]</sup> <sup>[[Archive.org]][793]</sup>

[^123]: ElectroSpaces, Danish military intelligence uses XKEYSCORE to tap cables in cooperation with the NSA <https://www.electrospaces.net/2020/10/danish-military-intelligence-uses.html> <sup>[[Archive.org]][794]</sup>

[^124]: Wikipedia, MUSCULAR <https://en.m.wikipedia.org/wiki/MUSCULAR_(surveillance_program)> <sup>[[Archive.org]][795]</sup>

[^125]: Wikipedia, SORM <https://en.wikipedia.org/wiki/SORM> <sup>[[Wikiless]][796]</sup> <sup>[[Archive.org]][797]</sup>

[^126]: Wikipedia, Tempora <https://en.wikipedia.org/wiki/Tempora> <sup>[[Wikiless]][798]</sup> <sup>[[Archive.org]][799]</sup>

[^127]: Wikipedia, PRISM <https://en.wikipedia.org/wiki/PRISM_(surveillance_program)> <sup>[[Wikiless]][800]</sup> <sup>[[Archive.org]][801]</sup>

[^128]: Justsecurity, General Hayden <https://www.justsecurity.org/10318/video-clip-director-nsa-cia-we-kill-people-based-metadata/> <sup>[[Archive.org]][802]</sup>

[^129]: IDMB, The Social Dilemma <https://www.imdb.com/title/tt11464826/> <sup>[[Archive.org]][803]</sup>

[^130]: ArsTechnica, How the way you type can shatter anonymity---even on Tor <https://arstechnica.com/information-technology/2015/07/how-the-way-you-type-can-shatter-anonymity-even-on-tor/> <sup>[[Archive.org]][804]</sup>

[^131]: Wikipedia, Stylometry <https://en.wikipedia.org/wiki/Stylometry> <sup>[[Wikiless]][805]</sup> <sup>[[Archive.org]][806]</sup>

[^132]: Paul Moore Blog, Behavioral Profiling: The password you can't change. <https://paul.reviews/behavioral-profiling-the-password-you-cant-change/> <sup>[[Archive.org]][807]</sup>

[^133]: Wikipedia, Sentiment Analysis, <https://en.wikipedia.org/wiki/Sentiment_analysis> <sup>[[Wikiless]][808]</sup> <sup>[[Archive.org]][809]</sup>

[^134]: EFF CoverYourTracks, <https://coveryourtracks.eff.org/> <sup>[[Archive.org]][810]</sup>

[^135]: Berkeley.edu, On the Feasibility of Internet-Scale Author Identification <https://people.eecs.berkeley.edu/~dawnsong/papers/2012%20On%20the%20Feasibility%20of%20Internet-Scale%20Author%20Identification.pdf> <sup>[[Archive.org]][811]</sup>

[^136]: SecuredTouch Blog, Behavioral Biometrics 101: Behavioral Biometrics vs. Behavioral Analytics <https://blog.securedtouch.com/behavioral-biometrics-101-an-in-depth-look-at-behavioral-biometrics-vs-behavioral-analytics> <sup>[[Archive.org]][812]</sup>

[^137]: ArsTechnica, Stakeout: how the FBI tracked and busted a Chicago Anon <https://arstechnica.com/tech-policy/2012/03/stakeout-how-the-fbi-tracked-and-busted-a-chicago-anon/> <sup>[[Archive.org]][813]</sup>

[^138]: Bellingcat MH17 - Russian GRU Commander 'Orion' Identified as Oleg Ivannikov <https://www.bellingcat.com/news/uk-and-europe/2018/05/25/mh17-russian-gru-commander-orion-identified-oleg-ivannikov/> <sup>[[Archive.org]][814]</sup>

[^139]: Facebook Research, Deepface <https://research.fb.com/publications/deepface-closing-the-gap-to-human-level-performance-in-face-verification/> <sup>[[Archive.org]][815]</sup>

[^140]: Privacy News Online, Putting the "face" in Facebook: how Mark Zuckerberg is building a world without public anonymity <https://www.privateinternetaccess.com/blog/putting-face-facebook-mark-zuckerberg-building-world-without-public-anonymity/> <sup>[[Archive.org]][816]</sup>

[^141]: CNBC, "Facebook has mapped populations in 23 countries as it explores satellites to expand internet" <https://www.cnbc.com/2017/09/01/facebook-has-mapped-human-population-building-internet-in-space.html> <sup>[[Archive.org]][817]</sup>

[^142]: MIT Technology Review, This is how we lost control of our faces, <https://www.technologyreview.com/2021/02/05/1017388/ai-deep-learning-facial-recognition-data-history/> <sup>[[Archive.org]][818]</sup>

[^143]: Bellingcat, Shadow of a Doubt: Crowdsourcing Time Verification of the MH17 Missile Launch Photo <https://www.bellingcat.com/resources/case-studies/2015/08/07/shadow-of-a-doubt/> <sup>[[Archive.org]][819]</sup>

[^144]: Brown Institute, Open-Source Investigation, <https://brown.columbia.edu/open-source-investigation/> <sup>[[Archive.org]][820]</sup>

[^145]: NewScientist, Facebook can recognize you in photos even if you're not looking <https://www.newscientist.com/article/dn27761-facebook-can-recognise-you-in-photos-even-if-youre-not-looking/> <sup>[[Archive.org]][821]</sup>

[^146]: Google Patent, Techniques for emotion detection and content delivery <https://patents.google.com/patent/US20150242679> <sup>[[Archive.org]][822]</sup>

[^147]: APNews, Chinese 'gait recognition' tech IDs people by how they walk <https://apnews.com/article/bf75dd1c26c947b7826d270a16e2658a> <sup>[[Archive.org]][823]</sup>

[^148]: TechCrunch, Facial recognition reveals political party in troubling new research <https://techcrunch.com/2021/01/13/facial-recognition-reveals-political-party-in-troubling-new-research/> <sup>[[Archive.org]][824]</sup>

[^149]: Nature.com, Facial recognition technology can expose political orientation from naturalistic facial images <https://www.nature.com/articles/s41598-020-79310-1> <sup>[[Archive.org]][825]</sup>

[^150]: Slate <https://slate.com/technology/2018/04/facebook-collects-data-on-non-facebook-users-if-they-want-to-delete-it-they-have-to-sign-up.html> <sup>[[Archive.org]][826]</sup>

[^151]: The Conversation <https://theconversation.com/shadow-profiles-facebook-knows-about-you-even-if-youre-not-on-facebook-94804> <sup>[[Archive.org]][827]</sup>

[^152]: The Verge <https://www.theverge.com/2018/4/11/17225482/facebook-shadow-profiles-zuckerberg-congress-data-privacy> <sup>[[Archive.org]][828]</sup>

[^153]: ZDNET <https://www.zdnet.com/article/anger-mounts-after-facebooks-shadow-profiles-leak-in-bug/> <sup>[[Archive.org]][829]</sup>

[^154]: CNET <https://www.cnet.com/news/shadow-profiles-facebook-has-information-you-didnt-hand-over/> <sup>[[Archive.org]][830]</sup>

[^155]: Anyvision <https://www.anyvision.co/> <sup>[[Archive.org]][831]</sup>

[^156]: BuzzFeed.news, Surveillance Nation <https://www.buzzfeednews.com/article/ryanmac/clearview-ai-local-police-facial-recognition> <sup>[[Archive.org]][832]</sup>

[^157]: NEC, Neoface <https://www.nec.com/en/global/solutions/biometrics/face/neofacewatch.html> <sup>[[Archive.org]][833]</sup>

[^158]: The Guardian, Met police deploy live facial recognition technology <https://www.theguardian.com/uk-news/2020/feb/11/met-police-deploy-live-facial-recognition-technology> <sup>[[Archive.org]][834]</sup>

[^159]: YouTube, The Economist, China: facial recognition and state control <https://www.youtube.com/watch?v=lH2gMNrUuEY> <sup>[[Invidious]][835]</sup>

[^160]: Washington Post, Huawei tested AI software that could recognize Uighur minorities and alert police, report says <https://www.washingtonpost.com/technology/2020/12/08/huawei-tested-ai-software-that-could-recognize-uighur-minorities-alert-police-report-says/> <sup>[[Archive.org]][836]</sup>

[^161]: The Intercept, How a Facial Recognition Mismatch Can Ruin Your Life <https://theintercept.com/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/> <sup>[[Archive.org]][837]</sup>

[^162]: BBC, WhatsApp photo drug dealer caught by 'groundbreaking' work <https://www.bbc.com/news/uk-wales-43711477> <sup>[[Archive.org]][838]</sup>

[^163]: CNN, Drug dealer jailed after sharing a photo of cheese that included his fingerprints <https://edition.cnn.com/2021/05/25/uk/drug-dealer-cheese-sentenced-scli-gbr-intl/index.html> <sup>[[Archive.org]][839]</sup>

[^164]: Vice.com, Cops Got a Drug Dealer's Fingerprints From Photos of His Hand on WhatsApp <https://www.vice.com/en/article/evqk9e/photo-of-fingerprints-used-to-arrest-drug-dealers> <sup>[[Archive.org]][840]</sup>

[^165]: JUSTIA Patent, Identification of taste attributes from an audio signal <https://patents.justia.com/patent/10891948> <sup>[[Archive.org]][841]</sup>

[^166]: IMDB, Gattaca 1997, <https://www.imdb.com/title/tt0119177/> <sup>[[Archive.org]][842]</sup>

[^167]: IMDB, Person of Interest 2011 <https://www.imdb.com/title/tt1839578> <sup>[[Archive.org]][843]</sup>

[^168]: IMDB, Minority Report 2002, <https://www.imdb.com/title/tt0181689> <sup>[[Archive.org]][844]</sup>

[^169]: Wikipedia, Deepfake <https://en.wikipedia.org/wiki/Deepfake> <sup>[[Wikiless]][845]</sup> <sup>[[Archive.org]][846]</sup>

[^170]: Econotimes, Deepfake Voice Technology: The Good. The Bad. The Future <https://www.econotimes.com/Deepfake-Voice-Technology-The-Good-The-Bad-The-Future-1601278> <sup>[[Archive.org]][847]</sup>

[^171]: Wikipedia, Deepfake Events <https://en.wikipedia.org/wiki/Deepfake#Example_events> <sup>[[Wikiless]][845]</sup> <sup>[[Archive.org]][846]</sup>

[^172]: Forbes, A Voice Deepfake Was Used To Scam A CEO Out Of $243,000 <https://www.forbes.com/sites/jessedamiani/2019/09/03/a-voice-deepfake-was-used-to-scam-a-ceo-out-of-243000/> <sup>[[Archive.org]][848]</sup>

[^173]: Joseph Steinberg, How To Prevent Facial Recognition Technology From Identifying You <https://josephsteinberg.com/how-to-prevent-facial-recognition-technology-from-identifying-you/> <sup>[[Archive.org]][849]</sup>

[^174]: NIST, Face recognition accuracy with masks using pre-COVID-19 algorithms <https://nvlpubs.nist.gov/nistpubs/ir/2020/NIST.IR.8311.pdf> <sup>[[Archive.org]][850]</sup>

[^175]: BBC, Facial recognition identifies people wearing masks <https://www.bbc.com/news/technology-55573802> <sup>[[Archive.org]][851]</sup>

[^176]: University of Wisconsin, Exploring Reflectacles As Anti-Surveillance Glasses and for Adversarial Machine Learning in Computer Vision <http://diglib.uwgb.edu/digital/api/collection/p17003coll4/id/71/download> <sup>[[Archive.org]][852]</sup>

[^177]: Wikipedia, Phishing <https://en.wikipedia.org/wiki/Phishing> <sup>[[Wikiless]][853]</sup> <sup>[[Archive.org]][854]</sup>

[^178]: Wikipedia, Social Engineering <https://en.wikipedia.org/wiki/Social_engineering_(security)> <sup>[[Wikiless]][855]</sup> <sup>[[Archive.org]][856]</sup>

[^179]: BBC, Spy pixels in emails have become endemic <https://www.bbc.com/news/technology-56071437> <sup>[[Archive.org]][857]</sup>

[^180]: Wikipedia, Exploit <https://en.wikipedia.org/wiki/Exploit_(computer_security)> <sup>[[Wikiless]][858]</sup> <sup>[[Archive.org]][859]</sup>

[^181]: Wikipedia, Freedom Hosting <https://en.wikipedia.org/wiki/Freedom_Hosting> <sup>[[Wikiless]][860]</sup> <sup>[[Archive.org]][861]</sup>

[^182]: Wired, 2013 FBI Admits It Controlled Tor Servers Behind Mass Malware Attack <https://www.wired.com/2013/09/freedom-hosting-fbi/> <sup>[[Archive.org]][862]</sup>

[^183]: Wikipedia, 2020 United States federal government data breach <https://en.wikipedia.org/wiki/2020_United_States_federal_government_data_breach> <sup>[[Wikiless]][863]</sup> <sup>[[Archive.org]][864]</sup>

[^184]: BBC, China social media: WeChat and the Surveillance State <https://www.bbc.com/news/blogs-china-blog-48552907> <sup>[[Archive.org]][865]</sup>

[^185]: The Intercept, Revealed: Massive Chinese Police Database <https://theintercept.com/2021/01/29/china-uyghur-muslim-surveillance-police/> <sup>[[Archive.org]][866]</sup>

[^186]: Wikipedia, Sandbox <https://en.wikipedia.org/wiki/Sandbox_(computer_security)> <sup>[[Wikiless]][867]</sup> <sup>[[Archive.org]][868]</sup>

[^187]: Wired, Why the Security of USB Is Fundamentally Broken <https://www.wired.com/2014/07/usb-security/> <sup>[[Archive.org]][869]</sup>

[^188]: Wikipedia, Stuxnet <https://en.wikipedia.org/wiki/Stuxnet> <sup>[[Wikiless]][870]</sup> <sup>[[Archive.org]][871]</sup>

[^189]: Superuser.com, How do I safely investigate a USB stick found in the parking lot at work? <https://superuser.com/questions/1206321/how-do-i-safely-investigate-a-usb-stick-found-in-the-parking-lot-at-work> <sup>[[Archive.org]][872]</sup>

[^190]: The Guardian, Glenn Greenwald: how the NSA tampers with US-made internet routers <https://www.theguardian.com/books/2014/may/12/glenn-greenwald-nsa-tampers-us-internet-routers-snowden> <sup>[[Archive.org]][873]</sup>

[^191]: Wikipedia, Rootkit <https://en.wikipedia.org/wiki/Rootkit> <sup>[[Wikiless]][874]</sup> <sup>[[Archive.org]][875]</sup>

[^192]: Wikipedia, Userspace <https://en.wikipedia.org/wiki/User_space> <sup>[[Wikiless]][876]</sup> <sup>[[Archive.org]][877]</sup>

[^193]: Wikipedia, Firmware <https://en.wikipedia.org/wiki/Firmware> <sup>[[Wikiless]][878]</sup> <sup>[[Archive.org]][879]</sup>

[^194]: Wikipedia, BIOS <https://en.wikipedia.org/wiki/BIOS> <sup>[[Wikiless]][880]</sup> <sup>[[Archive.org]][881]</sup>

[^195]: Wikipedia, UEFI <https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface> <sup>[[Wikiless]][882]</sup> <sup>[[Archive.org]][883]</sup>

[^196]: Bellingcat, Joseph Mifsud: Rush for the EXIF <https://www.bellingcat.com/news/americas/2018/10/26/joseph-mifsud-rush-exif/> <sup>[[Archive.org]][884]</sup>

[^197]: Zoom Support, Adding a watermark <https://support.zoom.us/hc/en-us/articles/209605273-Adding-a-Watermark> <sup>[[Archive.org]][885]</sup>

[^198]: Zoom Support, Audio Watermark <https://support.zoom.us/hc/en-us/articles/360021839031-Audio-Watermark> <sup>[[Archive.org]][886]</sup>

[^199]: CreativeCloud Extension, IMATAG <https://exchange.adobe.com/creativecloud.details.101789.imatag-invisible-watermark-and-image-monitoring.html> <sup>[[Archive.org]][887]</sup>

[^200]: NexGuard, <https://dtv.nagra.com/nexguard-forensic-watermarking> <sup>[[Archive.org]][888]</sup>

[^201]: Vobile Solutions, <https://www.vobilegroup.com/solutions> <sup>[[Archive.org]][889]</sup>

[^202]: Cinavia, <https://www.cinavia.com/languages/english/pages/technology.html> <sup>[[Archive.org]][890]</sup>

[^203]: Imatag, <https://www.imatag.com/> <sup>[[Archive.org]][891]</sup>

[^204]: Wikipedia, Steganography <https://en.wikipedia.org/wiki/Steganography> <sup>[[Wikiless]][892]</sup> <sup>[[Archive.org]][893]</sup>

[^205]: IEEExplore, A JPEG compression resistant steganography scheme for raster graphics images <https://ieeexplore.ieee.org/document/4428921> <sup>[[Archive.org]][894]</sup>

[^206]: ScienceDirect, Robust audio watermarking using perceptual masking <https://www.sciencedirect.com/science/article/abs/pii/S0165168498000140> <sup>[[Archive.org]][895]</sup>

[^207]: IEEExplore, Spread-spectrum watermarking of audio signals <https://ieeexplore.ieee.org/abstract/document/1188746> <sup>[[Archive.org]][896]</sup>

[^208]: Google Scholar, source camera identification <https://scholar.google.com/scholar?q=source+camera+identification> <sup>[[Archive.org]][897]</sup>

[^209]: Wikipedia, Printing Steganography <https://en.wikipedia.org/wiki/Machine_Identification_Code> <sup>[[Wikiless]][898]</sup> <sup>[[Archive.org]][899]</sup>

[^210]: MIT, SeeingYellow, <http://seeingyellow.com/> <sup>[[Archive.org]][900]</sup>

[^211]: arXiv, An Analysis of Anonymity in the Bitcoin System <https://arxiv.org/abs/1107.4524> <sup>[[Archive.org]][901]</sup>

[^212]: Bellingcat, How To Track Illegal Funding Campaigns Via Cryptocurrency, <https://www.bellingcat.com/resources/how-tos/2019/03/26/how-to-track-illegal-funding-campaigns-via-cryptocurrency/> <sup>[[Archive.org]][902]</sup>

[^213]: Wikipedia, KYC <https://en.wikipedia.org/wiki/Know_your_customer> <sup>[[Wikiless]][903]</sup> <sup>[[Archive.org]][904]</sup>

[^214]: arXiv.org, Probing the Mystery of Cryptocurrency Theft: An Investigation into Methods for Taint Analysis <https://arxiv.org/pdf/1906.05754.pdf> <sup>[[Archive.org]][905]</sup>

[^215]: YouTube, Breaking Monero <https://www.youtube.com/watch?v=WOyC6OB6ezA&list=PLsSYUeVwrHBnAUre2G_LYDsdo-tD0ov-y> <sup>[[Invidious]][906]</sup>

[^216]: Monero, Monero vs Princeton Researchers, <https://monero.org/monero-vs-princeton-researchers/> <sup>[[Archive.org]][907]</sup>

[^217]: Wikipedia, Cryptocurrency Tumbler <https://en.wikipedia.org/wiki/Cryptocurrency_tumbler> <sup>[[Wikiless]][908]</sup> <sup>[[Archive.org]][909]</sup>

[^218]: Wikipedia, Security Through Obscurity <https://en.wikipedia.org/wiki/Security_through_obscurity> <sup>[[Wikiless]][910]</sup> <sup>[[Archive.org]][911]</sup>

[^219]: ArXiv, Tracking Mixed Bitcoins, <https://arxiv.org/abs/2009.14007> <sup>[[Archive.org]][912]</sup>

[^220]: SSRN, The Cryptocurrency Tumblers: Risks, Legality and Oversight <https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3080361> <sup>[[Archive.org]][913]</sup>

[^221]: Magnet Forensics, Magnet AXIOM <https://www.magnetforensics.com/products/magnet-axiom/cloud/> <sup>[[Archive.org]][914]</sup>

[^222]: Cellebrite, Unlock cloud-based evidence to solve the case sooner <https://www.cellebrite.com/en/ufed-cloud/> <sup>[[Archive.org]][915]</sup>

[^223]: Chromium Documentation, Technical analysis of client identification mechanisms <https://sites.google.com/a/chromium.org/dev/Home/chromium-security/client-identification-mechanisms#TOC-Machine-specific-characteristics> <sup>[[Archive.org]][916]</sup>

[^224]: Mozilla Wiki, Fingerprinting <https://wiki.mozilla.org/Fingerprinting> <sup>[[Archive.org]][917]</sup>

[^225]: Grayshirt, <https://www.grayshift.com/> <sup>[[Archive.org]][918]</sup>

[^226]: Securephones.io, Data Security on Mobile Devices: Current State of the Art, Open Problems, and Proposed Solutions <https://securephones.io/main.pdf> <sup>[[Archive.org]][919]</sup>

[^227]: Loup-Vaillant.fr, Rolling Your Own Crypto <https://loup-vaillant.fr/articles/rolling-your-own-crypto> <sup>[[Archive.org]][920]</sup>

[^228]: Dhole Moments, Crackpot Cryptography and Security Theater <https://soatok.blog/2021/02/09/crackpot-cryptography-and-security-theater/> <sup>[[Archive.org]][921]</sup>

[^229]: Vice.com, Why You Don't Roll Your Own Crypto <https://www.vice.com/en/article/wnx8nq/why-you-dont-roll-your-own-crypto> <sup>[[Archive.org]][922]</sup>

[^230]: YouTube, Great Crypto Failures <https://www.youtube.com/watch?v=loy84K3AJ5Q> <sup>[[Invidious]][923]</sup>
...
[^232]: Citizenlab.ca, Move Fast and Roll Your Own Crypto <https://citizenlab.ca/2020/04/move-fast-roll-your-own-crypto-a-quick-look-at-the-confidentiality-of-zoom-meetings/> <sup>[[Archive.org]][924]</sup>

[^233]: Jack Poon, The myth of military grade encryption <https://medium.com/@atcipher/the-myth-of-military-grade-encryption-292313ae6369> <sup>[[Archive.org]][925]</sup>

[^234]: Congruent Labs, Stop calling it "Military-Grade Encryption" <https://blog.congruentlabs.co/military-grade-encryption/> <sup>[[Archive.org]][926]</sup>

[^235]: IronCoreLabs Blog, "Military Grade Encryption" <https://blog.ironcorelabs.com/military-grade-encryption-69aae0145588> <sup>[[Archive.org]][927]</sup>

[^236]: Wikipedia, Gag Order, <https://en.wikipedia.org/wiki/Gag_order> <sup>[[Wikiless]][928]</sup> <sup>[[Archive.org]][929]</sup>

[^237]: Wikipedia, National Security Letter <https://en.wikipedia.org/wiki/National_security_letter> <sup>[[Wikiless]][930]</sup> <sup>[[Archive.org]][931]</sup>

[^238]: BleepingComputer, DoubleVPN servers, logs, and account info seized by law enforcement <https://www.bleepingcomputer.com/news/security/doublevpn-servers-logs-and-account-info-seized-by-law-enforcement/> <sup>[[Archive.org]][932]</sup>

[^239]: CyberScoop, Court rules encrypted email provider Tutanota must monitor messages in blackmail case <https://www.cyberscoop.com/court-rules-encrypted-email-tutanota-monitor-messages/> <sup>[[Archive.org]][933]</sup>

[^240]: Heise Online (German), <https://www.heise.de/news/Gericht-zwingt-Mailprovider-Tutanota-zu-Ueberwachungsfunktion-4972460.html> <sup>[[Archive.org]][934]</sup>

[^241]: PCMag, Did PureVPN Cross a Line When It Disclosed User Information? <https://www.pcmag.com/opinions/did-purevpn-cross-a-line-when-it-disclosed-user-information> <sup>[[Archive.org]][935]</sup>

[^242]: Internet Archive, Wipeyourdata, "No logs" EarthVPN user arrested after police finds logs <https://archive.is/XNuVw#selection-230.0-230.1> <sup>[[Archive.org]][936]</sup>

[^243]: Internet Archive, Invisibler, What Everybody Ought to Know About HideMyAss <https://archive.is/ag9w4#selection-136.0-136.1> <sup>[[Archive.org]][937]</sup>

[^244]: Wikipedia, Lavabit Suspension and Gag order, <https://en.wikipedia.org/wiki/Lavabit#Suspension_and_gag_order> <sup>[[Wikiless]][938]</sup> <sup>[[Archive.org]][939]</sup>

[^245]: Wikipedia, Warrant Canary <https://en.wikipedia.org/wiki/Warrant_canary> <sup>[[Wikiless]][940]</sup> <sup>[[Archive.org]][941]</sup>

[^246]: Washington Post, The intelligence coup of the century <https://www.washingtonpost.com/graphics/2020/world/national-security/cia-crypto-encryption-machines-espionage/> <sup>[[Archive.org]][942]</sup>

[^247]: Swissinfo.ch, Second Swiss firm allegedly sold encrypted spying devices <https://www.swissinfo.ch/eng/second-swiss-firm-allegedly-sold-encrypted-spying-devices/46186432> <sup>[[Archive.org]][943]</sup>

[^248]: Wikipedia, Das Leben der Anderen <https://en.wikipedia.org/wiki/The_Lives_of_Others> <sup>[[Wikiless]][944]</sup> <sup>[[Archive.org]][945]</sup>

[^249]: Wired, Mind the Gap: This Researcher Steals Data With Noise, Light, and Magnets <https://www.wired.com/story/air-gap-researcher-mordechai-guri/> <sup>[[Archive.org]][946]</sup>

[^250]: Ben Nassi, Lamphone, <https://www.nassiben.com/lamphone> <sup>[[Archive.org]][947]</sup>

[^251]: Wikipedia, Rubber-hose Cryptanalysis https://en.wikipedia.org/wiki/Rubber-hose_cryptanalysis

[^252]: Defuse.ca, TrueCrypt's Plausible Deniability is Theoretically Useless <https://defuse.ca/truecrypt-plausible-deniability-useless-by-game-theory.htm> <sup>[[Archive.org]][236]</sup>

[^253]: Wikipedia, OONI, <https://en.wikipedia.org/wiki/OONI> <sup>[[Wikiless]][948]</sup> <sup>[[Archive.org]][949]</sup>

[^254]: Privacy International, Timeline of SIM Card Registration Laws <https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws> <sup>[[Archive.org]][950]</sup>

[^255]: NYTimes, Lost Passwords Lock Millionaires Out of Their Bitcoin Fortunes <https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html> <sup>[[Archive.org]][951]</sup>

[^256]: Usenix.org, Shedding too much Light on a Microcontroller's Firmware Protection <https://www.usenix.org/system/files/conference/woot17/woot17-paper-obermaier.pdf> <sup>[[Archive.org]][952]</sup>

[^257]: Wikipedia, TAILS, <https://en.wikipedia.org/wiki/Tails_(operating_system)> <sup>[[Wikiless]][953]</sup> <sup>[[Archive.org]][954]</sup>

[^258]: Vice.com, Facebook Helped the FBI Hack a Child Predator <https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez> <sup>[[Archive.org]][955]</sup>

[^259]: Veracrypt Documentation, Trim Operations <https://www.veracrypt.fr/en/Trim%20Operation.html> <sup>[[Archive.org]][956]</sup>

[^260]: Coreboot, <https://www.coreboot.org/> <sup>[[Archive.org]][957]</sup>

[^261]: YouTube, 36C3 - Uncover, Understand, Own - Regaining Control Over Your AMD CPU <https://www.youtube.com/watch?v=bKH5nGLgi08&t=2834s> <sup>[[Invidious]][83]</sup>

[^262]: Qubes OS, Anti-Evil Maid, <https://github.com/QubesOS/qubes-antievilmaid> <sup>[[Archive.org]][261]</sup>

[^263]: XKCD, Password Strength <https://xkcd.com/936/> <sup>[[Archive.org]][958]</sup>

[^264]: QubesOS FAQ, <https://www.qubes-os.org/faq/#is-secure-boot-supported> <sup>[[Archive.org]][354]</sup>

[^265]: Wikipedia, Secure Boot, <https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface#Secure_boot> <sup>[[Wikiless]][882]</sup> <sup>[[Archive.org]][883]</sup>

[^266]: Wikipedia, Booting <https://en.wikipedia.org/wiki/Booting> <sup>[[Wikiless]][959]</sup> <sup>[[Archive.org]][960]</sup>

[^267]: Wired <https://www.wired.com/2013/12/better-data-security-nail-polish/> <sup>[[Archive.org]][961]</sup>

[^268]: Wikipedia, Virtual Machine <https://en.wikipedia.org/wiki/Virtual_machine> <sup>[[Wikiless]][962]</sup> <sup>[[Archive.org]][963]</sup>

[^269]: Wikipedia, Plausible Deniability <https://en.wikipedia.org/wiki/Plausible_deniability> <sup>[[Wikiless]][964]</sup> <sup>[[Archive.org]][965]</sup>

[^270]: Wikipedia, Deniable Encryption <https://en.wikipedia.org/wiki/Deniable_encryption> <sup>[[Wikiless]][966]</sup> <sup>[[Archive.org]][967]</sup>

[^271]: Privacytools.io, Don't use Windows 10 - It's a privacy nightmare <https://privacytools.io/operating-systems/#win10> <sup>[[Archive.org]][968]</sup>

[^272]: Wikipedia, Deniable Encryption <https://en.wikipedia.org/wiki/Deniable_encryption> <sup>[[Wikiless]][966]</sup> <sup>[[Archive.org]][967]</sup>

[^273]: Wikipedia, Key Disclosure Laws <https://en.wikipedia.org/wiki/Key_disclosure_law> <sup>[[Wikiless]][518]</sup> <sup>[[Archive.org]][519]</sup>

[^274]: GP Digital, World map of encryption laws and policies <https://www.gp-digital.org/world-map-of-encryption/> <sup>[[Archive.org]][520]</sup>

[^275]: Wikipedia, Bitlocker <https://en.wikipedia.org/wiki/BitLocker> <sup>[[Wikiless]][969]</sup> <sup>[[Archive.org]][970]</sup>

[^276]: Alpine Linux Wiki, Setting up a laptop <https://wiki.alpinelinux.org/wiki/Setting_up_a_laptop> <sup>[[Archive.org]][971]</sup>

[^277]: Wikipedia, Evil Maid Attack <https://en.wikipedia.org/wiki/Evil_maid_attack> <sup>[[Wikiless]][972]</sup> <sup>[[Archive.org]][973]</sup>

[^278]: Wikipedia, Cold Boot Attack <https://en.wikipedia.org/wiki/Cold_boot_attack> <sup>[[Wikiless]][974]</sup> <sup>[[Archive.org]][975]</sup>

[^279]: CITP 2008 (<https://www.youtube.com/watch?v=JDaicPIgn9U>) <sup>[[Invidious]][976]</sup>

[^280]: ResearchGate, Defeating Plausible Deniability of VeraCrypt Hidden Operating Systems <https://www.researchgate.net/publication/318155607_Defeating_Plausible_Deniability_of_VeraCrypt_Hidden_Operating_Systems> <sup>[[Archive.org]][977]</sup>

[^281]: SANS.org, Mission Implausible: Defeating Plausible Deniability with Digital Forensics <https://www.sans.org/reading-room/whitepapers/forensics/mission-implausible-defeating-plausible-deniability-digital-forensics-39500> <sup>[[Archive.org]][978]</sup>

[^282]: SourceForge, Veracrypt Forum <https://sourceforge.net/p/veracrypt/discussion/technical/thread/53f33faf/> <sup>[[Archive.org]][979]</sup>

[^283]: Microsoft, BitLocker Countermeasures <https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures> <sup>[[Archive.org]][980]</sup>

[^284]: SANS, Windows ShellBag Forensics in-depth <https://www.sans.org/reading-room/whitepapers/forensics/windows-shellbag-forensics-in-depth-34545> <sup>[[Archive.org]][981]</sup>

[^285]: University of York, Forensic data recovery from the Windows Search Database <https://eprints.whiterose.ac.uk/75046/1/Forensic_Data_Recovery_From_The_Windows_Search_Database_preprint_DIIN328.pdf> <sup>[[Archive.org]][982]</sup>

[^286]: A forensic insight into Windows 10 Jump Lists <https://cyberforensicator.com/wp-content/uploads/2017/01/1-s2.0-S1742287616300202-main.2-14.pdf> <sup>[[Archive.org]][983]</sup>

[^287]: Wikipedia, Gatekeeper <https://en.wikipedia.org/wiki/Gatekeeper_(macOS)> <sup>[[Wikiless]][984]</sup> <sup>[[Archive.org]][985]</sup>

[^288]: Wikipedia Veracrypt <https://en.wikipedia.org/wiki/VeraCrypt> <sup>[[Wikiless]][986]</sup> <sup>[[Archive.org]][987]</sup>

[^289]: OSTIF Veracrypt Audit, 2016, <https://ostif.org/the-veracrypt-audit-results/> <sup>[[Archive.org]][988]</sup>

[^290]: Veracrypt Documentation, Unencrypted Data in RAM <https://www.veracrypt.fr/en/Unencrypted%20Data%20in%20RAM.html> <sup>[[Archive.org]][989]</sup>

[^291]: Veracrypt Documentation, Data Leaks <https://www.veracrypt.fr/code/VeraCrypt/plain/doc/html/Data%20Leaks.html> <sup>[[Archive.org]][990]</sup>

[^292]: Wikipedia, Trim <https://en.wikipedia.org/wiki/Trim_(computing)> <sup>[[Wikiless]][453]</sup> <sup>[[Archive.org]][454]</sup>

[^293]: Veracrypt Documentation, Trim Operations <https://www.veracrypt.fr/en/Trim%20Operation.html> <sup>[[Archive.org]][956]</sup>

[^294]: Veracrypt Documentation, Rescue Disk <https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html> <sup>[[Archive.org]][991]</sup>

[^295]: St Cloud State University, Forensic Research on Solid State Drives using Trim Analysis <https://repository.stcloudstate.edu/cgi/viewcontent.cgi?article=1141&context=msia_etds> <sup>[[Archive.org]][992]</sup>

[^296]: WindowsCentral, Trim Tutorial <https://www.windowscentral.com/how-ensure-trim-enabled-windows-10-speed-ssd-performance> <sup>[[Archive.org]][993]</sup>

[^297]: Veracrypt Documentation, Trim Operation <https://veracrypt.eu/en/docs/trim-operation/> <sup>[[Archive.org]][994]</sup>

[^298]: Black Hat 2018, Perfectly Deniable Steganographic Disk Encryption <https://i.blackhat.com/eu-18/Thu-Dec-6/eu-18-Schaub-Perfectly-Deniable-Steganographic-Disk-Encryption.pdf> <sup>[[Archive.org]][995]</sup>

[^299]: Milan Broz's Blog, TRIM & dm-crypt ... problems? <http://asalor.blogspot.com/2011/08/trim-dm-crypt-problems.html> <sup>[[Archive.org]][996]</sup>

[^300]: Veracrypt Documentation, Rescue Disk <https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html> <sup>[[Archive.org]][991]</sup>

[^301]: Wikipedia, Virtualbox <https://en.wikipedia.org/wiki/VirtualBox> <sup>[[Wikiless]][997]</sup> <sup>[[Archive.org]][998]</sup>

[^302]: VirtualBox Ticket 17987 <https://www.virtualbox.org/ticket/17987> <sup>[[Archive.org]][999]</sup>

[^303]: Whonix Documentation, Spectre Meltdown, <https://www.whonix.org/wiki/Spectre_Meltdown#VirtualBox> <sup>[[Archive.org]][88]</sup>

[^304]: Whonix Documentation, Stream Isolation <https://www.whonix.org/wiki/Stream_Isolation> <sup>[[Archive.org]][302]</sup>

[^305]: Whonix Documentation, Tunnels Comparison Table, <https://www.whonix.org/wiki/Tunnels/Introduction#Comparison_Table> <sup>[[Archive.org]][304]</sup>

[^306]: Wikipedia, Whonix <https://en.wikipedia.org/wiki/Whonix> <sup>[[Wikiless]][1000]</sup> <sup>[[Archive.org]][1001]</sup>

[^307]: Oracle Virtualbox Manual, Snapshots <https://docs.oracle.com/en/virtualization/virtualbox/6.0/user/snapshots.html> <sup>[[Archive.org]][1002]</sup>

[^308]: Utica College, FORENSIC RECOVERY OF EVIDENCE FROM DELETED ORACLE VIRTUALBOX VIRTUAL MACHINES <https://programs.online.utica.edu/sites/default/files/Neal_6_Gonnella_Forensic_Recovery_of_Evidence_from_Deleted_Oracle_VirtualBox_Virtual_Machine.pdf> <sup>[[Archive.org]][1003]</sup>

[^309]: Wikipedia, Spectre <https://en.wikipedia.org/wiki/Spectre_(security_vulnerability)> <sup>[[Wikiless]][1004]</sup> <sup>[[Archive.org]][1005]</sup>

[^310]: Wikipedia, Meltdown <https://en.wikipedia.org/wiki/Meltdown_(security_vulnerability)> <sup>[[Wikiless]][1006]</sup> <sup>[[Archive.org]][1007]</sup>

[^311]: Whonix Documentation, Stream Isolation, By Settings <https://www.whonix.org/wiki/Stream_Isolation#By_Settings> <sup>[[Archive.org]][1008]</sup>

[^312]: Wikipedia, TOTP <https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm> <sup>[[Wikiless]][1009]</sup> <sup>[[Archive.org]][1010]</sup>

[^313]: Wikipedia, Multi-Factor Authentication <https://en.wikipedia.org/wiki/Multi-factor_authentication> <sup>[[Wikiless]][1011]</sup> <sup>[[Archive.org]][1012]</sup>

[^314]: Whonix Documentation, Bridged Adapters Warning <https://www.whonix.org/wiki/Whonix-Gateway_Security#Warning:_Bridged_Networking> <sup>[[Archive.org]][1013]</sup>

[^315]: Qubes OS, FAQ, <https://www.qubes-os.org/faq/#is-qubes-just-another-linux-distribution> <sup>[[Archive.org]][1014]</sup>

[^316]: Qubes OS, System Requirements <https://www.qubes-os.org/doc/system-requirements/> <sup>[[Archive.org]][1015]</sup>

[^317]: Whonix Documentation, Stream Isolation <https://www.whonix.org/wiki/Stream_Isolation> <sup>[[Archive.org]][302]</sup>

[^318]: Whonix Documentation, Tunnels Comparison Table, <https://www.whonix.org/wiki/Tunnels/Introduction#Comparison_Table> <sup>[[Archive.org]][304]</sup>

[^319]: Qubes OS Issues, Simulate Hibernation / Suspend-To-Disk #2414 <https://github.com/QubesOS/qubes-issues/issues/2414> <sup>[[Archive.org]][1016]</sup>

[^320]: Wikipedia, AppArmor <https://en.wikipedia.org/wiki/AppArmor> <sup>[[Wikiless]][1017]</sup> <sup>[[Archive.org]][1018]</sup>

[^321]: Wikipedia, SELinux <https://en.wikipedia.org/wiki/Security-Enhanced_Linux> <sup>[[Wikiless]][1019]</sup> <sup>[[Archive.org]][1020]</sup>

[^322]: Wikipedia, TOTP <https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm> <sup>[[Wikiless]][1009]</sup> <sup>[[Archive.org]][1010]</sup>

[^323]: Wikipedia, Multi-Factor Authentication <https://en.wikipedia.org/wiki/Multi-factor_authentication> <sup>[[Wikiless]][1011]</sup> <sup>[[Archive.org]][1012]</sup>

[^324]: Wikipedia, Captcha <https://en.wikipedia.org/wiki/CAPTCHA> <sup>[[Wikiless]][1021]</sup> <sup>[[Archive.org]][1022]</sup>

[^325]: Wikipedia, Turing Test <https://en.wikipedia.org/wiki/Turing_test> <sup>[[Wikiless]][1023]</sup> <sup>[[Archive.org]][1024]</sup>

[^326]: Google reCaptcha <https://www.google.com/recaptcha/about/> <sup>[[Archive.org]][1025]</sup>

[^327]: hCaptcha <https://www.hcaptcha.com/> <sup>[[Archive.org]][1026]</sup>

[^328]: hCaptcha, hCaptcha Is Now the Largest Independent CAPTCHA Service, Runs on 15% Of The Internet <https://www.hcaptcha.com/post/hcaptcha-now-the-largest-independent-captcha-service> <sup>[[Archive.org]][1027]</sup>

[^329]: Nearcyan.com, You (probably) don't need ReCAPTCHA <https://nearcyan.com/you-probably-dont-need-recaptcha/> <sup>[[Archive.org]][1028]</sup>

[^330]: ArsTechnica, "Google's reCAPTCHA turns "invisible," will separate bots from people without challenges" <https://arstechnica.com/gadgets/2017/03/googles-recaptcha-announces-invisible-background-captchas/> <sup>[[Archive.org]][1029]</sup>

[^331]: BlackHat Asia 2016, "I'm not a human: Breaking the Google reCAPTCHA", <https://www.blackhat.com/docs/asia-16/materials/asia-16-Sivakorn-Im-Not-a-Human-Breaking-the-Google-reCAPTCHA-wp.pdf> <sup>[[Archive.org]][1030]</sup>

[^332]: Google Blog <https://security.googleblog.com/2014/12/are-you-robot-introducing-no-captcha.html> <sup>[[Archive.org]][1031]</sup>

[^333]: Tor Project Community, Cloudflare Captcha Monitoring <https://community.torproject.org/gsoc/cloudflare-captcha-monitoring/> <sup>[[Archive.org]][1032]</sup>

[^334]: Cloudflare Blog, Cloudflare supports Privacy Pass <https://blog.cloudflare.com/cloudflare-supports-privacy-pass/> <sup>[[Archive.org]][1033]</sup>

[^335]: Privacy International, Timeline of SIM Card Registration Laws <https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws> <sup>[[Archive.org]][950]</sup>

[^336]: Wikipedia, Device Fingerprinting <https://en.wikipedia.org/wiki/Device_fingerprint> <sup>[[Wikiless]][1034]</sup> <sup>[[Archive.org]][1035]</sup>

[^337]: Developers Google Blog,

    Guidance to developers affected by our effort to block less secure browsers and applications <https://developers.googleblog.com/2020/08/guidance-for-our-effort-to-block-less-secure-browser-and-apps.html> <sup>[[Archive.org]][1036]</sup>

[^338]: Google Help, Access age-restricted content & features <https://support.google.com/accounts/answer/10071085> <sup>[[Archive.org]][1037]</sup>

[^339]: Wikipedia, Dark Pattern <https://en.wikipedia.org/wiki/Dark_pattern> <sup>[[Wikiless]][1038]</sup> <sup>[[Archive.org]][1039]</sup>

[^340]: The Verge, Tinder will give you a verified blue check mark if you pass its catfishing test <https://www.theverge.com/2020/1/23/21077423/tinder-photo-verification-blue-checkmark-safety-center-launch-noonlight> <sup>[[Archive.org]][1040]</sup>

[^341]: DigitalInformationWorld, Facebook will now require you to Create a Video Selfie for Identity Verification <https://www.digitalinformationworld.com/2020/03/facebook-is-now-demanding-some-users-to-create-a-video-selfie-for-identity-verification.html> <sup>[[Archive.org]][1041]</sup>

[^342]: Vice.com, PornHub Announces 'Biometric Technology' to Verify Users <https://www.vice.com/en/article/m7a4eq/pornhub-new-verification-policy-biometric-id> <sup>[[Archive.org]][1042]</sup>

[^343]: Variety, China Launches Hotline to Report Online Comments That 'Distort' History or 'Deny' Its Cultural Excellence <https://variety.com/2021/digital/news/china-censorship-hotline-historical-nihilism-1234950554/> <sup>[[Archive.org]][1043]</sup>

[^344]: Wikipedia, Trust but verify <https://en.wikipedia.org/wiki/Trust,_but_verify> <sup>[[Wikiless]][672]</sup> <sup>[[Archive.org]][673]</sup>

[^345]: Wikipedia, Zero-trust Security Model <https://en.wikipedia.org/wiki/Zero_trust_security_model> <sup>[[Wikiless]][1044]</sup> <sup>[[Archive.org]][1045]</sup>

[^346]: Wikipedia, Espionage, Organization <https://en.wikipedia.org/wiki/Espionage#Organization> <sup>[[Wikiless]][1046]</sup> <sup>[[Archive.org]][1047]</sup>

[^347]: Wikipedia, Sim Swapping <https://en.wikipedia.org/wiki/SIM_swap_scam> <sup>[[Wikiless]][1048]</sup> <sup>[[Archive.org]][1049]</sup>

[^348]: Whonix Documentation, <https://www.whonix.org/wiki/Tor#Edit_Tor_Configuration> <sup>[[Archive.org]][1050]</sup>

[^349]: Tor Browser Documentation, <https://support.torproject.org/tbb/tbb-editing-torrc/> <sup>[[Archive.org]][1051]</sup>

[^350]: Facebook Onion Website <http://facebookcorewwwi.onion>

[^351]: Google Help <https://support.google.com/accounts/answer/114129?hl=en> <sup>[[Archive.org]][1052]</sup>

[^352]: Google Help <https://support.google.com/google-ads/answer/7474263?hl=en> <sup>[[Archive.org]][1053]</sup>

[^353]: Google, Your account is disabled <https://support.google.com/accounts/answer/40695> <sup>[[Archive.org]][1054]</sup>

[^354]: Google, Request to restore the account <https://support.google.com/accounts/contact/disabled2> <sup>[[Archive.org]][1055]</sup>

[^355]: Google Help, Update your account to meet age requirements <https://support.google.com/accounts/answer/1333913?hl=en> <sup>[[Archive.org]][1056]</sup>

[^356]: Jumio, ID verification features <https://www.jumio.com/features/> <sup>[[Archive.org]][1057]</sup>

[^357]: Privacytools.io Recommended E-mail Providers <https://privacytools.io/providers/email/> <sup>[[Archive.org]][1058]</sup>

[^358]: ProtonMail Human Verification System [https://ProtonMail.com/support/knowledge-base/human-verification/][] <sup>[[Archive.org]][1059]</sup>

[^359]: Twitter Appeal Form <https://help.twitter.com/forms/general>

[^360]: KnowYourMeme, Good Luck, I'm Behind 7 Proxies <https://knowyourmeme.com/memes/good-luck-im-behind-7-proxies> <sup>[[Archive.org]][1060]</sup>

[^361]: Wikipedia, end-to-end encryption, <https://en.wikipedia.org/wiki/End-to-end_encryption> <sup>[[Wikiless]][1061]</sup> <sup>[[Archive.org]][1062]</sup>

[^362]: Wikipedia, Forward Secrecy, <https://en.wikipedia.org/wiki/Forward_secrecy> <sup>[[Wikiless]][1063]</sup> <sup>[[Archive.org]][1064]</sup>

[^363]: Protonblog, What is zero-access encryption and why it is important for security <https://protonmail.com/blog/zero-access-encryption/> <sup>[[Archive.org]][1065]</sup>

[^364]: Wikipedia, Cambridge Analytica Scandal, <https://en.wikipedia.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal> <sup>[[Wikiless]][1066]</sup> <sup>[[Archive.org]][1067]</sup>

[^365]: Signal Blog, Technology preview: Sealed sender for Signal <https://signal.org/blog/sealed-sender/> <sup>[[Archive.org]][1068]</sup>

[^366]: Signal Blog, Private Contact Discovery, <https://signal.org/blog/private-contact-discovery/> <sup>[[Archive.org]][1069]</sup>

[^367]: Signal Blog, Private Group System, <https://signal.org/blog/signal-private-group-system/> <sup>[[Archive.org]][1070]</sup>

[^368]: Privacytools.io, File-Sharing <https://privacytools.io/software/file-sharing/> <sup>[[Archive.org]][1071]</sup>

[^369]: Privacytools.io, Real-Time Communication <https://privacytools.io/software/real-time-communication/> <sup>[[Archive.org]][1072]</sup>

[^370]: Praxis Films, Open Letter from Laura Poitras <https://www.praxisfilms.org/open-letter-from-laura-poitras/> <sup>[[Archive.org]][1073]</sup>

[^371]: Wikipedia, SecureDrop <https://en.wikipedia.org/wiki/SecureDrop> <sup>[[Wikiless]][1074]</sup> <sup>[[Archive.org]][1075]</sup>

[^372]: Wikipedia, TPM <https://en.wikipedia.org/wiki/Trusted_Platform_Module> <sup>[[Wikiless]][1076]</sup> <sup>[[Archive.org]][1077]</sup>

[^373]: Wikipedia, Pastebin <https://en.wikipedia.org/wiki/Pastebin> <sup>[[Wikiless]][1078]</sup> <sup>[[Archive.org]][1079]</sup>

[^374]: Wikipedia, Wear Leveling <https://en.wikipedia.org/wiki/Wear_leveling> <sup>[[Wikiless]][1080]</sup> <sup>[[Archive.org]][1081]</sup>

[^375]: Wikipedia, Trim <https://en.wikipedia.org/wiki/Write_amplification#TRIM> <sup>[[Wikiless]][1082]</sup> <sup>[[Archive.org]][1083]</sup>

[^376]: Wikipedia, Write Amplification <https://en.wikipedia.org/wiki/Write_amplification> <sup>[[Wikiless]][1082]</sup> <sup>[[Archive.org]][1083]</sup>

[^377]: Wikipedia, Trim Disadvantages <https://en.wikipedia.org/wiki/Trim_(computing)#Disadvantages> <sup>[[Wikiless]][453]</sup> <sup>[[Archive.org]][454]</sup>

[^378]: Wikipedia, Garbage Collection <https://en.wikipedia.org/wiki/Write_amplification#Garbage_collection> <sup>[[Wikiless]][1082]</sup> <sup>[[Archive.org]][1083]</sup>

[^379]: Techgage, Too TRIM? When SSD Data Recovery is Impossible <https://techgage.com/article/too_trim_when_ssd_data_recovery_is_impossible/> <sup>[[Archive.org]][1084]</sup>

[^380]: ResearchGate, Live forensics method for acquisition on the Solid-State Drive (SSD) NVMe TRIM function <https://www.researchgate.net/publication/341761017_Live_forensics_method_for_acquisition_on_the_Solid_State_Drive_SSD_NVMe_TRIM_function> <sup>[[Archive.org]][1085]</sup>

[^381]: ElcomSoft, Life after Trim: Using Factory Access Mode for Imaging SSD Drives <https://blog.elcomsoft.com/2019/01/life-after-trim-using-factory-access-mode-for-imaging-ssd-drives/> <sup>[[Archive.org]][1086]</sup>

[^382]: Forensic Focus, Forensic Acquisition Of Solid State Drives With Open Source Tools <https://www.forensicfocus.com/articles/forensic-acquisition-of-solid-state-drives-with-open-source-tools/> <sup>[[Archive.org]][1087]</sup>

[^383]: ResearchGate, Solid State Drive Forensics: Where Do We Stand? <https://www.researchgate.net/publication/325976653_Solid_State_Drive_Forensics_Where_Do_We_Stand> <sup>[[Archive.org]][1088]</sup>

[^384]: Wikipedia, Parted Magic <https://en.wikipedia.org/wiki/Parted_Magic> <sup>[[Wikiless]][1089]</sup> <sup>[[Archive.org]][1090]</sup>

[^385]: Wikipedia, hdparm <https://en.wikipedia.org/wiki/Hdparm> <sup>[[Wikiless]][1091]</sup> <sup>[[Archive.org]][1092]</sup>

[^386]: GitHub, nvme-cli <https://github.com/linux-nvme/nvme-cli> <sup>[[Archive.org]][1093]</sup>

[^387]: PartedMagic Secure Erase, <https://partedmagic.com/secure-erase/> <sup>[[Archive.org]][1094]</sup>

[^388]: Partedmagic NVMe Secure Erase, <https://partedmagic.com/nvme-secure-erase/> <sup>[[Archive.org]][1095]</sup>

[^389]: UFSExplorer, Can I recover data from an encrypted storage? <https://www.ufsexplorer.com/solutions/data-recovery-on-encrypted-storage.php> <sup>[[Archive.org]][1096]</sup>

[^390]: Apple Developer Documentation, <https://developer.apple.com/library/archive/documentation/FileManagement/Conceptual/APFS_Guide/FAQ/FAQ.html> <sup>[[Archive.org]][1097]</sup>

[^391]: EFF, How to: Delete Your Data Securely on MacOS <https://ssd.eff.org/en/module/how-delete-your-data-securely-macos> <sup>[[Archive.org]][475]</sup>

[^392]: Privacytools.io, Productivity tools <https://www.privacytools.io/software/productivity/> <sup>[[Archive.org]][1098]</sup>

[^393]: Whonix Documentation, Scrubbing Metadata <https://www.whonix.org/wiki/Metadata> <sup>[[Archive.org]][1099]</sup>

[^394]: TAILS documentation, MAT <https://gitlab.tails.boum.org/tails/blueprints/-/wikis/doc/mat/> <sup>[[Archive.org]][1100]</sup>

[^395]: GitHub, Disable Gatekeeper on macOS Big Sur (11.x) <https://disable-gatekeeper.github.io/> <sup>[[Archive.org]][1101]</sup>

[^396]: DuckDuckGo help, Cache <https://help.duckduckgo.com/duckduckgo-help-pages/features/cache/> <sup>[[Archive.org]][1102]</sup>

[^397]: DuckDuckGo help, Sources <https://help.duckduckgo.com/duckduckgo-help-pages/results/sources/> <sup>[[Archive.org]][1103]</sup>

[^398]: Wikipedia, Dead Drop <https://en.wikipedia.org/wiki/Dead_drop> <sup>[[Wikiless]][1104]</sup> <sup>[[Archive.org]][1105]</sup>

[^399]: Wikipedia, Secure Communication Obfuscation <https://en.wikipedia.org/wiki/Obfuscation#Secure_communication> <sup>[[Wikiless]][1106]</sup> <sup>[[Archive.org]][1107]</sup>

[^400]: Wikipedia, Steganography <https://en.wikipedia.org/wiki/Steganography> <sup>[[Wikiless]][892]</sup> <sup>[[Archive.org]][893]</sup>

[^401]: Wikipedia, Kleptography <https://en.wikipedia.org/wiki/Kleptography> <sup>[[Wikiless]][1108]</sup> <sup>[[Archive.org]][1109]</sup>

[^402]: Wikipedia, Koalang <https://en.wikipedia.org/wiki/Koalang> <sup>[[Wikiless]][1110]</sup> <sup>[[Archive.org]][1111]</sup>

[^403]: Wikipedia, OPSEC <https://en.wikipedia.org/wiki/Operations_security> <sup>[[Wikiless]][1112]</sup> <sup>[[Archive.org]][1113]</sup>

[^404]: Privacytools.io, Operating Systems <https://privacytools.io/operating-systems/> <sup>[[Archive.org]][968]</sup>

[^405]: Brave Support, What is a Private Window with Tor? <https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-> <sup>[[Archive.org]][1114]</sup>

[^406]: Medium.com, The Windows USN Journal <https://medium.com/velociraptor-ir/the-windows-usn-journal-f0c55c9010e> <sup>[[Archive.org]][1115]</sup>

[^407]: Medium.com, Digging into the System Resource Usage Monitor (SRUM) <https://medium.com/velociraptor-ir/digging-into-the-system-resource-usage-monitor-srum-afbadb1a375> <sup>[[Archive.org]][1116]</sup>

[^408]: SANS, Timestamped Registry & NTFS Artifacts from Unallocated Space <https://www.sans.org/blog/timestamped-registry-ntfs-artifacts-from-unallocated-space/> <sup>[[Archive.org]][1117]</sup>

[^409]: DBAN, <https://dban.org/> <sup>[[Archive.org]][1118]</sup>

[^410]: NYTimes, Lost Passwords Lock Millionaires Out of Their Bitcoin Fortunes <https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html> <sup>[[Archive.org]][951]</sup>

[^411]: CrystalDiskInfo <https://crystalmark.info/en/software/crystaldiskinfo/> <sup>[[Archive.org]][1119]</sup>

[^412]: Wikipedia, Faraday Cage, <https://en.wikipedia.org/wiki/Faraday_cage> <sup>[[Wikiless]][1120]</sup> <sup>[[Archive.org]][1121]</sup>

[^413]: Edith Cowan University, A forensic examination of several mobile device Faraday bags & materials to test their effectiveness materials to test their effectiveness <https://ro.ecu.edu.au/cgi/viewcontent.cgi?article=1165&context=adf> <sup>[[Archive.org]][1122]</sup>

[^414]: arXiv, Deep-Spying: Spying using Smartwatch and Deep Learning <https://arxiv.org/abs/1512.05616> <sup>[[Archive.org]][1123]</sup>

[^415]: Acm.org, Privacy Implications of Accelerometer Data: A Review of Possible Inferences <https://dl.acm.org/doi/pdf/10.1145/3309074.3309076> <sup>[[Archive.org]][1124]</sup>

[^416]: YouTube, Fingerprinting Paper - Forensic Education <https://www.youtube.com/watch?v=sO98kDLkh-M> <sup>[[Invidious]][1125]</sup>

[^417]: Wikipedia, Touch DNA, <https://en.wikipedia.org/wiki/Touch_DNA> <sup>[[Wikiless]][1126]</sup> <sup>[[Archive.org]][1127]</sup>

[^418]: TheDNAGuide, DNA from Postage Stamps or Hair Samples? Yeeesssss..... <https://www.yourdnaguide.com/ydgblog/dna-hair-samples-postage-stamps> <sup>[[Archive.org]][1128]</sup>

[^419]: GitHub, Mhinkie, OONI-Detection <https://github.com/mhinkie/ooni-detection> <sup>[[Archive.org]][1129]</sup>

[^420]: Wikipedia, File Verification <https://en.wikipedia.org/wiki/File_verification> <sup>[[Wikiless]][1130]</sup> <sup>[[Archive.org]][1131]</sup>

[^421]: Wikipedia, CRC <https://en.wikipedia.org/wiki/Cyclic_redundancy_check> <sup>[[Wikiless]][1132]</sup> <sup>[[Archive.org]][1133]</sup>

[^422]: Wikipedia, MD5 <https://en.wikipedia.org/wiki/MD5> <sup>[[Wikiless]][1134]</sup> <sup>[[Archive.org]][1135]</sup>

[^423]: Wikipedia, MD5 Security <https://en.wikipedia.org/wiki/MD5#Security> <sup>[[Wikiless]][1134]</sup> <sup>[[Archive.org]][1135]</sup>

[^424]: Wikipedia, Collisions <https://en.wikipedia.org/wiki/Collision_(computer_science)> <sup>[[Wikiless]][1136]</sup> <sup>[[Archive.org]][1137]</sup>

[^425]: Wikipedia, SHA <https://en.wikipedia.org/wiki/Secure_Hash_Algorithms> <sup>[[Wikiless]][1138]</sup> <sup>[[Archive.org]][1139]</sup>

[^426]: Wikipedia, SHA-2 <https://en.wikipedia.org/wiki/SHA-2> <sup>[[Wikiless]][1140]</sup> <sup>[[Archive.org]][1141]</sup>

[^427]: Wikipedia, Collision Resistance <https://en.wikipedia.org/wiki/Collision_resistance> <sup>[[Wikiless]][1142]</sup> <sup>[[Archive.org]][1143]</sup>

[^428]: GnuPG Gpg4win Wiki, Check integrity of Gpg4win packages <https://wiki.gnupg.org/Gpg4win/CheckIntegrity> <sup>[[Archive.org]][1144]</sup>

[^429]: Medium.com, How to verify checksum on Mac <https://medium.com/@EvgeniIvanov/how-to-verify-checksum-on-mac-988f166b0c4f> <sup>[[Archive.org]][1145]</sup>

[^430]: Wikipedia, GPG <https://en.wikipedia.org/wiki/GNU_Privacy_Guard> <sup>[[Wikiless]][1146]</sup> <sup>[[Archive.org]][1147]</sup>

[^431]: Wikipedia, Public-Key Cryptography <https://en.wikipedia.org/wiki/Public-key_cryptography> <sup>[[Wikiless]][1148]</sup> <sup>[[Archive.org]][1149]</sup>

[^432]: Wikipedia, Polymorphic Code <https://en.wikipedia.org/wiki/Polymorphic_code> <sup>[[Wikiless]][1150]</sup> <sup>[[Archive.org]][1151]</sup>

[^433]: Whonix Documentation, Use of AV, <https://www.whonix.org/wiki/Malware_and_Firmware_Trojans#The_Utility_of_Antivirus_Tools> <sup>[[Archive.org]][1152]</sup>

[^434]: Whonix Forums, <https://forums.whonix.org/t/installation-of-antivirus-scanners-by-default/9755/8> <sup>[[Archive.org]][1153]</sup>

[^435]: AV-Test Security Report 2018-2019, <https://www.av-test.org/fileadmin/pdf/security_report/AV-TEST_Security_Report_2018-2019.pdf> <sup>[[Archive.org]][1154]</sup>

[^436]: ZDNet, ESET discovers 21 new Linux malware families <https://www.zdnet.com/article/eset-discovers-21-new-linux-malware-families/> <sup>[[Archive.org]][1155]</sup>

[^437]: NakeSecurity, EvilGnome -- Linux malware aimed at your desktop, not your servers <https://nakedsecurity.sophos.com/2019/07/25/evilgnome-linux-malware-aimed-at-your-laptop-not-your-servers/> <sup>[[Archive.org]][1156]</sup>

[^438]: Immunify, HiddenWasp: How to detect malware hidden on Linux & IoT <https://blog.imunify360.com/hiddenwasp-how-to-detect-malware-hidden-on-linux-iot> <sup>[[Archive.org]][1157]</sup>

[^439]: Wikipedia, Linux Malware <https://en.wikipedia.org/wiki/Linux_malware> <sup>[[Wikiless]][1158]</sup> <sup>[[Archive.org]][1159]</sup>

[^440]: Wikipedia, MacOS Malware <https://en.wikipedia.org/wiki/MacOS_malware> <sup>[[Wikiless]][1160]</sup> <sup>[[Archive.org]][1161]</sup>

[^441]: MacWorld, List of Mac viruses, malware and security flaws <https://www.macworld.co.uk/feature/mac-viruses-list-3668354/> <sup>[[Archive.org]][1162]</sup>

[^442]: JAMF, The Mac Malware of 2020 <https://resources.jamf.com/documents/macmalware-2020.pdf> <sup>[[Archive.org]][1163]</sup>

[^443]: MacOS Security and Privacy Guide, <https://github.com/drduh/macOS-Security-and-Privacy-Guide#viruses-and-malware> <sup>[[Archive.org]][281]</sup>

[^444]: ImageTragick.com, <https://imagetragick.com/> <sup>[[Archive.org]][1164]</sup>

[^445]: Oracle Virtualbox Documentation, <https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html> <sup>[[Archive.org]][1165]</sup>

[^446]: Oracle Virtualbox Documentation, <https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html> <sup>[[Archive.org]][1165]</sup>

[^447]: Lenny Zeltser, Analyzing Malicious Documents Cheat Sheet <https://zeltser.com/analyzing-malicious-documents/> <sup>[[Archive.org]][1166]</sup>

[^448]: Wikipedia, Portable Applications <https://en.wikipedia.org/wiki/Portable_application> <sup>[[Wikiless]][1167]</sup> <sup>[[Archive.org]][1168]</sup>

[^449]: Wikipedia, Virtualization <https://en.wikipedia.org/wiki/Virtualization> <sup>[[Wikiless]][1169]</sup> <sup>[[Archive.org]][1170]</sup>

[^450]: Tor Project, Project Snowflake <https://snowflake.torproject.org/> <sup>[[Archive.org]][527]</sup>

[^451]: GitHub, Obfs4 Repository <https://github.com/Yawning/obfs4/> <sup>[[Archive.org]][1171]</sup>

[^452]: Tor Browser Manual, Pluggable Transport <https://tb-manual.torproject.org/circumvention/> <sup>[[Archive.org]][1172]</sup>

[^453]: Tor Browser Manual, Pluggable Transport <https://tb-manual.torproject.org/circumvention/> <sup>[[Archive.org]][1172]</sup>

[^454]: Europol Wasabi Wallet Report, <https://www.tbstat.com/wp/uploads/2020/06/Europol-Wasabi-Wallet-Report.pdf> <sup>[[Archive.org]][1173]</sup>

[^455]: Monero Research Lab, Evaluating cryptocurrency security and privacy in a post-quantum world <https://github.com/insight-decentralized-consensus-lab/post-quantum-monero/blob/master/writeups/technical_note.pdf> <sup>[[Archive.org]][1174]</sup>
  ...
  [Your Network: 11]: #_Toc76996194
  [Acknowledgements: 161]: #_Toc76996359
  ...
  [219]: https://web.archive.org/web/https://www.schneier.com/blog/archives/2014/03/choosing_secure_1.html
  ...
  [229]: https://web.archive.org/web/https://tails.boum.org/doc/about/warning/index.en.html
  ...
  [252]: media/image20.jpeg
  [253]: media/image21.jpeg
  ...
  [270]: https://web.archive.org/web/https://help.ubuntu.com/16.04/ubuntu-help/power-hibernate.html
  [271]: https://web.archive.org/web/http://ubuntuhandbook.org/index.php/2020/05/lid-close-behavior-ubuntu-20-04/
  [272]: https://web.archive.org/web/https://tipsonubuntu.com/2018/04/28/change-lid-close-action-ubuntu-18-04-lts/
  [273]: https://web.archive.org/web/https://help.ubuntu.com/community/EnableHibernateWithEncryptedSwap
  [274]: https://web.archive.org/web/https://help.ubuntu.com/community/AnonymizingNetworkMACAddresses
  [275]: https://web.archive.org/web/https://josh.works/shell-script-basics-change-mac-address
  [276]: https://yewtu.be/watch?v=Sa0KqbpLye4
  [277]: https://web.archive.org/web/https://madaidans-insecurities.github.io/guides/linux-hardening.html
  [278]: https://web.archive.org/web/https://wiki.archlinux.org/title/Security
  [279]: https://web.archive.org/web/https://codeberg.org/SalamanderSecurity/PARSEC
  [280]: https://yewtu.be/watch?v=lFx5icuE6Io
  [281]: https://web.archive.org/web/https://github.com/drduh/macOS-Security-and-Privacy-Guide
  [282]: https://web.archive.org/web/https://support.apple.com/en-us/HT204455
  [283]: https://web.archive.org/web/https://sneak.berlin/20201112/your-computer-isnt-yours/
  [284]: https://web.archive.org/web/https://blog.jacopo.io/en/post/apple-ocsp/
  [285]: https://yewtu.be/watch?v=vNRics7tlqw
  [286]: https://web.archive.org/web/https://technitium.com/tmac/
  [287]: https://web.archive.org/web/https://www.veracrypt.fr/en/Downloads.html
  ...
  [288]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/turn-on-device-encryption-0c453637-bc88-5f74-5105-741561aae838
  [289]: https://web.archive.org/web/https://docs.microsoft.com/en-us/troubleshoot/windows-client/deployment/disable-and-re-enable-hibernation
  [290]: https://web.archive.org/web/https://www.veracrypt.fr/en/VeraCrypt%20Hidden%20Operating%20System.html
  [291]: https://web.archive.org/web/https://www.veracrypt.fr/en/Security%20Requirements%20for%20Hidden%20Volumes.html
  [292]: media/image22.jpeg
  [293]: https://web.archive.org/web/https://www.veracrypt.fr/en/Protection%20of%20Hidden%20Volumes.html
  [294]: https://web.archive.org/web/https://www.whonix.org/wiki/KVM
  [295]: https://web.archive.org/web/https://www.whonix.org/wiki/KVM#Why_Use_KVM_Over_VirtualBox.3F
  [296]: media/image23.jpeg 
  [297]: media/image24.jpeg 
  [298]: https://web.archive.org/web/https://gitlab.torproject.org/legacy/trac/-/wikis/org/doc/ListOfServicesBlockingTor
  [299]: media/image25.jpeg 
  [300]: media/image26.jpeg 
  [301]: https://web.archive.org/web/https://stakey.club/en/decred-via-tor-network/
  [302]: https://web.archive.org/web/https://www.whonix.org/wiki/Stream_Isolation
  [303]: https://web.archive.org/web/https://tails.boum.org/contribute/design/stream_isolation/
  [304]: https://web.archive.org/web/https://www.whonix.org/wiki/Tunnels/Introduction#Comparison_Table
  [305]: https://web.archive.org/web/https://www.whonix.org/wiki/Tunnels/Connecting_to_a_VPN_before_Tor
  [306]: https://web.archive.org/web/https://www.whonix.org/wiki/Comparison_Of_Tor_with_CGI_Proxies,_Proxy_Chains,_and_VPN_Services
  [307]: https://web.archive.org/web/https://www.whonix.org/wiki/Why_does_Whonix_use_Tor
  [308]: https://web.archive.org/web/https://www.researchgate.net/publication/324251041_Anonymity_communication_VPN_and_Tor_a_comparative_study
  [309]: https://web.archive.org/web/https://gist.github.com/joepie91/5a9909939e6ce7d09e29
  [310]: https://web.archive.org/web/https://schub.wtf/blog/2019/04/08/very-precarious-narrative.html
  [311]: https://web.archive.org/web/https://gitlab.torproject.org/legacy/trac/-/wikis/doc/TorPlusVPN
  [312]: https://web.archive.org/web/https://gitlab.tails.boum.org/tails/blueprints/-/wikis/vpn_support/
  [313]: https://web.archive.org/web/https://tails.boum.org/support/faq/index.en.html
  [314]: https://web.archive.org/web/https://www.whonix.org/wiki/Tunnels/Introduction
  [315]: https://web.archive.org/web/https://www.whonix.org/wiki/Tunnels/Connecting_to_Tor_before_a_VPN
  [316]: media/image27.jpeg 
  [317]: media/image28.jpeg 
  [318]: https://web.archive.org/web/https://www.virtualbox.org/wiki/Downloads
  [319]: https://web.archive.org/web/https://www.whonix.org/wiki/Download
  [320]: https://web.archive.org/web/https://www.whonix.org/wiki/Virtualization_Platform_Security
  [321]: https://web.archive.org/web/https://www.whonix.org/wiki/Network_Time_Synchronization
  [322]: https://web.archive.org/web/https://www.virtualbox.org/manual/ch13.html
  [323]: https://web.archive.org/web/https://www.whonix.org/wiki/Bridges
  [324]: https://web.archive.org/web/https://www.whonix.org/wiki/Operating_System_Software_and_Updates
  [325]: https://web.archive.org/web/https://www.whonix.org/wiki/DoNot
  [326]: https://web.archive.org/web/https://www.whonix.org/wiki/Documentation
  [327]: https://web.archive.org/web/https://www.whonix.org/wiki/Install_Software
  [328]: https://web.archive.org/web/https://www.whonix.org/wiki/Anti-Forensics_Precautions
  [Virtualbox Hardening recommendations]: #virtualbox-hardening-recommendations
  [329]: https://web.archive.org/web/https://www.whonix.org/wiki/AppArmor
  [330]: https://web.archive.org/web/https://www.whonix.org/wiki/VM_Fingerprinting
  [331]: https://web.archive.org/web/https://www.whonix.org/wiki/Other_Operating_Systems
  [Hardening Linux]: #hardening-linux
  [332]: https://web.archive.org/web/https://ameliorated.info/
  [333]: https://web.archive.org/web/https://brave.com/download/
  [334]: https://web.archive.org/web/https://www.android-x86.org/documentation/virtualbox.html
  [335]: https://web.archive.org/web/https://www.wikigain.com/install-macos-catalina-on-virtualbox-on-windows/
  [336]: https://web.archive.org/web/https://www.wikigain.com/how-to-install-macos-big-sur-on-virtualbox-on-windows-pc/
  [337]: https://web.archive.org/web/https://github.com/myspaghetti/macos-virtualbox
  [Hardening MacOS]: #hardening-macos
  [https://www.whonix.org/wiki/KeePassXC]: https://www.whonix.org/wiki/Keepassxc
  [338]: https://web.archive.org/web/https://www.whonix.org/wiki/Keepassxc
  [339]: https://web.archive.org/web/https://keepassxc.org/download/
  [340]: https://web.archive.org/web/https://keepassxc.org/docs/KeePassXC_GettingStarted.html
  ...
  [341]: media/image29.jpeg 
  [342]: media/image30.jpeg 
  [343]: media/image31.jpeg 
  [344]: https://web.archive.org/web/https://www.qubes-os.org/intro/
  [345]: https://web.archive.org/web/https://www.qubes-os.org/video-tours/
  [346]: https://web.archive.org/web/https://www.qubes-os.org/doc/getting-started/
  [347]: https://yewtu.be/watch?v=8cU4hQg6GvU
  [348]: https://yewtu.be/watch?v=sbN5Bz3v-uA
  [349]: https://yewtu.be/watch?v=YPAvoFsvSbg
  [350]: https://web.archive.org/web/https://www.qubes-os.org/hcl/
  [351]: media/image32.jpeg 
  [352]: media/image33.jpeg
  [353]: https://web.archive.org/web/https://www.qubes-os.org/doc/installation-guide/
  [354]: https://web.archive.org/web/https://www.qubes-os.org/faq/
  [355]: https://web.archive.org/web/https://github.com/Qubes-Community/Contents/blob/master/docs/privacy/anonymizing-your-mac-address.md
  [356]: https://web.archive.org/web/https://wiki.debian.org/AppArmor
  [357]: https://web.archive.org/web/https://wiki.archlinux.org/title/AppArmor
  [358]: https://web.archive.org/web/https://www.whonix.org/wiki/Qubes/AppArmor
  [359]: https://yewtu.be/watch?v=_WOKRaM-HI4
  [360]: https://web.archive.org/web/https://docs.fedoraproject.org/en-US/quick-docs/getting-started-with-selinux/
  [361]: https://web.archive.org/web/https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/vpn.md
  [362]: https://web.archive.org/web/https://check.torproject.org/
  [363]: https://web.archive.org/web/https://linuxconfig.org/how-to-create-a-vpn-killswitch-using-iptables-on-linux
  [364]: https://web.archive.org/web/https://mullvad.net/en/check/
  [365]: https://web.archive.org/web/https://www.ivpn.net/
  [366]: https://web.archive.org/web/https://protonvpn.com/support/vpn-ip-change/
  [367]: https://web.archive.org/web/https://www.whonix.org/wiki/Qubes/DisposableVM
  [368]: https://web.archive.org/web/https://brave.com/linux/
  [369]: https://web.archive.org/web/https://github.com/anbox/anbox-modules
  [370]: https://web.archive.org/web/https://github.com/anbox/anbox/blob/master/docs/install.md
  [371]: media/image34.jpeg
  [372]: https://web.archive.org/web/https://github.com/dessant/buster
  [373]: https://web.archive.org/web/https://www.hcaptcha.com/accessibility
  [374]: https://web.archive.org/web/https://privacypass.github.io/
  [375]: media/image35.jpeg
  [376]: media/image36.jpeg
  [377]: media/image37.jpeg
  [378]: https://web.archive.org/web/https://github.com/deepfakes/faceswap
  [Online Phone Number (less recommended)]: #online-phone-number-less-recommended
  [379]: https://web.archive.org/web/https://thispersondoesnotexist.com/
  [380]: https://web.archive.org/web/https://github.com/NVlabs/stylegan2
  [381]: https://web.archive.org/web/https://www.myheritage.com/deep-nostalgia
  [382]: media/image38.jpeg 
  [383]: https://web.archive.org/web/https://github.com/AliaksandrSiarohin/first-order-model
  [384]: https://web.archive.org/web/https://gendersec.tacticaltech.org/wiki/index.php/Complete_manual
  [385]: https://web.archive.org/web/https://www.bigdatacloud.com/insights/tor-exit-nodes
  [386]: https://web.archive.org/web/https://b3rn3d.herokuapp.com/blog/2014/03/05/tor-country-codes/
  [387]: https://wikiless.org/wiki/Facebook_real-name_policy_controversy
  [388]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Facebook_real-name_policy_controversy
  [389]: https://web.archive.org/web/https://slate.com/technology/2018/02/why-some-americans-are-cheering-germany-for-taking-on-facebooks-real-name-policy.html
  [390]: https://web.archive.org/web/https://www.theverge.com/2018/2/12/17005746/facebook-real-name-policy-illegal-german-court-rules
  [391]: https://web.archive.org/web/https://www.pcmag.com/news/german-court-rules-facebooks-real-name-policy-is-illegal
  [392]: https://web.archive.org/web/https://www.vzbv.de/sites/default/files/downloads/2018/02/14/18-02-12_vzbv_pm_facebook-urteil_en.pdf
  [393]: https://web.archive.org/web/https://www.reuters.com/article/us-germany-facebook/german-court-rules-facebook-use-of-personal-data-illegal-idUSKBN1FW1FI
  [394]: https://wikiless.org/wiki/Real-name_system
  [395]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Real-name_system
  [396]: https://web.archive.org/web/https://privacytools.io/
  [397]: https://web.archive.org/web/https://www.whonix.org/wiki/E-Mail#Anonymity_Friendly_Email_Provider_List
  [398]: https://web.archive.org/web/https://www.amazon.com/gp/help/customer/display.html?nodeId=202140280
  [399]: https://web.archive.org/web/https://www.apple.com/legal/internet-services/icloud/en/terms.html
  [400]: https://web.archive.org/web/https://briarproject.org/privacy-policy/
  [401]: https://web.archive.org/web/https://discord.com/terms
  [402]: https://web.archive.org/web/https://element.io/terms-of-service
  [403]: https://web.archive.org/web/https://www.facebook.com/terms.php
  [404]: https://web.archive.org/web/https://docs.github.com/en/free-pro-team@latest/github/site-policy/github-terms-of-service
  [405]: https://web.archive.org/web/https://about.gitlab.com/handbook/legal/subscription-agreement/
  [406]: https://web.archive.org/web/https://policies.google.com/terms
  [407]: https://web.archive.org/web/https://www.ycombinator.com/legal/
  [408]: https://web.archive.org/web/https://help.instagram.com/581066165581870?ref=dp
  [409]: https://web.archive.org/web/https://jami.net/privacy-policy/
  [410]: https://web.archive.org/web/https://www.ivpn.net/tos/
  [411]: https://web.archive.org/web/https://www.linkedin.com/legal/user-agreement
  [412]: https://web.archive.org/web/https://policy.medium.com/medium-terms-of-service-9db0094a1e0f
  [413]: https://web.archive.org/web/https://www.microsoft.com/en/servicesagreement/
  [414]: https://web.archive.org/web/https://mullvad.net/en/help/terms-service/
  [415]: https://web.archive.org/web/https://njal.la/tos/
  [416]: https://web.archive.org/web/https://protonmail.com/terms-and-conditions
  [417]: https://web.archive.org/web/https://protonvpn.com/terms-and-conditions
  [418]: https://web.archive.org/web/https://www.redditinc.com/policies
  [419]: https://web.archive.org/web/https://slashdotmedia.com/terms-of-use/
  [420]: https://web.archive.org/web/https://telegram.org/tos
  [421]: https://web.archive.org/web/mailto:recover@telegram.org
  [422]: https://web.archive.org/web/https://tutanota.com/terms/
  [423]: https://web.archive.org/web/https://www.twitch.tv/p/en/legal/terms-of-service/
  [424]: https://web.archive.org/web/https://www.whatsapp.com/legal/updates/terms-of-service-eea
  [425]: media/image39.jpeg
  [426]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2018/08/23/creating-android-open-source-research-device-pc/
  [427]: https://yewtu.be/watch?v=zSQtyW_ywZc
  [428]: https://wikiless.org/wiki/Comparison_of_instant_messaging_protocols
  [429]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Comparison_of_instant_messaging_protocols
  [430]: https://wikiless.org/wiki/Comparison_of_cross-platform_instant_messaging_clients
  [431]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Comparison_of_cross-platform_instant_messaging_clients
  [432]: https://web.archive.org/web/https://www.securemessagingapps.com/
  [433]: https://web.archive.org/web/https://protonmail.com/blog/whatsapp-alternatives/
  [434]: https://web.archive.org/web/https://www.whonix.org/wiki/Chat
  [435]: https://web.archive.org/web/https://briarproject.org/
  [436]: https://web.archive.org/web/https://onionshare.org/
  [437]: https://web.archive.org/web/https://jami.net/
  [438]: https://web.archive.org/web/https://element.io/
  [439]: https://web.archive.org/web/https://securedrop.org/
  [440]: https://web.archive.org/web/https://github.com/alecmuffett/real-world-onion-sites
  [441]: https://web.archive.org/web/https://haveibeenpwned.com/
  [442]: https://web.archive.org/web/https://www.veracrypt.fr/en/Beginner%27s%20Tutorial.html
  [443]: https://web.archive.org/web/https://www.qubes-os.org/doc/backup-restore/
  [444]: https://web.archive.org/web/https://support.apple.com/en-ie/guide/mac-help/mh21241/mac
  [445]: https://web.archive.org/web/https://support.apple.com/en-ie/guide/mac-help/mh11421/11.0/mac/11.0
  [446]: https://web.archive.org/web/https://support.apple.com/en-ie/guide/disk-utility/dskutl1010/mac
  [447]: https://web.archive.org/web/https://privacytools.io/providers/cloud-storage/
  [448]: https://web.archive.org/web/https://privacytools.io/providers/paste/
  [449]: https://web.archive.org/web/https://syncthing.net/
  [450]: media/image40.jpeg
  [451]: media/image41.jpeg
  [452]: media/image42.jpeg
  [453]: https://wikiless.org/wiki/Trim_(computing)
  [454]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trim_(computing)
  [455]: media/image43.jpeg
  [456]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/Solid_state_drive
  [457]: https://web.archive.org/web/https://www.bleachbit.org/download/linux
  [458]: https://web.archive.org/web/https://superuser.com/questions/19326/how-to-wipe-free-disk-space-in-linux
  [459]: https://web.archive.org/web/https://linuxhint.com/completely_wipe_hard_drive_ubuntu/
  [460]: https://web.archive.org/web/https://linoxide.com/linux-command/commands-wipe-disk-linux/
  [461]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/Securely_wipe_disk
  [462]: https://web.archive.org/web/https://ssd.eff.org/en/module/how-delete-your-data-securely-linux
  [Extra Tools Cleaning]: #extra-tools-cleaning
  [463]: https://web.archive.org/web/https://eraser.heidi.ie/download/
  [464]: https://web.archive.org/web/http://killdisk.com/killdisk-freeware.htm
  [465]: https://web.archive.org/web/https://support.apple.com/en-gb/guide/disk-utility/dskutl14079/mac
  [466]: https://web.archive.org/web/https://support.apple.com/guide/disk-utility/erase-and-reformat-a-storage-device-dskutl14079/mac
  [467]: https://web.archive.org/web/https://support.apple.com/guide/disk-utility/encrypt-protect-a-storage-device-password-dskutl35612/mac
  [468]: media/image44.jpeg
  [469]: https://web.archive.org/web/https://ssd.eff.org/en/module/how-delete-your-data-securely-windows
  [470]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption
  [471]: https://web.archive.org/web/https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md
  [472]: https://web.archive.org/web/https://support.apple.com/en-us/HT210898
  [473]: media/image45.jpeg
  [474]: https://web.archive.org/web/http://www.edenwaith.com/products/permanent%20eraser/
  [475]: https://web.archive.org/web/https://ssd.eff.org/en/module/how-delete-your-data-securely-macos
  [476]: https://web.archive.org/web/https://www.whonix.org/wiki/System_Hardening_Checklist
  [477]: https://web.archive.org/web/https://exiftool.org/
  [478]: https://web.archive.org/web/https://exifcleaner.com/
  [479]: https://web.archive.org/web/https://www.purevpn.com/internet-privacy/how-to-remove-metadata-from-photos
  [480]: https://web.archive.org/web/https://sandlab.cs.uchicago.edu/fawkes/
  [481]: https://web.archive.org/web/https://github.com/Shawn-Shan/fawkes
  [482]: https://web.archive.org/web/https://lowkey.umiacs.umd.edu/
  [483]: https://web.archive.org/web/https://adversarial.io/
  [484]: https://web.archive.org/web/https://github.com/kanzure/pdfparanoia
  [485]: https://web.archive.org/web/https://support.microsoft.com/en-us/office/remove-hidden-data-and-personal-information-by-inspecting-documents-presentations-or-workbooks-356b7b5d-77af-44fe-a07f-9aa4d085966f
  [486]: https://web.archive.org/web/https://0xacab.org/jvoisin/mat2
  [487]: media/image46.jpeg 
  [488]: https://web.archive.org/web/https://www.whonix.org/wiki/VM_Live_Mode
  [489]: https://web.archive.org/web/https://www.titanium-software.fr/en/onyx.html
  [490]: https://web.archive.org/web/https://github.com/Qubes-Community/Contents/blob/master/docs/security/security-guidelines.md
  [491]: https://web.archive.org/web/https://www.whonix.org/wiki/Linux_Kernel_Runtime_Guard_LKRG
  [492]: https://web.archive.org/web/https://github.com/sundowndev/go-covermyass
  [493]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/how-to-open-registry-editor-in-windows-10-deab38e6-91d6-e0aa-4b7c-8878d9e07b11
  [494]: https://web.archive.org/web/https://privazer.com/en/download-shellbag-analyzer-shellbag-cleaner.php
  [495]: https://web.archive.org/web/https://privazer.com/en/download.php
  [496]: https://web.archive.org/web/https://www.bleachbit.org/download
  [497]: https://web.archive.org/web/https://justdeleteme.xyz/
  [498]: https://web.archive.org/web/https://justgetmydata.com/
  [499]: https://web.archive.org/web/https://search.google.com/search-console/remove-outdated-content
  [500]: https://web.archive.org/web/https://www.bing.com/webmasters/tools/contentremoval
  [501]: https://web.archive.org/web/https://webmaster.yandex.com/
  [502]: https://web.archive.org/web/https://webmaster.yandex.com/tools/del-url/
  [503]: https://web.archive.org/web/https://help.yahoo.com/kb/SLN4530.html
  [504]: https://wikiless.org/wiki/Wikipedia:Courtesy_vanishing
  [505]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wikipedia:Courtesy_vanishing
  [506]: https://web.archive.org/web/https://guardianproject.github.io/haven/
  [507]: https://web.archive.org/web/https://www.google.com/alerts
  [508]: https://wikiless.org/wiki/Ross_Ulbricht
  [509]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Ross_Ulbricht
  [510]: https://yewtu.be/watch?v=d-7o9xYp7eE
  [511]: https://yewtu.be/watch?v=IqZZU9lFlF4
  [512]: https://yewtu.be/watch?v=zXmZnU2GdVk
  [513]: https://yewtu.be/watch?v=eQ2OZKitRwc
  ...
  [514]: https://web.archive.org/web/https://www.defcon.org/images/defcon-22/dc-22-presentations/Crenshaw/DEFCON-22-Adrian-Crenshaw-Dropping-Docs-on-Darknets-How-People-Got-Caught-UPDATED.pdf
  [515]: https://yewtu.be/watch?v=6Chp12sEnWk
  [516]: https://yewtu.be/watch?v=J1q4Ir2J8P8
  [517]: https://yewtu.be/watch?v=GR_U0G-QGA0
  [518]: https://wikiless.org/wiki/Key_disclosure_law
  [519]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Key_disclosure_law
  [520]: https://web.archive.org/web/https://www.gp-digital.org/world-map-of-encryption/
  [521]: https://mirror.anonymousplanet.org/donations.html
  [522]: https://web.archive.org/web/https://anonymousplanet.org/donations.html
  [523]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/donations.html
  [524]: media/image47.jpeg 
  [525]: media/image48.jpeg 
  [526]: media/image49.jpeg 
  [527]: https://web.archive.org/web/https://snowflake.torproject.org/
  [528]: https://web.archive.org/web/https://community.torproject.org/relay/
  [Recommended VPS hosting providers]: #_Recommended_VPS_hosting
  [529]: https://web.archive.org/web/https://torrelay.ca/
  [530]: https://web.archive.org/web/https://blog.torproject.org/tips-running-exit-node
  [531]: https://web.archive.org/web/https://metrics.torproject.org/rs.html#details/970814F267BF3DE9DFF2A0F8D4019F80C68AEE26
  [532]: https://wikiless.org/wiki/Permanent_Record_(autobiography)
  [533]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Permanent_Record_(autobiography)
  [534]: https://web.archive.org/web/https://www.w10privacy.de/english-home/
  [535]: https://web.archive.org/web/https://crazymax.dev/WindowsSpyBlocker/download/
  [536]: https://web.archive.org/web/https://www.microsoft.com/en-us/software-download/windows10
  [537]: https://web.archive.org/web/https://www.system-rescue.org/Installing-SystemRescue-on-a-USB-memory-stick/
  [538]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/Solid_state_drive/Memory_cell_clearing
  [539]: https://web.archive.org/web/https://ata.wiki.kernel.org/index.php/ATA_Secure_Erase
  [540]: https://web.archive.org/web/https://tinyapps.org/docs/wipe_drives_hdparm.html
  [541]: https://web.archive.org/web/https://tinyapps.org/docs/ata_sanitize_hdparm.html
  [542]: https://web.archive.org/web/https://tinyapps.org/docs/nvme-secure-erase.html
  [543]: https://web.archive.org/web/https://tinyapps.org/docs/nvme-sanitize.html
  [544]: https://web.archive.org/web/https://clonezilla.org/liveusb.php
  [545]: https://web.archive.org/web/https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/01_Save_disk_image
  [546]: https://web.archive.org/web/https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/02_Restore_disk_image
  [547]: https://web.archive.org/web/https://www.torproject.org/download/
  [548]: https://web.archive.org/web/https://tb-manual.torproject.org/security-settings/
  [549]: https://web.archive.org/web/https://bridges.torproject.org/
  [550]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/disk-cleanup-in-windows-10-8a96ff42-5751-39ad-23d6-434b4d5b9a68
  [551]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/defragment-your-windows-10-pc-048aefac-7f1f-4632-d48a-9700c4ec702a
  [552]: https://web.archive.org/web/https://www.bleachbit.org/
  [553]: https://web.archive.org/web/https://privazer.com/
  [554]: https://web.archive.org/web/https://www.system-rescue.org/
  [555]: https://web.archive.org/web/https://www.lifewire.com/how-to-erase-a-hard-drive-using-dban-2619148
  [556]: https://web.archive.org/web/https://github.com/PartialVolume/shredos.2020.02
  [557]: https://web.archive.org/web/https://rufus.ie/
  [558]: https://web.archive.org/web/https://kb.sandisk.com/app/answers/detail/a_id/15108/~/dashboard-support-information
  [559]: https://web.archive.org/web/https://www.seagate.com/support/downloads/seatools/
  [560]: https://web.archive.org/web/https://www.samsung.com/semiconductor/minisite/ssd/download/tools/
  [561]: https://web.archive.org/web/https://www.kingston.com/unitedstates/en/support/technical/ssdmanager
  [562]: https://web.archive.org/web/https://support.lenovo.com/us/en/downloads/ds019026-thinkpad-drive-erase-utility-for-resetting-the-cryptographic-key-and-erasing-the-solid-state-drive-thinkpad
  [563]: https://web.archive.org/web/https://www.crucial.com/support/storage-executive
  [564]: https://web.archive.org/web/https://support.wdc.com/downloads.aspx?p=279
  [565]: https://web.archive.org/web/https://store.hp.com/us/en/tech-takes/how-to-secure-erase-ssd
  [566]: https://web.archive.org/web/https://www.transcend-info.com/Support/Software-10/
  [567]: https://web.archive.org/web/https://www.dell.com/support/kbdoc/en-us/000134997/using-the-dell-bios-data-wipe-function-for-optiplex-precision-and-latitude-systems-built-after-november-2015?lwp=rt
  [568]: https://web.archive.org/web/https://www.toshiba-storage.com/downloads/
  [569]: https://web.archive.org/web/https://www.glump.net/howto/desktop/enable-trim-on-an-external-ssd-on-linux
  [570]: https://web.archive.org/web/https://code.mendhak.com/securely-wipe-ssd/
  [571]: https://web.archive.org/web/https://www.lifewire.com/enable-trim-for-ssd-in-os-x-yosemite-2260789
  [572]: https://web.archive.org/web/https://cindori.org/trimenabler/
  [573]: https://web.archive.org/web/https://www.debian.org/CD/netinst/
  [574]: https://web.archive.org/web/https://support.lenovo.com/be/en/solutions/migr-68369
  [575]: https://web.archive.org/web/https://support.hp.com/gb-en/document/c06204100
  [576]: https://web.archive.org/web/https://www.dell.com/support/kbdoc/en-us/000146892/dell-data-wipe
  [577]: https://web.archive.org/web/https://us.answers.acer.com/app/answers/detail/a_id/41567/~/how-to-use-disk-sanitizer-on-acer-travelmate-notebooks
  [578]: https://wikiless.org/wiki/EncroChat
  [579]: https://web.archive.org/web/https://en.wikipedia.org/wiki/EncroChat
  [580]: https://wikiless.org/wiki/Sky_ECC
  [581]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sky_ECC
  [582]: https://web.archive.org/web/https://privacytools.io/providers/vpn/
  [Printing Watermarking]: #printing-watermarking
  [583]: https://web.archive.org/web/https://www.getmonero.org/community/merchants/
  [584]: https://web.archive.org/web/https://proprivacy.com/vpn/guides/create-your-own-vpn-server
  [585]: https://web.archive.org/web/https://linuxize.com/post/how-to-setup-ssh-socks-tunnel-for-private-browsing/
  [586]: https://web.archive.org/web/https://www.digitalocean.com/community/tutorials/how-to-route-web-traffic-securely-without-a-vpn-using-a-socks-tunnel
  [587]: https://web.archive.org/web/https://www.forwardproxy.com/2018/12/using-putty-to-setup-a-quick-socks-proxy/
  [588]: https://web.archive.org/web/https://ma.ttias.be/socks-proxy-linux-ssh-bypass-content-filters/
  [589]: https://web.archive.org/web/https://www.putty.org/
  [590]: media/image50.jpeg 
  [591]: https://web.archive.org/web/https://tails.boum.org/contribute/design/Unsafe_Browser/
  [592]: https://web.archive.org/web/https://archive.flossmanuals.net/bypassing-censorship/index.html
  [593]: media/image51.jpeg 
  [594]: https://web.archive.org/web/https://www.alfa.com.tw/
  [595]: https://web.archive.org/web/https://www.tp-link.com/us/home-networking/usb-adapter/tl-wn722n/
  [596]: https://web.archive.org/web/https://www.wirelesshack.org/best-kali-linux-compatible-usb-adapter-dongles.html
  [597]: https://yewtu.be/watch?v=8FV2QZ1BPnw
  [598]: https://web.archive.org/web/https://www.netally.com/products/
  [599]: https://web.archive.org/web/https://mullvad.net/en/help/install-mullvad-app-windows/
  [600]: https://web.archive.org/web/https://www.ivpn.net/apps-windows
  [601]: https://web.archive.org/web/https://protonvpn.com/support/protonvpn-windows-vpn-application/
  [602]: https://web.archive.org/web/https://mullvad.net/en/help/install-and-use-mullvad-app-macos/
  [603]: https://web.archive.org/web/https://www.ivpn.net/apps-macos/
  [604]: https://web.archive.org/web/https://protonvpn.com/support/protonvpn-mac-vpn-application/
  [605]: https://web.archive.org/web/https://mullvad.net/en/help/install-mullvad-app-linux/
  [606]: https://web.archive.org/web/https://www.ivpn.net/apps-linux/
  [607]: https://web.archive.org/web/https://protonvpn.com/support/linux-vpn-setup/
  [608]: https://web.archive.org/web/https://www.ivpn.net/knowledgebase/general/do-you-offer-a-kill-switch-or-vpn-firewall/
  [609]: https://web.archive.org/web/https://protonvpn.com/support/what-is-kill-switch/
  [610]: https://web.archive.org/web/https://mullvad.net/en/help/using-mullvad-vpn-app/
  [611]: https://web.archive.org/web/https://protonvpn.com/blog/macos-vpn-kill-switch/
  [612]: https://web.archive.org/web/https://mullvad.net/en/help/wireguard-and-mullvad-vpn/
  [613]: https://web.archive.org/web/https://mullvad.net/en/help/linux-openvpn-installation/
  [614]: https://web.archive.org/web/https://github.com/ProtonVPN/linux-cli/blob/master/USAGE.md
  [615]: https://web.archive.org/web/https://www.ivpn.net/knowledgebase/linux/linux-wireguard-kill-switch/
  [616]: https://web.archive.org/web/https://www.ivpn.net/knowledgebase/linux/linux-kill-switch-using-the-uncomplicated-firewall-ufw/
  [617]: https://web.archive.org/web/https://ooni.org/install/
  [618]: https://web.archive.org/web/https://www.gpg4win.org/
  [619]: https://web.archive.org/web/https://gpgtools.org/
  [620]: https://web.archive.org/web/https://support.torproject.org/tbb/how-to-verify-signature/
  [621]: https://web.archive.org/web/https://tails.boum.org/install/vm-download/index.en.html
  [622]: https://web.archive.org/web/https://www.whonix.org/wiki/Verify_the_Whonix_images
  [623]: https://web.archive.org/web/https://www.clamav.net/
  [624]: https://web.archive.org/web/https://github.com/rfxn/linux-malware-detect
  [625]: https://web.archive.org/web/http://www.chkrootkit.org/
  [626]: https://web.archive.org/web/https://developers.virustotal.com/v3.0/docs/search-by-hash
  [627]: https://web.archive.org/web/https://github.com/rshipp/awesome-malware-analysis
  [628]: https://web.archive.org/web/https://support.virustotal.com/hc/en-us/articles/115002168385-Privacy-Policy
  [629]: https://web.archive.org/web/https://blog.didierstevens.com/programs/pdf-tools/
  [630]: https://web.archive.org/web/https://github.com/QubesOS/qubes-app-linux-pdf-converter
  [631]: https://web.archive.org/web/https://github.com/firstlookmedia/pdf-redact-tools
  [632]: https://web.archive.org/web/https://github.com/firstlookmedia/dangerzone
  [633]: https://web.archive.org/web/https://digital-forensics.sans.org/media/analyzing-malicious-document-files.pdf
  [634]: https://web.archive.org/web/https://www.winitor.com/pdf/Malware-Analysis-Fundamentals-Files-Tools.pdf
  [635]: media/image52.jpeg 
  [636]: media/image53.jpeg 
  [637]: https://yewtu.be/watch?v=nwkiU6GG-YU
  [638]: https://web.archive.org/web/https://telegra.ph/AME-Download-Guide-09-07
  [639]: https://web.archive.org/web/https://wiki.ameliorated.info/doku.php?id=documentation_20H2
  [640]: https://web.archive.org/web/https://wasabiwallet.io/
  [641]: https://web.archive.org/web/https://njal.la/
  [642]: https://web.archive.org/web/https://privacytools.io/providers/hosting/
  [643]: https://web.archive.org/web/https://www.1984.is/
  [644]: https://web.archive.org/web/https://community.torproject.org/relay/community-resources/good-bad-isps/
  [**https://www.youtube.com/watch?v=j02QoI4ZlnU**]: https://www.youtube.com/watch?v=j02QoI4ZlnU
  [645]: https://yewtu.be/watch?v=j02QoI4ZlnU
  [646]: https://web.archive.org/web/https://github.com/monero-project/monero/blob/master/docs/ANONYMITY_NETWORKS.md#privacy-limitations
  [647]: https://web.archive.org/web/https://www.huntonprivacyblog.com/wp-content/uploads/sites/28/2016/02/Telemedia_Act__TMA_.pdf
  [648]: https://wikiless.org/wiki/Don%27t_be_evil
  [649]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Don%27t_be_evil
  [650]: https://yewtu.be/watch?v=6DGNZnfKYnU
  [651]: https://wikiless.org/wiki/Open-source_intelligence
  [652]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Open-source_intelligence
  [653]: https://yewtu.be/playlist?list=PLna1KTNJu3y09Tu70U6yPn28sekaNhOMY
  [654]: https://wikiless.org/wiki/4chan
  [655]: https://web.archive.org/web/https://en.wikipedia.org/wiki/4chan
  [656]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/how-does-privacy-differ-from-anonymity-and-why-are-both-important/
  [657]: https://web.archive.org/web/https://scholar.harvard.edu/files/mickens/files/thisworldofours.pdf
  [658]: https://web.archive.org/web/https://xkcd.com/538/
  [659]: https://wikiless.org/wiki/Threat_model
  [660]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Threat_model
  [661]: https://web.archive.org/web/https://www.bellingcat.com/
  [662]: https://wikiless.org/wiki/Doxing
  [663]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Doxing
  [664]: https://yewtu.be/watch?v=muoR8Td44UE
  [665]: https://web.archive.org/web/https://www.bbc.com/news/technology-50150981
  [666]: https://web.archive.org/web/https://2019.www.torproject.org/about/torusers.html.en
  [667]: https://web.archive.org/web/https://www.whonix.org/wiki/Anonymity
  [668]: https://web.archive.org/web/https://geekfeminism.wikia.org/wiki/Who_is_harmed_by_a_%22Real_Names%22_policy%3F
  [669]: https://web.archive.org/web/https://www.cyberghostvpn.com/privacyhub/internet-privacy-surveillance/
  [670]: https://wikiless.org/wiki/IANAL
  [671]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IANAL
  [672]: https://wikiless.org/wiki/Trust,_but_verify
  [673]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trust,_but_verify
  [674]: https://wikiless.org/wiki/IP_address
  [675]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IP_address
  [676]: https://wikiless.org/wiki/Data_retention
  [677]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Data_retention
  [678]: https://wikiless.org/wiki/Tor_(anonymity_network)
  [679]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tor_(anonymity_network)
  [680]: https://wikiless.org/wiki/Virtual_private_network
  [681]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtual_private_network
  [682]: https://wikiless.org/wiki/Domain_Name_System
  [683]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Domain_Name_System
  [684]: https://wikiless.org/wiki/DNS_blocking
  [685]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_blocking
  [686]: https://web.archive.org/web/https://arxiv.org/pdf/2001.08288.pdf
  [687]: https://web.archive.org/web/https://labzilla.io/blog/force-dns-pihole
  [688]: https://wikiless.org/wiki/DNS_over_HTTPS
  [689]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_over_HTTPS
  [690]: https://wikiless.org/wiki/DNS_over_TLS
  [691]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_over_TLS
  [692]: https://wikiless.org/wiki/Pi-hole
  [693]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Pi-hole
  [694]: https://wikiless.org/wiki/Server_Name_Indication
  [695]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Server_Name_Indication
  [696]: https://web.archive.org/web/https://www.usenix.org/system/files/foci19-paper_chai_0.pdf
  [697]: https://wikiless.org/wiki/Content_delivery_network
  [698]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Content_delivery_network
  [699]: https://web.archive.org/web/https://blog.cloudflare.com/encrypted-client-hello/
  [700]: https://web.archive.org/web/https://www.zdnet.com/article/russia-wants-to-ban-the-use-of-secure-protocols-such-as-tls-1-3-doh-dot-esni/
  [701]: https://web.archive.org/web/https://www.zdnet.com/article/china-is-now-blocking-all-encrypted-https-traffic-using-tls-1-3-and-esni/
  [702]: https://wikiless.org/wiki/Online_Certificate_Status_Protocol
  [703]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Online_Certificate_Status_Protocol
  [704]: https://web.archive.org/web/https://madaidans-insecurities.github.io/encrypted-dns.html
  [705]: https://wikiless.org/wiki/OCSP_stapling
  [706]: https://web.archive.org/web/https://en.wikipedia.org/wiki/OCSP_stapling
  [707]: https://web.archive.org/web/https://dev.chromium.org/Home/chromium-security/crlsets
  [708]: https://web.archive.org/web/https://www.zdnet.com/article/chrome-does-certificate-revocation-better/
  [709]: https://web.archive.org/web/https://www.esat.kuleuven.be/cosic/publications/article-3153.pdf
  [710]: https://web.archive.org/web/https://www.researchgate.net/publication/332893422_Oblivious_DNS_Practical_Privacy_for_DNS_Queries
  [711]: https://web.archive.org/web/https://nymity.ch/tor-dns/
  [712]: https://wikiless.org/wiki/Near-field_communication
  [713]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Near-field_communication
  [714]: https://web.archive.org/web/https://shop.samsonite.com/accessories/rfid-accessories/
  [715]: https://web.archive.org/web/https://support.google.com/accounts/answer/3467281?hl=en
  [716]: https://web.archive.org/web/https://support.apple.com/en-us/HT207056
  [717]: https://web.archive.org/web/https://cse.buffalo.edu/~lusu/papers/MobiCom2020.pdf
  [718]: https://web.archive.org/web/https://digi.ninja/jasager/
  [719]: https://web.archive.org/web/https://shop.hak5.org/products/wifi-pineapple
  [720]: https://wikiless.org/wiki/Wi-Fi_deauthentication_attack
  [721]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wi-Fi_deauthentication_attack
  [722]: https://wikiless.org/wiki/Captive_portal
  [723]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Captive_portal
  [724]: https://web.archive.org/web/https://www.hackerfactor.com/blog/index.php?/archives/868-Deanonymizing-Tor-Circuits.html
  [725]: https://web.archive.org/web/https://distrinet.cs.kuleuven.be/software/tor-wf-dl/
  [726]: https://web.archive.org/web/https://www.dailydot.com/unclick/tor-harvard-bomb-suspect/
  [727]: https://web.archive.org/web/https://arstechnica.com/information-technology/2015/10/how-the-nsa-can-break-trillions-of-encrypted-web-and-vpn-connections/
  [728]: https://web.archive.org/web/https://arstechnica.com/gadgets/2020/11/does-tor-provide-more-benefit-or-harm-new-paper-says-it-depends/
  [729]: https://web.archive.org/web/https://www.pnas.org/content/early/2020/11/24/2011893117
  [730]: https://web.archive.org/web/https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/
  [731]: https://web.archive.org/web/https://support.apple.com/en-us/HT210515
  [732]: https://web.archive.org/web/https://www.xda-developers.com/samsung-find-my-mobile-app-locate-galaxy-devices-offline/
  [733]: https://web.archive.org/web/https://support.apple.com/en-us/HT204756
  [734]: https://wikiless.org/wiki/Bluetooth_Low_Energy
  [735]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Bluetooth_Low_Energy
  [736]: https://wikiless.org/wiki/International_Mobile_Equipment_Identity
  [737]: https://web.archive.org/web/https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity
  [738]: https://wikiless.org/wiki/International_mobile_subscriber_identity
  [739]: https://web.archive.org/web/https://en.wikipedia.org/wiki/International_mobile_subscriber_identity
  [740]: https://web.archive.org/web/https://source.android.com/devices/tech/config/device-identifiers
  [741]: https://web.archive.org/web/https://policies.google.com/privacy/embedded?hl=en-US
  [742]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2019/06/28/the-gru-globetrotters-mission-london/
  [743]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2020/02/17/v-like-vympel-fsbs-secretive-department-v-behind-assassination-of-zelimkhan-khangoshvili/
  [744]: https://wikiless.org/wiki/Closed-circuit_television
  [745]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Closed-circuit_television
  [746]: https://web.archive.org/web/https://www.apple.com/legal/transparency/device-requests.html
  [747]: https://web.archive.org/web/https://theintercept.com/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/
  [748]: https://wikiless.org/wiki/IMSI-catcher
  [749]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IMSI-catcher
  [750]: https://wikiless.org/wiki/Stingray_phone_tracker
  [751]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stingray_phone_tracker
  [752]: https://web.archive.org/web/https://gizmodo.com/american-cops-turns-to-canadian-phone-tracking-firm-aft-1845442778
  [753]: https://wikiless.org/wiki/Man-in-the-middle_attack
  [754]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Man-in-the-middle_attack
  [755]: https://web.archive.org/web/https://shop.puri.sm/shop/librem-5/
  [756]: https://wikiless.org/wiki/MAC_address
  [757]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MAC_address
  [758]: https://web.archive.org/web/https://amsignalinc.com/data-sheets/Acyclica/Acyclica-RoadTrend-Product-Sheet.pdf
  [759]: https://web.archive.org/web/https://www.researchgate.net/publication/334590931_Tracking_Anonymized_Bluetooth_Devices/fulltext/5d3308db92851cd04675a469/Tracking-Anonymized-Bluetooth-Devices.pdf
  [760]: https://wikiless.org/wiki/Central_processing_unit
  [761]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Central_processing_unit
  [762]: https://wikiless.org/wiki/Intel_Management_Engine
  [763]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Intel_Management_Engine
  [764]: https://wikiless.org/wiki/AMD_Platform_Security_Processor
  [765]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AMD_Platform_Security_Processor
  [766]: https://web.archive.org/web/https://libreboot.org/
  [767]: https://web.archive.org/web/https://www.apple.com/privacy/docs/Differential_Privacy_Overview.pdf
  [768]: https://wikiless.org/wiki/Differential_privacy
  [769]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Differential_privacy
  [770]: https://web.archive.org/web/https://www.reuters.com/article/us-apple-fbi-icloud-exclusive-idUSKBN1ZK1CT
  [771]: https://web.archive.org/web/https://www.zdnet.com/article/apple-data-collection-stored-request/
  [772]: https://web.archive.org/web/https://decorrespondent.nl/8481/heres-how-we-found-the-names-and-addresses-of-soldiers-and-secret-agents-using-a-simple-fitness-app/412999257-6756ba27
  [773]: https://web.archive.org/web/https://www.wired.com/story/strava-heat-map-military-bases-fitness-trackers-privacy/
  [774]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2018/01/29/strava-interpretation-guide/
  [775]: https://web.archive.org/web/https://www.theguardian.com/world/2018/jan/28/fitness-tracking-app-gives-away-location-of-secret-us-army-bases
  [776]: https://web.archive.org/web/https://www.telegraph.co.uk/technology/2018/07/08/running-app-exposes-mi6-gchq-workers-whereabouts/
  [777]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2019/05/06/alexa-has-been-eavesdropping-you-this-whole-time/?itid=lk_interstitial_manual_59
  [778]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2019/12/17/what-does-your-car-know-about-you-we-hacked-chevy-find-out/
  [779]: https://web.archive.org/web/https://kieranhealy.org/blog/archives/2013/06/09/using-metadata-to-find-paul-revere/
  [780]: https://wikiless.org/wiki/Sensorvault
  [781]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sensorvault
  [782]: https://web.archive.org/web/https://nrkbeta.no/2020/12/03/my-phone-was-spying-on-me-so-i-tracked-down-the-surveillants/
  [783]: https://web.archive.org/web/https://www.nytimes.com/interactive/2019/12/19/opinion/location-tracking-cell-phone.html
  [784]: https://web.archive.org/web/https://nakedsecurity.sophos.com/2020/03/10/google-data-puts-innocent-man-at-the-scene-of-a-crime/
  [785]: https://wikiless.org/wiki/Geo-fence_warrant
  [786]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Geo-fence_warrant
  [787]: https://web.archive.org/web/https://www.vice.com/en/article/y3g97x/location-data-apps-drone-strikes-iowa-national-guard
  [788]: https://wikiless.org/wiki/Room_641A
  [789]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Room_641A
  [790]: https://wikiless.org/wiki/Edward_Snowden
  [791]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Edward_Snowden
  [792]: https://wikiless.org/wiki/XKeyscore
  [793]: https://web.archive.org/web/https://en.wikipedia.org/wiki/XKeyscore
  [794]: https://web.archive.org/web/https://www.electrospaces.net/2020/10/danish-military-intelligence-uses.html
  [795]: https://web.archive.org/web/https://en.m.wikipedia.org/wiki/MUSCULAR_(surveillance_program)
  [796]: https://wikiless.org/wiki/SORM
  [797]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SORM
  [798]: https://wikiless.org/wiki/Tempora
  [799]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tempora
  [800]: https://wikiless.org/wiki/PRISM_(surveillance_program)
  [801]: https://web.archive.org/web/https://en.wikipedia.org/wiki/PRISM_(surveillance_program)
  [802]: https://web.archive.org/web/https://www.justsecurity.org/10318/video-clip-director-nsa-cia-we-kill-people-based-metadata/
  [803]: https://web.archive.org/web/https://www.imdb.com/title/tt11464826/
  [804]: https://web.archive.org/web/https://arstechnica.com/information-technology/2015/07/how-the-way-you-type-can-shatter-anonymity-even-on-tor/
  [805]: https://wikiless.org/wiki/Stylometry
  [806]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stylometry
  [807]: https://web.archive.org/web/https://paul.reviews/behavioral-profiling-the-password-you-cant-change/
  [808]: https://wikiless.org/wiki/Sentiment_analysis
  [809]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sentiment_analysis
  [810]: https://web.archive.org/web/https://coveryourtracks.eff.org/
  [811]: https://web.archive.org/web/https://people.eecs.berkeley.edu/~dawnsong/papers/2012%20On%20the%20Feasibility%20of%20Internet-Scale%20Author%20Identification.pdf
  [812]: https://web.archive.org/web/https://blog.securedtouch.com/behavioral-biometrics-101-an-in-depth-look-at-behavioral-biometrics-vs-behavioral-analytics
  [813]: https://web.archive.org/web/https://arstechnica.com/tech-policy/2012/03/stakeout-how-the-fbi-tracked-and-busted-a-chicago-anon/
  [814]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2018/05/25/mh17-russian-gru-commander-orion-identified-oleg-ivannikov/
  [815]: https://web.archive.org/web/https://research.fb.com/publications/deepface-closing-the-gap-to-human-level-performance-in-face-verification/
  [816]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/putting-face-facebook-mark-zuckerberg-building-world-without-public-anonymity/
  [817]: https://web.archive.org/web/https://www.cnbc.com/2017/09/01/facebook-has-mapped-human-population-building-internet-in-space.html
  [818]: https://web.archive.org/web/https://www.technologyreview.com/2021/02/05/1017388/ai-deep-learning-facial-recognition-data-history/
  [819]: https://web.archive.org/web/https://www.bellingcat.com/resources/case-studies/2015/08/07/shadow-of-a-doubt/
  [820]: https://web.archive.org/web/https://brown.columbia.edu/open-source-investigation/
  [821]: https://web.archive.org/web/https://www.newscientist.com/article/dn27761-facebook-can-recognise-you-in-photos-even-if-youre-not-looking/
  [822]: https://web.archive.org/web/https://patents.google.com/patent/US20150242679
  [823]: https://web.archive.org/web/https://apnews.com/article/bf75dd1c26c947b7826d270a16e2658a
  [824]: https://web.archive.org/web/https://techcrunch.com/2021/01/13/facial-recognition-reveals-political-party-in-troubling-new-research/
  [825]: https://web.archive.org/web/https://www.nature.com/articles/s41598-020-79310-1
  [826]: https://web.archive.org/web/https://slate.com/technology/2018/04/facebook-collects-data-on-non-facebook-users-if-they-want-to-delete-it-they-have-to-sign-up.html
  [827]: https://web.archive.org/web/https://theconversation.com/shadow-profiles-facebook-knows-about-you-even-if-youre-not-on-facebook-94804
  [828]: https://web.archive.org/web/https://www.theverge.com/2018/4/11/17225482/facebook-shadow-profiles-zuckerberg-congress-data-privacy
  [829]: https://web.archive.org/web/https://www.zdnet.com/article/anger-mounts-after-facebooks-shadow-profiles-leak-in-bug/
  [830]: https://web.archive.org/web/https://www.cnet.com/news/shadow-profiles-facebook-has-information-you-didnt-hand-over/
  [831]: https://web.archive.org/web/https://www.anyvision.co/
  [832]: https://web.archive.org/web/https://www.buzzfeednews.com/article/ryanmac/clearview-ai-local-police-facial-recognition
  [833]: https://web.archive.org/web/https://www.nec.com/en/global/solutions/biometrics/face/neofacewatch.html
  [834]: https://web.archive.org/web/https://www.theguardian.com/uk-news/2020/feb/11/met-police-deploy-live-facial-recognition-technology
  [835]: https://yewtu.be/watch?v=lH2gMNrUuEY
  [836]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2020/12/08/huawei-tested-ai-software-that-could-recognize-uighur-minorities-alert-police-report-says/
  [837]: https://web.archive.org/web/https://theintercept.com/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/
  [838]: https://web.archive.org/web/https://www.bbc.com/news/uk-wales-43711477
  [839]: https://web.archive.org/web/https://edition.cnn.com/2021/05/25/uk/drug-dealer-cheese-sentenced-scli-gbr-intl/index.html
  [840]: https://web.archive.org/web/https://www.vice.com/en/article/evqk9e/photo-of-fingerprints-used-to-arrest-drug-dealers
  [841]: https://web.archive.org/web/https://patents.justia.com/patent/10891948
  [842]: https://web.archive.org/web/https://www.imdb.com/title/tt0119177/
  [843]: https://web.archive.org/web/https://www.imdb.com/title/tt1839578
  [844]: https://web.archive.org/web/https://www.imdb.com/title/tt0181689
  [845]: https://wikiless.org/wiki/Deepfake
  [846]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Deepfake
  [847]: https://web.archive.org/web/https://www.econotimes.com/Deepfake-Voice-Technology-The-Good-The-Bad-The-Future-1601278
  [848]: https://web.archive.org/web/https://www.forbes.com/sites/jessedamiani/2019/09/03/a-voice-deepfake-was-used-to-scam-a-ceo-out-of-243000/
  [849]: https://web.archive.org/web/https://josephsteinberg.com/how-to-prevent-facial-recognition-technology-from-identifying-you/
  [850]: https://web.archive.org/web/https://nvlpubs.nist.gov/nistpubs/ir/2020/NIST.IR.8311.pdf
  [851]: https://web.archive.org/web/https://www.bbc.com/news/technology-55573802
  [852]: https://web.archive.org/web/http://diglib.uwgb.edu/digital/api/collection/p17003coll4/id/71/download
  [853]: https://wikiless.org/wiki/Phishing
  [854]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Phishing
  [855]: https://wikiless.org/wiki/Social_engineering_(security)
  [856]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Social_engineering_(security)
  [857]: https://web.archive.org/web/https://www.bbc.com/news/technology-56071437
  [858]: https://wikiless.org/wiki/Exploit_(computer_security)
  [859]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Exploit_(computer_security)
  [860]: https://wikiless.org/wiki/Freedom_Hosting
  [861]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Freedom_Hosting
  [862]: https://web.archive.org/web/https://www.wired.com/2013/09/freedom-hosting-fbi/
  [863]: https://wikiless.org/wiki/2020_United_States_federal_government_data_breach
  [864]: https://web.archive.org/web/https://en.wikipedia.org/wiki/2020_United_States_federal_government_data_breach
  [865]: https://web.archive.org/web/https://www.bbc.com/news/blogs-china-blog-48552907
  [866]: https://web.archive.org/web/https://theintercept.com/2021/01/29/china-uyghur-muslim-surveillance-police/
  [867]: https://wikiless.org/wiki/Sandbox_(computer_security)
  [868]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sandbox_(computer_security)
  [869]: https://web.archive.org/web/https://www.wired.com/2014/07/usb-security/
  [870]: https://wikiless.org/wiki/Stuxnet
  [871]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stuxnet
  [872]: https://web.archive.org/web/https://superuser.com/questions/1206321/how-do-i-safely-investigate-a-usb-stick-found-in-the-parking-lot-at-work
  [873]: https://web.archive.org/web/https://www.theguardian.com/books/2014/may/12/glenn-greenwald-nsa-tampers-us-internet-routers-snowden
  [874]: https://wikiless.org/wiki/Rootkit
  [875]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Rootkit
  [876]: https://wikiless.org/wiki/User_space
  [877]: https://web.archive.org/web/https://en.wikipedia.org/wiki/User_space
  [878]: https://wikiless.org/wiki/Firmware
  [879]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Firmware
  [880]: https://wikiless.org/wiki/BIOS
  [881]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BIOS
  [882]: https://wikiless.org/wiki/Unified_Extensible_Firmware_Interface
  [883]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface
  [884]: https://web.archive.org/web/https://www.bellingcat.com/news/americas/2018/10/26/joseph-mifsud-rush-exif/
  [885]: https://web.archive.org/web/https://support.zoom.us/hc/en-us/articles/209605273-Adding-a-Watermark
  [886]: https://web.archive.org/web/https://support.zoom.us/hc/en-us/articles/360021839031-Audio-Watermark
  [887]: https://web.archive.org/web/https://exchange.adobe.com/creativecloud.details.101789.imatag-invisible-watermark-and-image-monitoring.html
  [888]: https://web.archive.org/web/https://dtv.nagra.com/nexguard-forensic-watermarking
  [889]: https://web.archive.org/web/https://www.vobilegroup.com/solutions
  [890]: https://web.archive.org/web/https://www.cinavia.com/languages/english/pages/technology.html
  [891]: https://web.archive.org/web/https://www.imatag.com/
  [892]: https://wikiless.org/wiki/Steganography
  [893]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Steganography
  [894]: https://web.archive.org/web/https://ieeexplore.ieee.org/document/4428921
  [895]: https://web.archive.org/web/https://www.sciencedirect.com/science/article/abs/pii/S0165168498000140
  [896]: https://web.archive.org/web/https://ieeexplore.ieee.org/abstract/document/1188746
  [897]: https://web.archive.org/web/https://scholar.google.com/scholar?q=source+camera+identification
  [898]: https://wikiless.org/wiki/Machine_Identification_Code
  [899]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Machine_Identification_Code
  [900]: https://web.archive.org/web/http://seeingyellow.com/
  [901]: https://web.archive.org/web/https://arxiv.org/abs/1107.4524
  [902]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2019/03/26/how-to-track-illegal-funding-campaigns-via-cryptocurrency/
  [903]: https://wikiless.org/wiki/Know_your_customer
  [904]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Know_your_customer
  [905]: https://web.archive.org/web/https://arxiv.org/pdf/1906.05754.pdf
  [906]: https://yewtu.be/playlist?list=PLsSYUeVwrHBnAUre2G_LYDsdo-tD0ov-y
  [907]: https://web.archive.org/web/https://monero.org/monero-vs-princeton-researchers/
  [908]: https://wikiless.org/wiki/Cryptocurrency_tumbler
  [909]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cryptocurrency_tumbler
  [910]: https://wikiless.org/wiki/Security_through_obscurity
  [911]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Security_through_obscurity
  [912]: https://web.archive.org/web/https://arxiv.org/abs/2009.14007
  [913]: https://web.archive.org/web/https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3080361
  [914]: https://web.archive.org/web/https://www.magnetforensics.com/products/magnet-axiom/cloud/
  [915]: https://web.archive.org/web/https://www.cellebrite.com/en/ufed-cloud/
  [916]: https://web.archive.org/web/https://sites.google.com/a/chromium.org/dev/Home/chromium-security/client-identification-mechanisms
  [917]: https://web.archive.org/web/https://wiki.mozilla.org/Fingerprinting
  [918]: https://web.archive.org/web/https://www.grayshift.com/
  [919]: https://web.archive.org/web/https://securephones.io/main.pdf
  [920]: https://web.archive.org/web/https://loup-vaillant.fr/articles/rolling-your-own-crypto
  [921]: https://web.archive.org/web/https://soatok.blog/2021/02/09/crackpot-cryptography-and-security-theater/
  [922]: https://web.archive.org/web/https://www.vice.com/en/article/wnx8nq/why-you-dont-roll-your-own-crypto
  [923]: https://yewtu.be/watch?v=loy84K3AJ5Q
  [924]: https://web.archive.org/web/https://citizenlab.ca/2020/04/move-fast-roll-your-own-crypto-a-quick-look-at-the-confidentiality-of-zoom-meetings/
  [925]: https://web.archive.org/web/https://medium.com/@atcipher/the-myth-of-military-grade-encryption-292313ae6369
  [926]: https://web.archive.org/web/https://blog.congruentlabs.co/military-grade-encryption/
  [927]: https://web.archive.org/web/https://blog.ironcorelabs.com/military-grade-encryption-69aae0145588
  [928]: https://wikiless.org/wiki/Gag_order
  [929]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Gag_order
  [930]: https://wikiless.org/wiki/National_security_letter
  [931]: https://web.archive.org/web/https://en.wikipedia.org/wiki/National_security_letter
  [932]: https://web.archive.org/web/https://www.bleepingcomputer.com/news/security/doublevpn-servers-logs-and-account-info-seized-by-law-enforcement/
  [933]: https://web.archive.org/web/https://www.cyberscoop.com/court-rules-encrypted-email-tutanota-monitor-messages/
  [934]: https://web.archive.org/web/https://www.heise.de/news/Gericht-zwingt-Mailprovider-Tutanota-zu-Ueberwachungsfunktion-4972460.html
  [935]: https://web.archive.org/web/https://www.pcmag.com/opinions/did-purevpn-cross-a-line-when-it-disclosed-user-information
  [936]: https://web.archive.org/web/https://archive.is/XNuVw
  [937]: https://web.archive.org/web/https://archive.is/ag9w4
  [938]: https://wikiless.org/wiki/Lavabit
  [939]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Lavabit
  [940]: https://wikiless.org/wiki/Warrant_canary
  [941]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Warrant_canary
  [942]: https://web.archive.org/web/https://www.washingtonpost.com/graphics/2020/world/national-security/cia-crypto-encryption-machines-espionage/
  [943]: https://web.archive.org/web/https://www.swissinfo.ch/eng/second-swiss-firm-allegedly-sold-encrypted-spying-devices/46186432
  [944]: https://wikiless.org/wiki/The_Lives_of_Others
  [945]: https://web.archive.org/web/https://en.wikipedia.org/wiki/The_Lives_of_Others
  [946]: https://web.archive.org/web/https://www.wired.com/story/air-gap-researcher-mordechai-guri/
  [947]: https://web.archive.org/web/https://www.nassiben.com/lamphone
  [948]: https://wikiless.org/wiki/OONI
  [949]: https://web.archive.org/web/https://en.wikipedia.org/wiki/OONI
  [950]: https://web.archive.org/web/https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws
  [951]: https://web.archive.org/web/https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html
  [952]: https://web.archive.org/web/https://www.usenix.org/system/files/conference/woot17/woot17-paper-obermaier.pdf
  [953]: https://wikiless.org/wiki/Tails_(operating_system)
  [954]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tails_(operating_system)
  [955]: https://web.archive.org/web/https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez
  [956]: https://web.archive.org/web/https://www.veracrypt.fr/en/Trim%20Operation.html
  [957]: https://web.archive.org/web/https://www.coreboot.org/
  [958]: https://web.archive.org/web/https://xkcd.com/936/
  [959]: https://wikiless.org/wiki/Booting
  [960]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Booting
  [961]: https://web.archive.org/web/https://www.wired.com/2013/12/better-data-security-nail-polish/
  [962]: https://wikiless.org/wiki/Virtual_machine
  [963]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtual_machine
  [964]: https://wikiless.org/wiki/Plausible_deniability
  [965]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Plausible_deniability
  [966]: https://wikiless.org/wiki/Deniable_encryption
  [967]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Deniable_encryption
  [968]: https://web.archive.org/web/https://privacytools.io/operating-systems/
  [969]: https://wikiless.org/wiki/BitLocker
  [970]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BitLocker
  [971]: https://web.archive.org/web/https://wiki.alpinelinux.org/wiki/Setting_up_a_laptop
  [972]: https://wikiless.org/wiki/Evil_maid_attack
  [973]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Evil_maid_attack
  [974]: https://wikiless.org/wiki/Cold_boot_attack
  [975]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cold_boot_attack
  [976]: https://yewtu.be/watch?v=JDaicPIgn9U
  [977]: https://web.archive.org/web/https://www.researchgate.net/publication/318155607_Defeating_Plausible_Deniability_of_VeraCrypt_Hidden_Operating_Systems
  [978]: https://web.archive.org/web/https://www.sans.org/reading-room/whitepapers/forensics/mission-implausible-defeating-plausible-deniability-digital-forensics-39500
  [979]: https://web.archive.org/web/https://sourceforge.net/p/veracrypt/discussion/technical/thread/53f33faf/
  [980]: https://web.archive.org/web/https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures
  [981]: https://web.archive.org/web/https://www.sans.org/reading-room/whitepapers/forensics/windows-shellbag-forensics-in-depth-34545
  [982]: https://web.archive.org/web/https://eprints.whiterose.ac.uk/75046/1/Forensic_Data_Recovery_From_The_Windows_Search_Database_preprint_DIIN328.pdf
  [983]: https://web.archive.org/web/https://cyberforensicator.com/wp-content/uploads/2017/01/1-s2.0-S1742287616300202-main.2-14.pdf
  [984]: https://wikiless.org/wiki/Gatekeeper_(macOS)
  [985]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Gatekeeper_(macOS)
  [986]: https://wikiless.org/wiki/VeraCrypt
  [987]: https://web.archive.org/web/https://en.wikipedia.org/wiki/VeraCrypt
  [988]: https://web.archive.org/web/https://ostif.org/the-veracrypt-audit-results/
  [989]: https://web.archive.org/web/https://www.veracrypt.fr/en/Unencrypted%20Data%20in%20RAM.html
  [990]: https://web.archive.org/web/https://www.veracrypt.fr/code/VeraCrypt/plain/doc/html/Data%20Leaks.html
  [991]: https://web.archive.org/web/https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html
  [992]: https://web.archive.org/web/https://repository.stcloudstate.edu/cgi/viewcontent.cgi?article=1141&context=msia_etds
  [993]: https://web.archive.org/web/https://www.windowscentral.com/how-ensure-trim-enabled-windows-10-speed-ssd-performance
  [994]: https://web.archive.org/web/https://veracrypt.eu/en/docs/trim-operation/
  [995]: https://web.archive.org/web/https://i.blackhat.com/eu-18/Thu-Dec-6/eu-18-Schaub-Perfectly-Deniable-Steganographic-Disk-Encryption.pdf
  [996]: https://web.archive.org/web/http://asalor.blogspot.com/2011/08/trim-dm-crypt-problems.html
  [997]: https://wikiless.org/wiki/VirtualBox
  [998]: https://web.archive.org/web/https://en.wikipedia.org/wiki/VirtualBox
  [999]: https://web.archive.org/web/https://www.virtualbox.org/ticket/17987
  [1000]: https://wikiless.org/wiki/Whonix
  [1001]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Whonix
  [1002]: https://web.archive.org/web/https://docs.oracle.com/en/virtualization/virtualbox/6.0/user/snapshots.html
  [1003]: https://web.archive.org/web/https://programs.online.utica.edu/sites/default/files/Neal_6_Gonnella_Forensic_Recovery_of_Evidence_from_Deleted_Oracle_VirtualBox_Virtual_Machine.pdf
  [1004]: https://wikiless.org/wiki/Spectre_(security_vulnerability)
  [1005]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Spectre_(security_vulnerability)
  [1006]: https://wikiless.org/wiki/Meltdown_(security_vulnerability)
  [1007]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Meltdown_(security_vulnerability)
  [1008]: https://web.archive.org/web/https://www.whonix.org/wiki/Stream_Isolation#By_Settings
  [1009]: https://wikiless.org/wiki/Time-based_One-time_Password_algorithm
  [1010]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm
  [1011]: https://wikiless.org/wiki/Multi-factor_authentication
  [1012]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Multi-factor_authentication
  [1013]: https://web.archive.org/web/https://www.whonix.org/wiki/Whonix-Gateway_Security#Warning:_Bridged_Networking
  [1014]: https://web.archive.org/web/https://www.qubes-os.org/faq/#is-qubes-just-another-linux-distribution
  [1015]: https://web.archive.org/web/https://www.qubes-os.org/doc/system-requirements/
  [1016]: https://web.archive.org/web/https://github.com/QubesOS/qubes-issues/issues/2414
  [1017]: https://wikiless.org/wiki/AppArmor
  [1018]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AppArmor
  [1019]: https://wikiless.org/wiki/Security-Enhanced_Linux
  [1020]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Security-Enhanced_Linux
  [1021]: https://wikiless.org/wiki/CAPTCHA
  [1022]: https://web.archive.org/web/https://en.wikipedia.org/wiki/CAPTCHA
  [1023]: https://wikiless.org/wiki/Turing_test
  [1024]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Turing_test
  [1025]: https://web.archive.org/web/https://www.google.com/recaptcha/about/
  [1026]: https://web.archive.org/web/https://www.hcaptcha.com/
  [1027]: https://web.archive.org/web/https://www.hcaptcha.com/post/hcaptcha-now-the-largest-independent-captcha-service
  [1028]: https://web.archive.org/web/https://nearcyan.com/you-probably-dont-need-recaptcha/
  [1029]: https://web.archive.org/web/https://arstechnica.com/gadgets/2017/03/googles-recaptcha-announces-invisible-background-captchas/
  [1030]: https://web.archive.org/web/https://www.blackhat.com/docs/asia-16/materials/asia-16-Sivakorn-Im-Not-a-Human-Breaking-the-Google-reCAPTCHA-wp.pdf
  [1031]: https://web.archive.org/web/https://security.googleblog.com/2014/12/are-you-robot-introducing-no-captcha.html
  [1032]: https://web.archive.org/web/https://community.torproject.org/gsoc/cloudflare-captcha-monitoring/
  [1033]: https://web.archive.org/web/https://blog.cloudflare.com/cloudflare-supports-privacy-pass/
  [1034]: https://wikiless.org/wiki/Device_fingerprint
  [1035]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Device_fingerprint
  [1036]: https://web.archive.org/web/https://developers.googleblog.com/2020/08/guidance-for-our-effort-to-block-less-secure-browser-and-apps.html
  [1037]: https://web.archive.org/web/https://support.google.com/accounts/answer/10071085
  [1038]: https://wikiless.org/wiki/Dark_pattern
  [1039]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Dark_pattern
  [1040]: https://web.archive.org/web/https://www.theverge.com/2020/1/23/21077423/tinder-photo-verification-blue-checkmark-safety-center-launch-noonlight
  [1041]: https://web.archive.org/web/https://www.digitalinformationworld.com/2020/03/facebook-is-now-demanding-some-users-to-create-a-video-selfie-for-identity-verification.html
  [1042]: https://web.archive.org/web/https://www.vice.com/en/article/m7a4eq/pornhub-new-verification-policy-biometric-id
  [1043]: https://web.archive.org/web/https://variety.com/2021/digital/news/china-censorship-hotline-historical-nihilism-1234950554/
  [1044]: https://wikiless.org/wiki/Zero_trust_security_model
  [1045]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Zero_trust_security_model
  [1046]: https://wikiless.org/wiki/Espionage
  [1047]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Espionage
  [1048]: https://wikiless.org/wiki/SIM_swap_scam
  [1049]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SIM_swap_scam
  [1050]: https://web.archive.org/web/https://www.whonix.org/wiki/Tor
  [1051]: https://web.archive.org/web/https://support.torproject.org/tbb/tbb-editing-torrc/
  [1052]: https://web.archive.org/web/https://support.google.com/accounts/answer/114129?hl=en
  [1053]: https://web.archive.org/web/https://support.google.com/google-ads/answer/7474263?hl=en
  [1054]: https://web.archive.org/web/https://support.google.com/accounts/answer/40695
  [1055]: https://web.archive.org/web/https://support.google.com/accounts/contact/disabled2
  [1056]: https://web.archive.org/web/https://support.google.com/accounts/answer/1333913?hl=en
  [1057]: https://web.archive.org/web/https://www.jumio.com/features/
  [1058]: https://web.archive.org/web/https://privacytools.io/providers/email/
  ...
  [1059]: https://web.archive.org/web/https://protonmail.com/support/knowledge-base/human-verification/
  [1060]: https://web.archive.org/web/https://knowyourmeme.com/memes/good-luck-im-behind-7-proxies
  [1061]: https://wikiless.org/wiki/End-to-end_encryption
  [1062]: https://web.archive.org/web/https://en.wikipedia.org/wiki/End-to-end_encryption
  [1063]: https://wikiless.org/wiki/Forward_secrecy
  [1064]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Forward_secrecy
  [1065]: https://web.archive.org/web/https://protonmail.com/blog/zero-access-encryption/
  [1066]: https://wikiless.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal
  [1067]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal
  [1068]: https://web.archive.org/web/https://signal.org/blog/sealed-sender/
  [1069]: https://web.archive.org/web/https://signal.org/blog/private-contact-discovery/
  [1070]: https://web.archive.org/web/https://signal.org/blog/signal-private-group-system/
  [1071]: https://web.archive.org/web/https://privacytools.io/software/file-sharing/
  [1072]: https://web.archive.org/web/https://privacytools.io/software/real-time-communication/
  [1073]: https://web.archive.org/web/https://www.praxisfilms.org/open-letter-from-laura-poitras/
  [1074]: https://wikiless.org/wiki/SecureDrop
  [1075]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SecureDrop
  [1076]: https://wikiless.org/wiki/Trusted_Platform_Module
  [1077]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trusted_Platform_Module
  [1078]: https://wikiless.org/wiki/Pastebin
  [1079]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Pastebin
  [1080]: https://wikiless.org/wiki/Wear_leveling
  [1081]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wear_leveling
  [1082]: https://wikiless.org/wiki/Write_amplification
  [1083]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Write_amplification
  [1084]: https://web.archive.org/web/https://techgage.com/article/too_trim_when_ssd_data_recovery_is_impossible/
  [1085]: https://web.archive.org/web/https://www.researchgate.net/publication/341761017_Live_forensics_method_for_acquisition_on_the_Solid_State_Drive_SSD_NVMe_TRIM_function
  [1086]: https://web.archive.org/web/https://blog.elcomsoft.com/2019/01/life-after-trim-using-factory-access-mode-for-imaging-ssd-drives/
  [1087]: https://web.archive.org/web/https://www.forensicfocus.com/articles/forensic-acquisition-of-solid-state-drives-with-open-source-tools/
  [1088]: https://web.archive.org/web/https://www.researchgate.net/publication/325976653_Solid_State_Drive_Forensics_Where_Do_We_Stand
  [1089]: https://wikiless.org/wiki/Parted_Magic
  [1090]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Parted_Magic
  [1091]: https://wikiless.org/wiki/Hdparm
  [1092]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Hdparm
  [1093]: https://web.archive.org/web/https://github.com/linux-nvme/nvme-cli
  [1094]: https://web.archive.org/web/https://partedmagic.com/secure-erase/
  [1095]: https://web.archive.org/web/https://partedmagic.com/nvme-secure-erase/
  [1096]: https://web.archive.org/web/https://www.ufsexplorer.com/solutions/data-recovery-on-encrypted-storage.php
  [1097]: https://web.archive.org/web/https://developer.apple.com/library/archive/documentation/FileManagement/Conceptual/APFS_Guide/FAQ/FAQ.html
  [1098]: https://web.archive.org/web/https://www.privacytools.io/software/productivity/
  [1099]: https://web.archive.org/web/https://www.whonix.org/wiki/Metadata
  [1100]: https://web.archive.org/web/https://gitlab.tails.boum.org/tails/blueprints/-/wikis/doc/mat/
  [1101]: https://web.archive.org/web/https://disable-gatekeeper.github.io/
  [1102]: https://web.archive.org/web/https://help.duckduckgo.com/duckduckgo-help-pages/features/cache/
  [1103]: https://web.archive.org/web/https://help.duckduckgo.com/duckduckgo-help-pages/results/sources/
  [1104]: https://wikiless.org/wiki/Dead_drop
  [1105]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Dead_drop
  [1106]: https://wikiless.org/wiki/Obfuscation
  [1107]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Obfuscation
  [1108]: https://wikiless.org/wiki/Kleptography
  [1109]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Kleptography
  [1110]: https://wikiless.org/wiki/Koalang
  [1111]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Koalang
  [1112]: https://wikiless.org/wiki/Operations_security
  [1113]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Operations_security
  [1114]: https://web.archive.org/web/https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-
  [1115]: https://web.archive.org/web/https://medium.com/velociraptor-ir/the-windows-usn-journal-f0c55c9010e
  [1116]: https://web.archive.org/web/https://medium.com/velociraptor-ir/digging-into-the-system-resource-usage-monitor-srum-afbadb1a375
  [1117]: https://web.archive.org/web/https://www.sans.org/blog/timestamped-registry-ntfs-artifacts-from-unallocated-space/
  [1118]: https://web.archive.org/web/https://dban.org/
  [1119]: https://web.archive.org/web/https://crystalmark.info/en/software/crystaldiskinfo/
  [1120]: https://wikiless.org/wiki/Faraday_cage
  [1121]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Faraday_cage
  [1122]: https://web.archive.org/web/https://ro.ecu.edu.au/cgi/viewcontent.cgi?article=1165&context=adf
  [1123]: https://web.archive.org/web/https://arxiv.org/abs/1512.05616
  [1124]: https://web.archive.org/web/https://dl.acm.org/doi/pdf/10.1145/3309074.3309076
  [1125]: https://yewtu.be/watch?v=sO98kDLkh-M
  [1126]: https://wikiless.org/wiki/Touch_DNA
  [1127]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Touch_DNA
  [1128]: https://web.archive.org/web/https://www.yourdnaguide.com/ydgblog/dna-hair-samples-postage-stamps
  [1129]: https://web.archive.org/web/https://github.com/mhinkie/ooni-detection
  [1130]: https://wikiless.org/wiki/File_verification
  [1131]: https://web.archive.org/web/https://en.wikipedia.org/wiki/File_verification
  [1132]: https://wikiless.org/wiki/Cyclic_redundancy_check
  [1133]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cyclic_redundancy_check
  [1134]: https://wikiless.org/wiki/MD5
  [1135]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MD5
  [1136]: https://wikiless.org/wiki/Collision_(computer_science)
  [1137]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Collision_(computer_science)
  [1138]: https://wikiless.org/wiki/Secure_Hash_Algorithms
  [1139]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Secure_Hash_Algorithms
  [1140]: https://wikiless.org/wiki/SHA-2
  [1141]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SHA-2
  [1142]: https://wikiless.org/wiki/Collision_resistance
  [1143]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Collision_resistance
  [1144]: https://web.archive.org/web/https://wiki.gnupg.org/Gpg4win/CheckIntegrity
  [1145]: https://web.archive.org/web/https://medium.com/@EvgeniIvanov/how-to-verify-checksum-on-mac-988f166b0c4f
  [1146]: https://wikiless.org/wiki/GNU_Privacy_Guard
  [1147]: https://web.archive.org/web/https://en.wikipedia.org/wiki/GNU_Privacy_Guard
  [1148]: https://wikiless.org/wiki/Public-key_cryptography
  [1149]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Public-key_cryptography
  [1150]: https://wikiless.org/wiki/Polymorphic_code
  [1151]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Polymorphic_code
  [1152]: https://web.archive.org/web/https://www.whonix.org/wiki/Malware_and_Firmware_Trojans
  [1153]: https://web.archive.org/web/https://forums.whonix.org/t/installation-of-antivirus-scanners-by-default/9755/8
  [1154]: https://web.archive.org/web/https://www.av-test.org/fileadmin/pdf/security_report/AV-TEST_Security_Report_2018-2019.pdf
  [1155]: https://web.archive.org/web/https://www.zdnet.com/article/eset-discovers-21-new-linux-malware-families/
  [1156]: https://web.archive.org/web/https://nakedsecurity.sophos.com/2019/07/25/evilgnome-linux-malware-aimed-at-your-laptop-not-your-servers/
  [1157]: https://web.archive.org/web/https://blog.imunify360.com/hiddenwasp-how-to-detect-malware-hidden-on-linux-iot
  [1158]: https://wikiless.org/wiki/Linux_malware
  [1159]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Linux_malware
  [1160]: https://wikiless.org/wiki/MacOS_malware
  [1161]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MacOS_malware
  [1162]: https://web.archive.org/web/https://www.macworld.co.uk/feature/mac-viruses-list-3668354/
  [1163]: https://web.archive.org/web/https://resources.jamf.com/documents/macmalware-2020.pdf
  [1164]: https://web.archive.org/web/https://imagetragick.com/
  [1165]: https://web.archive.org/web/https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html
  [1166]: https://web.archive.org/web/https://zeltser.com/analyzing-malicious-documents/
  [1167]: https://wikiless.org/wiki/Portable_application
  [1168]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Portable_application
  [1169]: https://wikiless.org/wiki/Virtualization
  [1170]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtualization
  [1171]: https://web.archive.org/web/https://github.com/Yawning/obfs4/
  [1172]: https://web.archive.org/web/https://tb-manual.torproject.org/circumvention/
  [1173]: https://web.archive.org/web/https://www.tbstat.com/wp/uploads/2020/06/Europol-Wasabi-Wallet-Report.pdf
  [1174]: https://web.archive.org/web/https://github.com/insight-decentralized-consensus-lab/post-quantum-monero/blob/master/writeups/technical_note.pdf
